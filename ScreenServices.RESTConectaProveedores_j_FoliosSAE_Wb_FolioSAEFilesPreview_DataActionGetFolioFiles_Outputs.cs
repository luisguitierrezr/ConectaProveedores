...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public RestList<ssConectaProveedores.RestRecords.RESTST_8917d167cfa0f31ec1ed2a0d24e80bccStructure> outParamOtherFiles;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs FromOutputs(IBehaviorsConfiguration conf, long outParamFilePDF, long outParamFileSizePDF, long outParamFileXML, long outParamFileSizeXML, RL_b48e8aa5377b7b15faec0f07ad9facf2 outParamOtherFiles) {RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Model ToModel(RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs variables) {ConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Model result = new ConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioSAEFilesPreview_DataActionGetFolioFiles_Outputs();
