...
public class RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Model ToModel(RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Outputs variables) {ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Model result = new ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_DataActionGetFolioFiles_Outputs();
