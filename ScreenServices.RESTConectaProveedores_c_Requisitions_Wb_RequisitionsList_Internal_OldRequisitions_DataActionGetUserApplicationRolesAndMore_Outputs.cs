...
public class RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamIsActiveDEV_NewVersionScreenDownloads;
    ...
    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_97ac86b141c7934fd96d3cf71793066e outParamUserRolesList, string outParamAppRoleListText, bool outParamIsCorporativoCxP, bool outParamo_CanUploadInvoices, string outParamTelcelDirectionsListText, long outParamCorporativoRegionId, long outParamUserRegion, bool outParamIsActiveDEV_NewVersionScreenDownloads) {RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs result = new RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs();
...
result.outParamo_CanUploadInvoices = (bool?) outParamo_CanUploadInvoices;
...
return result;
    ...
    public static ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Model ToModel(RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs variables) {ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Model result = new ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Model();
...
return result;
    ...
    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs result = new RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs();
