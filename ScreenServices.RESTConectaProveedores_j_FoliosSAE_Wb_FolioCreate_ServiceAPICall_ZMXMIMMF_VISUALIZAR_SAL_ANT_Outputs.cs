...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioCreate_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Outputs : ScreenServicesApiController.Payload.IDataPayload {

    [JsonProperty("Response")]
public ssConectaProveedores.RestRecords.RESTST_cbb2055cf19f871ed882642269bd43ceStructure outParamResponse;


    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioCreate_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Outputs FromOutputs(IBehaviorsConfiguration conf, ST_cbb2055cf19f871ed882642269bd43ceStructure outParamResponse) {RESTConectaProveedores_j_FoliosSAE_Wb_FolioCreate_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioCreate_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Outputs();
