...
public class RESTConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public string inParami_GetUserId;
    ...
    public static RESTConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Inputs result = inputParameters.ToObject<RESTConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Inputs>(settings);
return result;
}


    public ConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Model ToModel() {ConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Model result = new ConectaProveedores_c_Requisitions_RequisitionDetail_ActionApprovModifReq_Model();
