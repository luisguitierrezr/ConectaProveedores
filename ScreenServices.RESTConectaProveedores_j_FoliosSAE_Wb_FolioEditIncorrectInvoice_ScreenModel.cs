...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs varLcGetSettings;
[JsonProperty("GetFolioFiles")]
public RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetFolioFiles_Outputs varLcGetFolioFiles;
[JsonProperty("GetOrderMainItems")]
public RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetOrderMainItems_Outputs varLcGetOrderMainItems;
[JsonProperty("GetSummary")]
public RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSummary_Outputs varLcGetSummary;
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel ToModel() {long inParamFolioId = variables.inParamFolioId == null ? 0L : variables.inParamFolioId.Value;
...
ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Model _varLcGetSettings = (variables.varLcGetSettings != null) ? RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs.ToModel(variables.varLcGetSettings) : null;
ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetFolioFiles_Model _varLcGetFolioFiles = (variables.varLcGetFolioFiles != null) ? RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetFolioFiles_Outputs.ToModel(variables.varLcGetFolioFiles) : null;
ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetOrderMainItems_Model _varLcGetOrderMainItems = (variables.varLcGetOrderMainItems != null) ? RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetOrderMainItems_Outputs.ToModel(variables.varLcGetOrderMainItems) : null;
ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSummary_Model _varLcGetSummary = (variables.varLcGetSummary != null) ? RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSummary_Outputs.ToModel(variables.varLcGetSummary) : null;
ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel screenModel = new ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ScreenModel(inParamFolioId, inParami_OrderId, inParami_LocalSelectedLines, varLcl_SummaryRec, varLcWithDatesError, varLcWithQuantityError, varLcWithFilesError, varLcDatesQuantityPEPError, varLcWithprorata, varLcfirstUserIdentifier, varLcComments, varLcInvoiceToCreate, varLcInvoiceForeignToCreate, varLcFilesList, varLcFilesListExtra, varLcApproverValid, varLcApproverErrorMessage, varLcMaxAmountError, varLcLocalSelectedLines, varLcl_ImportAnticipo, varLcCreditNoteFilesList, varLcl_IsOpenPopup, varLcl_IsOpenPopupComment, varLcHaveNewFiles, varLcNewFileNamesUploaded, varLcL_IsNational, varLcCreditNoteInvoiceToCreate, varLcCreditNote_IsNeeded, varLcInvoiceExtendedToCreate, varLcOrderAccConceptsIdToCreate, _ScreenDataSetGetFolioApprovalRejectReason, _ScreenDataSetGetFolioById, _ScreenDataSetGetFolioCommentsByFolioId, _ScreenDataSetGetFolioItemsByFolioId, _ScreenDataSetGetOrderDetail, _ScreenDataSetGetFolioObservationsByFolioId, _varLcGetSettings, _varLcGetFolioFiles, _varLcGetOrderMainItems, _varLcGetSummary, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
