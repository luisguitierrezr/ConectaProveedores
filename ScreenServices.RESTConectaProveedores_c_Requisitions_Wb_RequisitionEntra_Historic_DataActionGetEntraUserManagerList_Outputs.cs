...
public class RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs : ScreenServicesApiController.Payload.IDataPayload {

    [JsonProperty("UserList")]
public RestList<ssConectaProveedores.RestRecords.RESTST_34625f5643caa3d12448dcec7dd4c7d3Structure> outParamUserList;


    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_4af3045b114dbc57d1481fed5aceb93a outParamUserList) {RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs result = new RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs();
...
return result;
    ...
    public static ConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Model ToModel(RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs variables) {ConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Model result = new ConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Model();
...
return result;
    ...
    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs result = new RESTConectaProveedores_c_Requisitions_Wb_RequisitionEntra_Historic_DataActionGetEntraUserManagerList_Outputs();
