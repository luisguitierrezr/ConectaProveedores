...
[Route("screenservices/ConectaProveedores/j_FoliosSAE/Wb_SupportSAEUploadEdit")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController(ConectaProveedores_Controller.ProxyInstance, childControllers);
    ...
    static ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller() {
        Permissions = new CheckPermissionsIndex();
        Permissions.AddPermissionPropagationPath(/* Any Usage */CheckPermissionsIndex.ANY_USAGE_KEY, new String[] { CheckPermissionsIndex.ANY_USAGE_KEY, 
/*j_FoliosSAE.Wb_SupportSAEUploadEdit.ValidationOtherFiles*/"6dONWMH_kUW9Ti9X5sMIKA*5EzcCzoyQkmldSVcaP_9TA", 
...
/*System_.ListRemove*/"uXCIR2Atc0+es3zYuZSnNw*EL4Omu7NdEeReePEObsNOg"});
    ...
    public ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetSupplierUsersByUserId",Screen="Wb_SupportSAEUploadEdit",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetSupplierUsersByUserId(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "bSnCNyVXW3Wliu7s+vaqYg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_ScreenModel model = null;
...
try {model = RESTConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_ScreenModel.datasetGetSupplierUsersByUserId(requestContext,datasetGetSupplierUsersByUserId_maxRecords,datasetGetSupplierUsersByUserId_startIndex,IterationMultiplicity.Multiple,BuiltInFunction.GetUserId (),cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInvoiceFiles",Screen="Wb_SupportSAEUploadEdit",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_ScreenModel.datasetGetInvoiceFiles(requestContext,datasetGetInvoiceFiles_maxRecords,datasetGetInvoiceFiles_startIndex,IterationMultiplicity.Multiple,model.inParamFolioId,cancellationToken);
