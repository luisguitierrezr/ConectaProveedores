...
public class RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderFilesList_Outputs varLcGetOrderFilesList;
[JsonProperty("GetPaymentTermSpecial")]
public RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetPaymentTermSpecial_Outputs varLcGetPaymentTermSpecial;
[JsonProperty("GetAccountingData")]
public RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetAccountingData_Outputs varLcGetAccountingData;
[JsonProperty("GetOrderContractData")]
public RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderContractData_Outputs varLcGetOrderContractData;
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel ToModel() {long inParami_OrderId = variables.inParami_OrderId == null ? 0L : variables.inParami_OrderId.Value;
...
ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderFilesList_Model _varLcGetOrderFilesList = (variables.varLcGetOrderFilesList != null) ? RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderFilesList_Outputs.ToModel(variables.varLcGetOrderFilesList) : null;
ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetPaymentTermSpecial_Model _varLcGetPaymentTermSpecial = (variables.varLcGetPaymentTermSpecial != null) ? RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetPaymentTermSpecial_Outputs.ToModel(variables.varLcGetPaymentTermSpecial) : null;
ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetAccountingData_Model _varLcGetAccountingData = (variables.varLcGetAccountingData != null) ? RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetAccountingData_Outputs.ToModel(variables.varLcGetAccountingData) : null;
ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderContractData_Model _varLcGetOrderContractData = (variables.varLcGetOrderContractData != null) ? RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderContractData_Outputs.ToModel(variables.varLcGetOrderContractData) : null;
ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel screenModel = new ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel(inParami_OrderId, inParami_ForceRefresh, varLcl_CanEditForm, varLcFilesList, varLcl_FormIsValid, varLcl_OrderRequestFiles, varLcShowOrderReject_Popup, varLcDependentFoliosText, varLcl_RequestDocsErrorMessage, varLcl_IsValidReqDoc, varLcl_CanUploadContract, varLcl_IsSavingContractFile, varLcl_IsMissingEstimEqualAgFiniquito, _ScreenDataSetGetSpecialApprovals, _ScreenDataSetGetAccountingDataTypes, _ScreenDataSetGetAdvancedPaymentTypes, _ScreenDataSetGetSpecialPostDeliveryAuthorizations, _ScreenDataSetGetContractStatuses, _ScreenDataSetGetProjectAssetServiceOtro, _ScreenDataSetGetSuppliers, _ScreenDataSetGetBusinessValueSubcategoriesByCategoryId, _ScreenDataSetGetSupplierByRequisition, _ScreenDataSetGetOrderMainById, _ScreenDataSetGetProjectAssetServices, _ScreenDataSetGetInvoiceUsages, _ScreenDataSetGetOrderRetentionTypes, _ScreenDataSetGetBusinessValueCategories, _ScreenDataSetGetPaymentTerms, _ScreenDataSetGetInsuranceTypes, _ScreenDataSetGetFrequencies, _ScreenDataSetGetPaymentOptions, _ScreenDataSetGetPaymentWays, _ScreenDataSetGetOrderMainItemsByOrderMainId, _ScreenDataSetGetCurrencies, _ScreenDataSetGetDepositTypes, _ScreenDataSetGetPaymentMethods, _ScreenDataSetGetRejectComment, _varLcGetOrderFilesList, _varLcGetPaymentTermSpecial, _varLcGetAccountingData, _varLcGetOrderContractData, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
