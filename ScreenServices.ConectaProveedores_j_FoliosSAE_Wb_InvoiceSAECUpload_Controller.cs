...
[Route("screenservices/ConectaProveedores/j_FoliosSAE/Wb_InvoiceSAECUpload")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController("ssOutSystemsUI.ScreenServices.OutSystemsUI_Controller", "OutSystemsUI", childControllers);
    ...
    static ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller() {
...
/*j_FoliosSAE.Wb_InvoiceSAECUpload.TogglePopupForeigner*/"6dONWMH_kUW9Ti9X5sMIKA*2iTxiiLGwEScF1PCHi+2Eg", 
...
/*j_FoliosSAE.Wb_InvoiceSAECUpload.ValidationMainXMLPdf*/"6dONWMH_kUW9Ti9X5sMIKA*NlPpo3qDVEKU_yOBRl1clQ", 
/*j_FoliosSAE.Wb_InvoiceSAECUpload.ValidationCreditNotes*/"6dONWMH_kUW9Ti9X5sMIKA*bGbXsITSRk2TFVtLKm7QQA", 
...
/*System_.ListClear*/"uXCIR2Atc0+es3zYuZSnNw*veU0xTJwTE2X4au_He4_vw"});
    ...
    public ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetSupplier",Screen="Wb_InvoiceSAECUpload",Type=ScreenServicesActionType.DataAction)]
public async Task<ActionResult<Payload.ServiceResponse>> DataActionGetSupplier(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "joSB6Txac71noZ3K6eMuYw", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ScreenModel model = null;
...
try {model = RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
} catch (Exception ex) {
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamExpedicionFiscal, outParamIsNational, outParamName, outParamRFC, outParamSociety, outParamSupplierNr, outParamIsActiveDEV_TK395);
return output;
...
[RESTScreenServicesActionProperties(Name="Invoice_OCR",Screen="Wb_InvoiceSAECUpload",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionInvoice_OCR(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "l1Z7Ht+TQvOx9ZV7WJjjKA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ActionInvoice_OCR_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ActionInvoice_OCR_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ActionInvoice_OCR_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamExtractTextOrOcr2, res.outParamExtractForeignInvoiceDataForUs2);
return output;
...
[RESTScreenServicesActionProperties(Name="UploadInvoiceFiles",Screen="Wb_InvoiceSAECUpload",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionUploadInvoiceFiles(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "N89602WQuvEMIeUa+aj8jw", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ActionUploadInvoiceFiles_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ActionUploadInvoiceFiles_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_ActionUploadInvoiceFiles_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamErrorMsg, res.outParamo_Invoice, res.outParamo_InvoiceExtended, res.outParamClaveProdServ, res.outParamTipoComprobante, res.outParamIsMissingCreditNote);
return output;
