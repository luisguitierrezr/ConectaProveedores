...
public class RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public long? outParamo_InvoiceAccountingId;
    ...
    public static RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_c31399d0d7c776731653a069ba32283a outParamo_List, long outParamo_InvoiceAccountingId) {RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs result = new RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs();
...
// Write optimized tmpoutParamo_ListElement.AttrIsEditBenefitCenterSAP
tmpoutParamo_ListElement.AttrIsEditBenefitCenterSAP = (bool?) false;
// Write optimized tmpoutParamo_ListElement.AttrIsErrorBenefitCenterSAP
tmpoutParamo_ListElement.AttrIsErrorBenefitCenterSAP = (bool?) false;
...
return result;
    ...
    public static ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Model ToModel(RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs variables) {ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Model result = new ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Model();
...
return result;
    ...
    public static RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs result = new RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs();
