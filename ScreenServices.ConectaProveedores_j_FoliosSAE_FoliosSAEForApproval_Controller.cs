...
[Route("screenservices/ConectaProveedores/j_FoliosSAE/FoliosSAEForApproval")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController("ssOutSystemsUI.ScreenServices.OutSystemsUI_Controller", "OutSystemsUI", childControllers);
                ...
                Permissions.AddAsyncCheckPermissions(new ScreenName("j_FoliosSAE.FoliosSAEForApproval"), ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller.CheckPermissionsAsync);
            }
        }
    }
...
throw new Ex_NotFoliosRoleException( "Folios role required");
    ...
    static ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller() {
...
/*j_FoliosSAE.FoliosSAEForApproval.RefreshList*/"6dONWMH_kUW9Ti9X5sMIKA*M25SViE710yoaAilUU5hmQ", 
...
/*j_FoliosSAE.FoliosSAEForApproval.ResetFilters*/"6dONWMH_kUW9Ti9X5sMIKA*4XKSrufsEUi3wGw7xCRoWg", 
...
/*a_Common.OnException*/"6dONWMH_kUW9Ti9X5sMIKA*B4kRGvrnOEmQonA8ir4Pyg.#FlowExceptionHandler"});
    ...
    public ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetFoliosSAE",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetFoliosSAE(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "62fH_TWIO4jS5huf9zYTZA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ScreenModel model = null;
...
try {model = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
AggregateRecord<RL_03e3cf3b917f5a94fbd0a8404cd2dee5> ds_output = new AggregateRecord<RL_03e3cf3b917f5a94fbd0a8404cd2dee5>();
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ScreenModel.datasetGetFoliosSAE(requestContext,datasetGetFoliosSAE_maxRecords,datasetGetFoliosSAE_startIndex,IterationMultiplicity.Multiple,(await Functions.ActionCheckUserSession(requestContext,cancellationToken)),model.clientVariables.ssFolioForApproval_CreatedOnDate,model.clientVariables.ssFolioForApproval_CreatedToDate,model.clientVariables.ssFolioForApproval_FolioNumber,model.clientVariables.ssFolioForApproval_OrderNumber,model.clientVariables.ssFolioForApproval_RegionId,model.clientVariables.ssFolioForApproval_StatusId,model.clientVariables.ssFolioForApproval_SupplierId,model.clientVariables.ssOffsetUtc,(await Functions.ActionGetIsCorporativo(requestContext,cancellationToken)),model.varLcGetUserApplicationRoles.outParamAppRoleListText,model.varLcGetUserApplicationRoles.outParamEntraRolesListText,(await Functions.ActionGetUserDepartmentId(requestContext,"",cancellationToken)),BuiltInFunction.GetUserId (),(await Functions.ActionGetUserRegionId(requestContext,"",cancellationToken)),model.varLcl_TableSort,cancellationToken);

ds_output.Count = count;
IBehaviorsConfiguration config = ((IBehaviorsConfiguration)this.BehaviorsConfiguration.Clone());
config.OptimizeBinaries = true;
var output = ds_output.ToJS((l) => {
return l.ToRestList<ssConectaProveedores.RestRecords.RESTRC_7bf0e8779480c1f841bf78e3626ee944>(ssConectaProveedores.RestRecords.RESTRC_7bf0e8779480c1f841bf78e3626ee944.FromStructureDelegate(config));
}
);
return output;
...
[RESTScreenServicesActionProperties(Name="GetFolioStatus",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ScreenModel.datasetGetFolioStatus(requestContext,datasetGetFolioStatus_maxRecords,datasetGetFolioStatus_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetFoliosSAEFull",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetFoliosSAEFull(CancellationToken cancellationToken) {
    using Stream input = HttpContext.Request.Body;
    return await EndpointAsync(input, "XORNFwepOUSGuXg3lejq7g", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ScreenModel model = null;
AggregateInputsRecord inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
...
AggregateRecord<RL_03e3cf3b917f5a94fbd0a8404cd2dee5> ds_output = new AggregateRecord<RL_03e3cf3b917f5a94fbd0a8404cd2dee5>();
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ScreenModel.datasetGetFoliosSAEFull(requestContext,datasetGetFoliosSAEFull_maxRecords,datasetGetFoliosSAEFull_startIndex,IterationMultiplicity.Multiple,(await Functions.ActionCheckUserSession(requestContext,cancellationToken)),model.clientVariables.ssFolioForApproval_CreatedOnDate,model.clientVariables.ssFolioForApproval_CreatedToDate,model.clientVariables.ssFolioForApproval_FolioNumber,model.clientVariables.ssFolioForApproval_OrderNumber,model.clientVariables.ssFolioForApproval_RegionId,model.clientVariables.ssFolioForApproval_StatusId,model.clientVariables.ssFolioForApproval_SupplierId,model.clientVariables.ssOffsetUtc,(await Functions.ActionGetIsCorporativo(requestContext,cancellationToken)),model.varLcGetUserApplicationRoles.outParamAppRoleListText,model.varLcGetUserApplicationRoles.outParamEntraRolesListText,(await Functions.ActionGetUserDepartmentId(requestContext,"",cancellationToken)),BuiltInFunction.GetUserId (),(await Functions.ActionGetUserRegionId(requestContext,"",cancellationToken)),model.varLcl_TableSort,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetRegions",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetUserApplicationRoles",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_DataActionGetUserApplicationRoles_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamUserRolesList, outParamAppRoleListText, outParamEntraRolesListText, outParamCanBulkApprove);
return output;
...
[RESTScreenServicesActionProperties(Name="GetSettings",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetSettings(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "YMh+L1Z1H9xV5gLNPZiIAg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionGetSettings_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionGetSettings_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionGetSettings_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamOutSettingsText);
return output;
...
[RESTScreenServicesActionProperties(Name="AuditCreateWrapper",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionAuditCreateWrapper(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "R9ncJjtM_dSZmMkM5XAN_g", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionAuditCreateWrapper_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionAuditCreateWrapper_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
[RESTScreenServicesActionProperties(Name="ApprovRejectFolio",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionApprovRejectFolio(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "3lMt9PSpF_QXCgb0Q9x67w", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_Output);
return output;
...
[RESTScreenServicesActionProperties(Name="ScreenTableDownloadFoliosSAEScreen",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionScreenTableDownloadFoliosSAEScreen(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "LVjcGOv1UoUSO9O1l3vMbw", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionScreenTableDownloadFoliosSAEScreen_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionScreenTableDownloadFoliosSAEScreen_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionScreenTableDownloadFoliosSAEScreen_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_File, res.outParamo_StringListIds, res.outParamo_ErrorMsg);
return output;
...
[RESTScreenServicesActionProperties(Name="ColumnTogglerPassColumn",Screen="FoliosSAEForApproval",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionColumnTogglerPassColumn(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "CdBjpqOzG3k0+Q1AYbtdhg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionColumnTogglerPassColumn_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionColumnTogglerPassColumn_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
