...
public class lcvSendEmailApprover_RejectFolioPrevApprover : VarsBag {
...
public lcvSendEmailApprover_RejectFolioPrevApprover(long inParami_FolioId) {
this.inParami_FolioId = inParami_FolioId;
}
}
/// <summary>
/// Action <code>SendEmailApprover_RejectFolioPrevApprover</code> that represents the Service Studio
///  action <code>SendEmailApprover_RejectFolioPrevApprover</code> <p> Description: </p>
/// </summary>
public static async Task ActionSendEmailApprover_RejectFolioPrevApprover(IRequestContext requestContext,long inParami_FolioId,CancellationToken cancellationToken) {
lcvSendEmailApprover_RejectFolioPrevApprover localVars = new lcvSendEmailApprover_RejectFolioPrevApprover(inParami_FolioId);
try {
cancellationToken.ThrowIfCancellationRequested();
using (AppHealthProvider.CreateServerActionMetric("SendEmailApprover_RejectFolioPrevApprover", "ae66fd4a-5f35-4596-b718-7ca9ee3d9439"))
using (RuntimePlatformSettings.OpenTelemetry.ServerActionIsEnabled.GetValue() ? activitySource.CreateActionActivity("SendEmailApprover_RejectFolioPrevApprover", "ae66fd4a-5f35-4596-b718-7ca9ee3d9439", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828") : null){
...
int datasetGetFolioById_startIndex = 0;(localVars.queryResGetFolioById_outParamList,localVars.queryResGetFolioById_outParamCount) = await FuncActionSendEmailApprover_RejectFolioPrevApprover.datasetGetFolioById(requestContext,datasetGetFolioById_maxRecords,datasetGetFolioById_startIndex,IterationMultiplicity.Never,localVars.inParami_FolioId,cancellationToken);
...
int datasetGetUserExtendedInternalAssignedTo_startIndex = 0;(localVars.queryResGetUserExtendedInternalAssignedTo_outParamList,localVars.queryResGetUserExtendedInternalAssignedTo_outParamCount) = await FuncActionSendEmailApprover_RejectFolioPrevApprover.datasetGetUserExtendedInternalAssignedTo(requestContext,datasetGetUserExtendedInternalAssignedTo_maxRecords,datasetGetUserExtendedInternalAssignedTo_startIndex,IterationMultiplicity.Never,localVars.queryResGetFolioById_outParamList.CurrentRec.ssENFolioApprovalLevel.ssAssignedTo,cancellationToken);
...
using (AppHealthProvider.CreateSendEmailMetric("NextApproverFolio", "73de08d7-4579-4e83-80ac-97ff1d0a8d18"))
using (var sendEmailActivity = activitySource.CreateSendEmailActivity("NextApproverFolio", "73de08d7-4579-4e83-80ac-97ff1d0a8d18", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828")) {
...
public static class FuncActionSendEmailApprover_RejectFolioPrevApprover {
...
// Query Function "GetFolioById" aDWtmxHlwkOAX5TKSq3+Cg of Action "SendEmailApprover_RejectFolioPrevApprover"
...
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("SendEmailApprover_RejectFolioPrevApprover.GetFolioById", "9bad3568-e511-43c2-805f-94ca4aadfe0a");
using var queryActivity = activitySource.CreateAggregateQueryActivity("SendEmailApprover_RejectFolioPrevApprover.GetFolioById", "9bad3568-e511-43c2-805f-94ca4aadfe0a", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
selectBuilder.Append("/* /UserActions.Sv1mrjVflkW3GHyp7j2UOQ/NodesNotShownInESpaceTree.aDWtmxHlwkOAX5TKSq3+Cg, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT NULL o0, NULL o1, \"enfolio41\".\"folionumber\" o2, NULL o3, NULL o4, NULL o5, NULL o6, NULL o7, NULL o8, NULL o9, NULL o10, NULL o11, NULL o12, NULL o13, NULL o14, NULL o15, NULL o16, NULL o17, NULL o18, NULL o19, NULL o20, NULL o21, NULL o22, NULL o23, NULL o24, NULL o25, NULL o26, NULL o27, NULL o28, NULL o29, NULL o30, NULL o31, NULL o32, NULL o33, NULL o34, NULL o35, NULL o36, \"enfolioapprovallevel22\".\"assignedto\" o37, NULL o38, NULL o39, NULL o40, NULL o41, NULL o42, NULL o43, NULL o44, NULL o45, NULL o46, NULL o47, NULL o48, NULL o49, NULL o50, NULL o51, NULL o52, NULL o53, NULL o54, NULL o55, NULL o56, NULL o57, NULL o58, NULL o59, NULL o60, NULL o61, NULL o62, NULL o63, NULL o64, NULL o65, NULL o66, NULL o67, NULL o68, NULL o69, NULL o70, NULL o71, NULL o72, NULL o73, NULL o74, NULL o75, NULL o76, NULL o77, NULL o78");
fromBuilder.Append(" FROM ((({Folio} \"enfolio41\" Left JOIN {FolioApproval} \"enfolioapproval23\" ON (\"enfolio41\".\"id\" = \"enfolioapproval23\".\"folioid\"))  Left JOIN {FolioApprovalLevel} \"enfolioapprovallevel22\" ON (\"enfolioapproval23\".\"id\" = \"enfolioapprovallevel22\".\"folioapprovalid\"))  Left JOIN {OrderMain} \"enordermain44\" ON (\"enfolio41\".\"orderid\" = \"enordermain44\".\"id\")) ");
whereBuilder.Append(" WHERE ");
if (qpfoFolio_Id != 0) {
whereBuilder.Append("((\"enfolio41\".\"id\" = @qpfoFolio_Id) AND (\"enfolio41\".\"id\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpfoFolio_Id", DbType.Int64, qpfoFolio_Id);
} else {
whereBuilder.Append("(\"enfolio41\".\"id\" IS NULL)");
}
whereBuilder.Append(" AND (\"enfolioapprovallevel22\".\"approvalstatusid\" = ");
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query SendEmailApprover_RejectFolioPrevApprover.GetFolioById.List", cancellationToken: cancellationToken);
...
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query SendEmailApprover_RejectFolioPrevApprover.GetFolioById.List", cancellationToken: cancellationToken);
...
// Query Function "GetUserExtendedInternalAssignedTo" fb6Ntfcp6UCkpJYeKj3VCg of Action "SendEmailApprover_RejectFolioPrevApprover"
...
long outParamCount = default;
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("SendEmailApprover_RejectFolioPrevApprover.GetUserExtendedInternalAssignedTo", "b58dbe7d-29f7-40e9-a4a4-961e2a3dd50a");
using var queryActivity = activitySource.CreateAggregateQueryActivity("SendEmailApprover_RejectFolioPrevApprover.GetUserExtendedInternalAssignedTo", "b58dbe7d-29f7-40e9-a4a4-961e2a3dd50a", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
// Query Iterations: Never
if (multiplicity == IterationMultiplicity.Never) {
maxRecords = 1;
}
...
var groupByBuilder = new StringBuilder();
var havingBuilder = new StringBuilder();
selectBuilder.Append("/* /UserActions.Sv1mrjVflkW3GHyp7j2UOQ/NodesNotShownInESpaceTree.fb6Ntfcp6UCkpJYeKj3VCg, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT \"enuser97\".\"id\" o0, \"enuser97\".\"name\" o1, \"enuser97\".\"email\" o2, NULL o3, NULL o4, NULL o5, NULL o6, NULL o7, NULL o8, NULL o9, NULL o10, NULL o11, NULL o12, NULL o13, NULL o14, NULL o15, NULL o16, NULL o17, NULL o18, NULL o19, NULL o20, NULL o21, NULL o22, NULL o23, NULL o24, NULL o25, NULL o26, \"enuserextension45\".\"emailto\" o27");
fromBuilder.Append(" FROM (({User_Extended_Internal} \"enuser_extended_internal59\" Inner JOIN {User} \"enuser97\" ON (\"enuser_extended_internal59\".\"id\" = \"enuser97\".\"id\"))  Left JOIN {UserExtension} \"enuserextension45\" ON (\"enuser97\".\"id\" = \"enuserextension45\".\"id\")) ");
whereBuilder.Append(" WHERE ");
if ((qpusUser_Id.Trim()!="")) {
whereBuilder.Append("((\"enuser97\".\"id\" = @qpusUser_Id) AND (\"enuser97\".\"id\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpusUser_Id", DbType.String, qpusUser_Id);
} else {
whereBuilder.Append("(\"enuser97\".\"id\" IS NULL)");
}
if (maxRecords > 0) {
orderByBuilder.Append(" LIMIT ");
orderByBuilder.Append(maxRecords);
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query SendEmailApprover_RejectFolioPrevApprover.GetUserExtendedInternalAssignedTo.List", cancellationToken: cancellationToken);
await outParamList.LoadFromDatabase(cancellationToken);
outParamList.MaxRecords = maxRecords;
return (outParamList,outParamCount);
} finally {
...
_tmp.MaxRecords = maxRecords;
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query SendEmailApprover_RejectFolioPrevApprover.GetUserExtendedInternalAssignedTo.List", cancellationToken: cancellationToken);
await _tmp.LoadFromDatabase(cancellationToken);
