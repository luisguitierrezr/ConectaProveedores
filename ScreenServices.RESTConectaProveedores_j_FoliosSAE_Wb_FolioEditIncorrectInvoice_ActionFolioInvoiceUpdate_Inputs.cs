...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public string inParami_NewFileNamesUploaded;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Inputs result = inputParameters.ToObject<RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Inputs>(settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Model ToModel() {ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Model result = new ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_ActionFolioInvoiceUpdate_Model();
