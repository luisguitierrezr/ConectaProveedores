...
public class RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public int? inParamOffsetUtc;
    ...
    public static RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Inputs result = inputParameters.ToObject<RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Inputs>(settings);
return result;
}


    public ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Model ToModel() {ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Model result = new ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ActionOnSubmitAccounting_Model();
