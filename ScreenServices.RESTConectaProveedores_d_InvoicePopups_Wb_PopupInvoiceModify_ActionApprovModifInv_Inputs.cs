...
public class RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public string inParami_GetUserId;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Inputs result = inputParameters.ToObject<RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Inputs>(settings);
return result;
}


    public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Model ToModel() {ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Model result = new ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceModify_ActionApprovModifInv_Model();
