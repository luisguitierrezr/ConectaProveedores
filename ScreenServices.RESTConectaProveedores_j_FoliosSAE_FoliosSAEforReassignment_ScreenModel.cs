...
public class RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel ToModel() {bool varLcl_IsSidebarOpen = variables.varLcl_IsSidebarOpen == null ? false : variables.varLcl_IsSidebarOpen.Value;
...
ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel screenModel = new ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel(varLcl_IsSidebarOpen, varLcNotifContent, varLcTableSort, varLcStartIndex, varLcl_ColumnJSONVar, varLcl_CountAfterFetch, varLcl_ReInvokeToggler, _ScreenDataSetGetReassignments, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
