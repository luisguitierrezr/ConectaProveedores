...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public RestList<ssConectaProveedores.RestRecords.RESTST_714c559a98f1e1080cbf60de3228e843Structure> outParamKeyValueList;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_a579a1a05eaaba551100ea61f4cb3f6b outParamKeyValueList) {RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Model ToModel(RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs variables) {ConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Model result = new ConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditConstruction_DataActionGetMinutes_Outputs();
