...
public class RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public RestList<ssConectaProveedores.RestRecords.RESTRC_a32d2d6effb998fa5a8e4b01f03a15ca> outParamo_UsersList;
    ...
    public static RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_4c313dd08c2e051e0c0310a6d05109b0 outParamo_UsersList) {RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs result = new RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs();
...
return result;
    ...
    public static ConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Model ToModel(RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs variables) {ConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Model result = new ConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Model();
...
return result;
    ...
    public static RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs result = new RESTConectaProveedores_e_Orders_Wb_AssignUserOrderPopup_DataActionGetUsersList_Outputs();
