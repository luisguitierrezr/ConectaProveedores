...
public class RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel ToModel() {DateTime varLcDateStart = variables.varLcDateStart == null ? new DateTime(1900, 1, 1, 0, 0, 0, DateTimeKind.Utc) : OutSystems.RESTService.Runtime.Abstractions.Conversions.TextToDateTime(variables.varLcDateStart, OutSystems.RESTService.Runtime.Abstractions.Behaviors.DateTimeFormat.ISO);
...
ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel screenModel = new ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel(varLcDateStart, varLcDateEnd, varLcTableSort, varLcStartIndex, varLcMaxRecords, varLcStorageId, varLcIsSelectOne, varLcForceRefresh, _ScreenDataSetGetInvoiceFiles, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
