...
public class RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public ssConectaProveedores.RestRecords.RESTEN_d1d0320db36efbb094ad0082361435a0EntityRecord inParamInvoice;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Inputs result = inputParameters.ToObject<RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Inputs>(settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Model ToModel() {ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Model result = new ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Model();
