import { withBaseWebBlock, asPrimitiveValue, Widget, textWidget as $text, getTranslation, ifWidget as $if, useTracing } from "@outsystems/runtime-view-js";
import { Container as OSWidgets$Container, Text as OSWidgets$Text, List as OSWidgets$List, Expression as OSWidgets$Expression, Icon as OSWidgets$Icon } from "@outsystems/runtime-widgets-js";
...
import ModelFactory from "./ConectaProveedores.e_Orders.wb_OrderItemEntriesByOrderId.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.e_Orders.wb_OrderItemEntriesByOrderId.mvc$controller.js";
...
text: ["Entradas directas en SAP"],
_idProps: {
service: idService,
uuid: "1"
},
_widgetRecordProvider: widgetsRecordProvider
})), $if(model.variables.getOrderItemEntriesByOrderMainItemidAggr.isDataFetchedAttr, false, this, function () {
return [$if((!(model.variables.getOrderItemEntriesByOrderMainItemidAggr.listOut.isEmpty)), false, this, function () {
...
align: /*Default*/ 0,
animate: false,
style: model.getCachedValue(idService.getId("PXbAoUUUPUe_AMOSxttfSQ.Style"), function () {
...
style: "bold",
value: model.variables.getOrderItemEntriesByOrderMainItemidAggr.listOut.getCurrent(callContext.iterationContext).orderItemEntriesAttr.entryDocumentAttr,
_idProps: {
service: idService,
uuid: "7"
},
...
value: model.getCachedValue(idService.getId("4J4oHENxpEqYCtVuEeKavQ.Value"), function () {
...
value: model.getCachedValue(idService.getId("MmDc1iLQfE6cGVTy41Dh9g.Value"), function () {
...
value: (model.variables.getOrderItemEntriesByOrderMainItemidAggr.listOut.getCurrent(callContext.iterationContext).orderMainItemAttr.positionAttr).toString(),
_idProps: {
service: idService,
uuid: "13"
},
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("w0li99HxJkO4kMoA+ijd7Q#Value", "There are no direct entries from SAP...")))];
})];
}, function () {
return [createElement(OSWidgets$Container, {
align: /*Default*/ 0,
...
return {
codeFunction: "wb_OrderItemEntriesByOrderId",
functionKey: "9bf2fd6c-ae18-4732-9055-642680c00678",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "e_Orders.wb_OrderItemEntriesByOrderId",
...
return ["css/font-awesome.min.css", "css/OutSystemsReactWidgets.css", "css/ConectaProveedores.e_Orders.wb_OrderItemEntriesByOrderId.css"];
};
