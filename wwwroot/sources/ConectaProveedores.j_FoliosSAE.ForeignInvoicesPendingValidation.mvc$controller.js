...
import { Controller as OS$Controller, Flow as OS$Flow, Logger as OS$Logger, DataTypes as OS$DataTypes, DataConversion as OS$DataConversion, Exceptions as OS$Exceptions, BuiltinFunctions as OS$BuiltinFunctions, Authorization as OS$Authorization, Transitions as OS$Transitions, Navigation as OS$Navigation } from "@outsystems/runtime-core-js";
import ConectaProveedoresLanguageResources from "./ConectaProveedores.languageResources.js";
import ConectaProveedores_j_FoliosSAE_ForeignInvoicesPendingValidation_mvc_TranslationsResources from "./ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_j_FoliosSAE_ForeignInvoicesPendingValidation_mvc_TranslationsResources);
...
return controller.callServerAction("GetSettings", "screenservices/ConectaProveedores/j_FoliosSAE/ForeignInvoicesPendingValidation/ActionGetSettings", "YMh+L1Z1H9xV5gLNPZiIAg", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation$ActionGetSettings"))();
...
return controller.callServerAction("ColumnTogglerPassColumn", "screenservices/ConectaProveedores/j_FoliosSAE/ForeignInvoicesPendingValidation/ActionColumnTogglerPassColumn", "CdBjpqOzG3k0+Q1AYbtdhg", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetFolioStatuses", "screenservices/ConectaProveedores/j_FoliosSAE/ForeignInvoicesPendingValidation/ScreenDataSetGetFolioStatuses", "YiEX4Y3lAA34ViBIgR_A4A", maxRecords, startIndex, function (b) {
...
span.setAttribute("outsystems.function.key", "83d7c8ad-0324-44af-94a3-8ed8400e82aa");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetFolioApprovalLevelsByAssignedTo", "screenservices/ConectaProveedores/j_FoliosSAE/ForeignInvoicesPendingValidation/ScreenDataSetGetFolioApprovalLevelsByAssignedTo", "leBosr2SI2daqvw_Bx8S7w", maxRecords, startIndex, function (b) {
...
return controller._getFolioApprovalLevelsOnAfterFetch$Action(controller.callContext(callContext));
});
}.bind(this);
...
span.setAttribute("outsystems.function.key", "f250ec7b-86b7-486a-af41-88cec6116262");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "SCREEN_SERVICE_AGGREGATE_CALL");
}
...
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callDataAction("DataActionGetUserData", "screenservices/ConectaProveedores/j_FoliosSAE/ForeignInvoicesPendingValidation/DataActionGetUserData", "UKNY1DoOEenSfkY6Pstliw", function (b) {
...
return controller._getUserDataOnAfterFetch$Action(controller.callContext(callContext));
});
}.bind(this);
return OS$Logger.startActiveSpan("GetUserData", function (span) {
if(span) {
span.setAttribute("code.function", "GetUserData");
span.setAttribute("outsystems.function.key", "ec5c8bca-b61c-4d60-a50e-defa1f958393");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
this._dataFetchActionNames = ["getFolioStatuses$AggrRefresh", "getFolioApprovalLevelsByAssignedTo$AggrRefresh", "getUserData$DataActRefresh"];
}
...
span.setAttribute("outsystems.function.key", "03e3d418-0c4f-4278-b799-dbe682264a3d");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.OnPaginationNavigate$vars"))());
...
var result = controller.getFolioApprovalLevelsByAssignedTo$AggrRefresh(ConectaProveedoresClientVariables.getMaxRecords(), 0, callContext);
model.flush();
...
span.setAttribute("outsystems.function.key", "08dd5582-d099-477b-be64-2b365ae8940a");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
;
_getFolioApprovalLevelsOnAfterFetch$Action(callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
return OS$Logger.startActiveSpan("GetFolioApprovalLevelsOnAfterFetch", function (span) {
if(span) {
span.setAttribute("code.function", "GetFolioApprovalLevelsOnAfterFetch");
span.setAttribute("outsystems.function.key", "25801144-1d52-44bb-a000-64fd9f855323");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
return OS$Flow.tryFinally(function () {
controller.ensureControllerAlive("GetFolioApprovalLevelsOnAfterFetch");
callContext = controller.callContext(callContext);
...
model.flush();
return controller.getSettings$ServerAction(idService.getId("Table_ForeignInvoicesPendingValidation"), callContext).then(function (value) {
...
if(span) {
span.setAttribute("code.function", "ColumnTogglerPassColumn");
span.setAttribute("outsystems.function.key", "26dd84b5-b96d-4941-8c21-92729c0d47b5");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.ColumnTogglerPassColumn$vars"))());
vars.value.columnJSONInLocal = columnJSONIn;
return OS$Flow.executeAsyncFlow(function () {
// Execute Action: ColumnTogglerPassColumn
model.flush();
return controller.columnTogglerPassColumn$ServerAction(vars.value.columnJSONInLocal, idService.getId("Table_ForeignInvoicesPendingValidation"), OS$BuiltinFunctions.getUserId(), callContext).then(function () {
...
span.setAttribute("outsystems.function.key", "414a96e1-dfad-41da-8bec-15df6c0b684d");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.DropdownSuppliersOnChanged$vars"))());
vars.value.supplierIdInLocal = supplierIdIn;
return OS$Flow.executeAsyncFlow(function () {
// FoliosSAERejected_SupplierId = SupplierId
ConectaProveedoresClientVariables.setFoliosSAERejected_SupplierId(vars.value.supplierIdInLocal);
...
span.setAttribute("outsystems.function.key", "51dd7490-9f9c-48aa-b887-2a48413ae8b0");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
// Reset Filters
// ForeignInvoicesPendingValidation_FolioNumber = ""
ConectaProveedoresClientVariables.setForeignInvoicesPendingValidation_FolioNumber("");
// ForeignInvoicesPendingValidation_OrderNumber = ""
ConectaProveedoresClientVariables.setForeignInvoicesPendingValidation_OrderNumber("");
// ForeignInvoicesPendingValidation_StatusId = NullIdentifier
ConectaProveedoresClientVariables.setForeignInvoicesPendingValidation_StatusId(OS$BuiltinFunctions.nullIdentifier());
// ForeignInvoicesPendingValidation_SupplierId = NullIdentifier
ConectaProveedoresClientVariables.setForeignInvoicesPendingValidation_SupplierId(OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()));
} finally {
if(span) {
span.end();
}
...
span.setAttribute("outsystems.function.key", "5dbddefb-aca1-4ae3-8fc5-6d551f74baa1");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
return OS$Flow.tryFinally(function () {
controller.ensureControllerAlive("GetUserDataOnAfterFetch");
callContext = controller.callContext(callContext);
return OS$Flow.executeAsyncFlow(function () {
// not IsCxP
return OS$Flow.executeSequence(function () {
if(((!(model.variables.getUserDataDataAct.o_IsUserCxPOut)))) {
...
span.setAttribute("outsystems.function.key", "c115f6c0-aeae-489e-83ff-d3b515ab88bc");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.OnSort$vars"))());
...
span.setAttribute("outsystems.function.key", "f6a2c959-c29c-4d21-875e-8fae6dae4c03");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.RefreshList$vars"))());
...
getFolioApprovalLevelsOnAfterFetch$Action(callContext) {
var controller = this.controller;
return OS$Logger.startActiveSpan("GetFolioApprovalLevelsOnAfterFetch__proxy", function (span) {
if(span) {
span.setAttribute("code.function", "GetFolioApprovalLevelsOnAfterFetch");
span.setAttribute("outsystems.function.key", "25801144-1d52-44bb-a000-64fd9f855323");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
...
return OS$Flow.tryFinally(function () {
return controller.safeExecuteClientAction(controller._getFolioApprovalLevelsOnAfterFetch$Action, callContext);
}, function () {
if(span) {
span.end();
}
...
return OS$Flow.tryFinally(function () {
return controller.safeExecuteClientAction(controller._getUserDataOnAfterFetch$Action, callContext);
}, function () {
if(span) {
span.end();
}
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation$ActionGetSettings", [{
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.OnPaginationNavigate$vars", [{
name: "NewStartIndex",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.ColumnTogglerPassColumn$vars", [{
name: "ColumnJSON",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.DropdownSuppliersOnChanged$vars", [{
name: "SupplierId",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.OnSort$vars", [{
name: "SortBy",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.ForeignInvoicesPendingValidation.RefreshList$vars", [{
