...
import ModelFactory from "./ConectaProveedores.j_FoliosSAE.Wb_FolioSAEFilesPreview.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.j_FoliosSAE.Wb_FolioSAEFilesPreview.mvc$controller.js";
...
return createElement("div", props.rootNodeProperties, $if(model.variables.getFolioFilesDataAct.isDataFetchedAttr, false, this, function () {
...
}, $if(!(model.variables.getFolioFilesDataAct.fileXMLOut.equals(OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()))), false, this, function () {
...
i_TagText: "xml",
i_IsTagStyle: true,
i_StorageId: model.variables.getFolioFilesDataAct.fileXMLOut,
_i_StorageIdInDataFetchStatus: OS$Model.calculateDataFetchStatus(model.variables.getFolioFilesDataAct.dataFetchStatusAttr),
i_FileSize: model.variables.getFolioFilesDataAct.fileSizeXMLOut,
...
return [];
}), $if(!(model.variables.getFolioFilesDataAct.filePDFOut.equals(OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()))), false, this, function () {
return [createElement(ConectaProveedores_s_Storage_wb_PreviewFile_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
...
inputs: {
i_FileSize: model.variables.getFolioFilesDataAct.fileSizePDFOut,
_i_FileSizeInDataFetchStatus: OS$Model.calculateDataFetchStatus(model.variables.getFolioFilesDataAct.dataFetchStatusAttr),
i_IsTagStyle: true,
i_TagText: "pdf",
i_ExtendedClass: "margin-right-s",
i_StorageId: model.variables.getFolioFilesDataAct.filePDFOut,
_i_StorageIdInDataFetchStatus: OS$Model.calculateDataFetchStatus(model.variables.getFolioFilesDataAct.dataFetchStatusAttr)
},
events: {
_handleError: function (ex) {
...
return [];
}), $if((!(model.variables.getFolioFilesDataAct.otherFilesOut.isEmpty)), false, this, function () {
...
return [$text(getTranslation("Rmp4T7fNLECeUoSjeoDROw#Value", "others"))];
})
},
_dependencies: []
}))];
...
return [$text(getTranslation("ePsB+rCjukCMJGdSeKzpvQ#Value", "Other files"))];
})
},
_dependencies: []
})];
...
inputs: {
StorageFileList: model.variables.getFolioFilesDataAct.otherFilesOut,
_storageFileListInDataFetchStatus: OS$Model.calculateDataFetchStatus(model.variables.getFolioFilesDataAct.dataFetchStatusAttr)
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
return {
codeFunction: "Wb_FolioSAEFilesPreview",
functionKey: "58a3bff9-6183-4ea5-b6fc-bdfe7159cfef",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "j_FoliosSAE.Wb_FolioSAEFilesPreview",
...
return ["css/OutSystemsReactWidgets.css", "css/ConectaProveedores.j_FoliosSAE.Wb_FolioSAEFilesPreview.css"];
};
