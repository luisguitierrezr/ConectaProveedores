...
import ConectaProveedores_z_TableDownloadsPDF_Controller_translationsResources from "./ConectaProveedores.z_TableDownloadsPDF.controller$translationsResources.js";
...
OS$Logger.debug("z_TableDownloadsPDF", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_z_TableDownloadsPDF_Controller_translationsResources);
