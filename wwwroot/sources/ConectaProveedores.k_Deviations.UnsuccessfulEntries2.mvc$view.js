...
import ModelFactory from "./ConectaProveedores.k_Deviations.UnsuccessfulEntries2.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.k_Deviations.UnsuccessfulEntries2.mvc$controller.js";
...
text: [$text(getTranslation("28WgS3g0m02CXvexqC8Zqw#Value", "Homepage"))],
_idProps: {
service: idService,
uuid: "5"
},
...
text: [$text(getTranslation("bzGgZkLPCUGIEwN_BASHCg#Value", "Unsuccessful Entries"))],
_idProps: {
service: idService,
uuid: "8"
},
...
style: "display",
text: [$text(getTranslation("6JiKNjA+fkGcELR73VV+fQ#Value", "Unsuccessful Entries"))],
_idProps: {
service: idService,
uuid: "9"
},
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("4H6Da6v3T0OcQY0Y9v0nXA#Value", "Order Number"))), createElement(OSWidgets$Input, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
mandatory: false,
maxLength: 0,
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("4UprjRW9cE+iJC2hgnm0YQ#ValueExpression.69519515.1", "Order Number"),
style: "form-control",
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("q9iCIT_+8EWjZhlux8GAFg#Value", "Folio Number"))), createElement(OSWidgets$Input, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
mandatory: false,
maxLength: 13,
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("eS53J+HDxEuqGPdMeDyrhQ#ValueExpression.-1141793184.1", "Folio Number"),
style: "form-control",
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("gFERpIpm5EGjF97F4D6SdA#Value", "Supplier"))), createElement(OutSystemsUI_Interaction_DropdownSearch_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
getOwnerDisposeSpan: function () {
...
rec.valueAttr = OS$BuiltinFunctions.longIntegerToText(ConectaProveedoresClientVariables.getInvoice_SupplierId());
rec.labelAttr = "";
return rec;
}()]);
return list;
...
rec.searchPromptAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("pI6y8Azcg0G7a2MsKkvGSg#Value.-512840794.1", "Search...");
rec.noOptionsTextAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("qt1OtWdYE02gVk+_KhLXuQ#Value.-1274859484.1", "No suppliers to show...");
return rec;
}();
})
},
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("dtQa2f8xcUqv2j7jmV1Qag#Value", "Folio Status"))), createElement(OSWidgets$Dropdown, {
_validationProps: {
validationService: validationService
},
dropdownMode: /*Text*/ 0,
emptyValue: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("E4O6f83J2ESHoy1eNHQ1bw#ValueExpression.65921.1", "All"),
enabled: true,
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("uVYLha4v80m_SyjbVVwpcA#Value", "SAP Error"))), createElement(OSWidgets$Input, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
mandatory: false,
maxLength: 500,
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("YsLZOZCIo0eEoueJJ9tlqQ#ValueExpression.887872522.1", "SAP Error"),
style: "form-control",
...
text: [$text(getTranslation("wXxKQsmWpUKxuprvuHoQ_A#Value", "There are no pending folios at this moment."))],
_idProps: {
service: idService,
uuid: "34"
},
...
text: [$text(getTranslation("K_cMeaKNzkqJFB8DU8E6lg#Value", "Table settings"))],
_idProps: {
service: idService,
uuid: "39"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("UFCRva9tvUiFTqvuSdlAxQ#Value", "Folio Number"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("ynTiLuvinEGI+QE4Jq0Niw#Value", "Region"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: center;"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("SGrCKuhu90+yjdAtWZDieg#Value", "Order Number"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("jsYcbcZIgUaeCNYtjgpuCw#Value", "Supplier "))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("24glBOXaW0myqRrKMxJjoQ#Value", "Invoice Number"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: center;"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("g0YXkN3GykiZ7ADQLRca7g#Value", "Folio Status"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("oURqGdd3q0yJYLLwS015wA#Value", "Error Message")))];
}),
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: [asPrimitiveValue(model.variables.getDataAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getDataAggr.listOut.getCurrent(callContext.iterationContext).supplierAttr.numberAttr), asPrimitiveValue(model.variables.getDataAggr.listOut.getCurrent(callContext.iterationContext).supplierAttr.nameAttr)]
...
value: model.getCachedValue(idService.getId("z8gcjGBUq0qOEAnL+rHK2Q.Value"), function () {
...
_dependencies: [asPrimitiveValue(ConectaProveedoresClientVariables.getMaxRecords()), asPrimitiveValue(model.variables.i_StartIndexVar), asPrimitiveValue(model.variables.i_ReInvokeTogglerVar), asPrimitiveValue(model.variables.i_ColumnsListInJSONVar), asPrimitiveValue(model.variables.getDataAggr.countOut), asPrimitiveValue(model.variables.getDataAggr.listOut), asPrimitiveValue(model.variables.getDataAggr.isDataFetchedAttr), asPrimitiveValue(ConectaProveedoresClientVariables.getInvoice_UploadDateTo()), asPrimitiveValue(ConectaProveedoresClientVariables.getInvoice_UploadDateFrom()), asPrimitiveValue(ConectaProveedoresClientVariables.getInvoice_RequisitionName()), asPrimitiveValue(ConectaProveedoresClientVariables.getInvoice_InvoiceName()), asPrimitiveValue(ConectaProveedoresClientVariables.getUnsuccessfulEntries_SAPError()), asPrimitiveValue(model.variables.getFolioStatusAggr.listOut), asPrimitiveValue(ConectaProveedoresClientVariables.getUnsuccessfulEntries_FolioStatus()), asPrimitiveValue(ConectaProveedoresClientVariables.getInvoice_SupplierId()), asPrimitiveValue(model.variables.getDataAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getFolioStatusAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getSuppliersAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getSuppliersAggr.listOut), asPrimitiveValue(ConectaProveedoresClientVariables.getUnsuccessfulEntries_FolioNumber()), asPrimitiveValue(ConectaProveedoresClientVariables.getUnsuccessfulEntries_OrderNumber())]
}));
}, {
topLevelComponent: true,
getAttributes: function () {
return {
codeFunction: "UnsuccessfulEntries2",
functionKey: "db102b03-55ec-4e1b-89ea-f9f409f22076",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "k_Deviations.UnsuccessfulEntries2",
...
return [ConectaProveedores_a_Layouts_LayoutTopMenu_mvc_view, CloneOfDebounce_DebounceFlow_Debounce_mvc_view, OutSystemsUI_Interaction_DropdownSearch_mvc_view, OutSystemsUI_Interaction_ScrollableArea_mvc_view, Telcel_Theme_Utils_Wb_ShortText_mvc_view, Telcel_Theme_Utils_Wb_SupplierName_mvc_view, Telcel_Theme_Utils_Wb_Status_mvc_view, ColumOrganizerLib_ColumOrganizerLib_ColumnToggler_mvc_view, Telcel_Theme_Utils_Wb_CustomPagination_mvc_view, ConectaProveedores_y_Utils_Wb_SetTableRecord_mvc_view];
};
