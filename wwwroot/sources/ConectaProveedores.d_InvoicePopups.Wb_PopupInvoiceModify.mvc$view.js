...
import ModelFactory from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceModify.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceModify.mvc$controller.js";
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("BnVxsm9jSkaGUtxgIx6Ahw#Value", "Modify invoice"))), createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
extendedProperties: {
...
align: /*Default*/ 0,
animate: false,
style: model.getCachedValue(idService.getId("FOEkR5DqQU6C8isxMJ+Csw.Style"), function () {
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("kA8ybu71Ik6jW0Up99x5Ig#Value", "Comment"))), createElement(OSWidgets$TextArea, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
mandatory: false,
maxLength: 250,
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("BzkJMxto3UG8BiNDPBlJkw#ValueExpression.1782764159.1", "Provide a reason for the modification request..."),
style: "form-control",
textLines: 2,
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("iJWHAMGTmUanjqlsWtZvNw#Value", "Close"))), createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
gridProperties: {
...
var eventHandlerContext = typeof callContext !== 'undefined' && callContext !== null ? callContext.clone() : controller.callContext().clone();
return controller.modifyOnClick$Action(controller.callContext(eventHandlerContext));
});
;
},
...
_widgetRecordProvider: widgetsRecordProvider
}), $text(getTranslation("9CXubL46Y0eAHImOEBGqZw#Value", "Modify")))];
})
},
...
return {
codeFunction: "Wb_PopupInvoiceModify",
functionKey: "7e6d5286-b7d9-45f4-b00c-da27c73c70e9",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "d_InvoicePopups.Wb_PopupInvoiceModify",
