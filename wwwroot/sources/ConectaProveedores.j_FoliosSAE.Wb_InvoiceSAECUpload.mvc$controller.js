...
import { ST_1d6498da9105fbe815a7f766352917c0Structure, ST_f9f8b40f5330871047e55e068d129447Structure, ST_6dc39d329f4b959722daa75bc2f62c1fStructure, ST_09ca0b4d4a2f96d3f5dee609d73f12b2Structure, EN_d1d0320db36efbb094ad0082361435a0EntityRecord, EN_f81a3d226103fd013068b8763798067aEntityRecord, ST_7837994e68174a4794f15e4233b48555Structure } from "./ConectaProveedores.model.js";
...
import ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_mvc_TranslationsResources from "./ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_mvc_TranslationsResources);
...
return controller.callServerAction("Invoice_OCR", "screenservices/ConectaProveedores/j_FoliosSAE/Wb_InvoiceSAECUpload/ActionInvoice_OCR", "l1Z7Ht+TQvOx9ZV7WJjjKA", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload$ActionInvoice_OCR"))();
...
return controller.callServerAction("UploadInvoiceFiles", "screenservices/ConectaProveedores/j_FoliosSAE/Wb_InvoiceSAECUpload/ActionUploadInvoiceFiles", "N89602WQuvEMIeUa+aj8jw", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload$ActionUploadInvoiceFiles"))();
...
return controller.callDataAction("DataActionGetSupplier", "screenservices/ConectaProveedores/j_FoliosSAE/Wb_InvoiceSAECUpload/DataActionGetSupplier", "joSB6Txac71noZ3K6eMuYw", function (b) {
...
span.setAttribute("outsystems.function.key", "72f20306-4d16-47df-ae95-bf989469fbbb");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "02a4b323-35ca-43d2-aa91-713e4fc8cdc9");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "227fd177-4342-4ab8-8a7d-2e0c5e4d241b");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.CustomUploadOnFileChange$vars"))());
...
return target;
}), new (OS$GenericTypeCache.getGenericList(ST_7837994e68174a4794f15e4233b48555Structure))(), true, model.variables.invoiceForeignVar, OS$BuiltinFunctions.integerToDecimal(0), false, false, 0, model.variables.accDataVar.orderAccConceptIDAttr, model.variables.importAnticipoIn, OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()), ConectaProveedoresClientVariables.getOffsetUtc(), callContext).then(function (value) {
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("tEQyRpDV0kC2jJtRNx2K+g#Message.-1235798656.1", "This request requires a credit note to proceed."), /*Warning*/ 2);
...
// ToStore_InvoiceExtended = UploadInvoiceFiles.o_InvoiceExtended
model.variables.toStore_InvoiceExtendedVar = uploadInvoiceFilesVar.value.o_InvoiceExtendedOut;
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("iJs8+68aVUiDNJV29MO4_g#Message.875725967.1", "Empty file"), /*Error*/ 3);
...
span.setAttribute("outsystems.function.key", "45272c1b-22b4-45d6-84cc-42d655764804");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "8af124da-c622-44c0-9c17-53c21e2fb612");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "a3e95336-837a-4254-94ff-2381465d5c95");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.ValidationMainXMLPdf$vars"))());
vars.value.fileInLocal = fileIn.clone();
// 1 national or 0
...
model.variables.errorMsgVar = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("2yhXHgQaoEGaiV4DMroTaA#Value.-316167296.1", "File names should correspond");
}

} else {
// ErrorMsg = "File name should have maximum 20 digits"
model.variables.errorMsgVar = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("QB5TfZZ0PEGDZJUo46tqOQ#Value.-233626228.1", "File name should have maximum 20 digits");
}

} else {
// ErrorMsg = If
model.variables.errorMsgVar = ((model.variables.getSupplierDataAct.isNationalOut) ? (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("F0fXTKqON0W7mj9RS0Iv5A#Value.-1018373344.1", "Main files should be xml and pdf")) : (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("F0fXTKqON0W7mj9RS0Iv5A#Value.-704563035.1", "Main file should be pdf")));
}

} else {
// ErrorMsg = If
model.variables.errorMsgVar = ((model.variables.getSupplierDataAct.isNationalOut) ? (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("k3Xp5uDMoUe1E5sYlwkgqw#Value.-451005041.1", "Main files are limited to 2")) : (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("k3Xp5uDMoUe1E5sYlwkgqw#Value.-1983470837.1", "Main file is limited to 1")));
}
...
;
_wb_FolioAccSelectSendOrderAccConcept$Action(oFolioAccDataIn, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
return OS$Logger.startActiveSpan("wb_FolioAccSelectSendOrderAccConcept", function (span) {
if(span) {
span.setAttribute("code.function", "wb_FolioAccSelectSendOrderAccConcept");
span.setAttribute("outsystems.function.key", "a4f5ff55-37a9-4eac-af1f-08734fe7e36d");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
return OS$Flow.tryFinally(function () {
controller.ensureControllerAlive("wb_FolioAccSelectSendOrderAccConcept");
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.wb_FolioAccSelectSendOrderAccConcept$vars"))());
...
// Trigger Event: SendAccConceptType
return controller.sendInvoiceType$Action(model.variables.accDataVar.orderAccConceptIDAttr, callContext);
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "b0d7666c-d284-4d46-9315-5b4b2a6ed040");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.ValidationCreditNotes$vars"))());
vars.value.fileInLocal = fileIn.clone();
// 1 national or 0
...
// ErrorMsg = "File names should correspond"
model.variables.errorMsgVar = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("7kMbNUnOiEipmC438VSRxA#Value.-316167296.1", "File names should correspond");
}

} else {
// ErrorMsg = "File name should have maximum 20 digits"
model.variables.errorMsgVar = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("8B94DoPQiUO4MIPMqiBWKA#Value.-233626228.1", "File name should have maximum 20 digits");
}

} else {
// ErrorMsg = If
model.variables.errorMsgVar = ((model.variables.getSupplierDataAct.isNationalOut) ? (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("lQQDJ3kwpUSAFgGKu52euA#Value.-1018373344.1", "Main files should be xml and pdf")) : (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("lQQDJ3kwpUSAFgGKu52euA#Value.-704563035.1", "Main file should be pdf")));
}

} else {
// ErrorMsg = If
model.variables.errorMsgVar = ((model.variables.getSupplierDataAct.isNationalOut) ? (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("C9dcwJTWGE2pd_AaNupofw#Value.-451005041.1", "Main files are limited to 2")) : (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("C9dcwJTWGE2pd_AaNupofw#Value.-1983470837.1", "Main file is limited to 1")));
}
...
span.setAttribute("outsystems.function.key", "b70686a1-45b1-41e3-b596-419e4304f634");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.DatePickerInvoiceDate$vars"))());
...
span.setAttribute("outsystems.function.key", "c755ae8c-3705-4442-ab55-1a551dbdf2e3");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.CustomUploadOnFileChangeCreditNote$vars"))());
vars.value.fileInLocal = fileIn.clone();
vars.value.errorInLocal = errorIn.clone();
var uploadInvoiceFilesVar = new OS$DataTypes.VariableHolder();
return OS$Flow.executeAsyncFlow(function () {
...
// Execute Action: UploadInvoiceFiles
model.flush();
return controller.uploadInvoiceFiles$ServerAction(OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()), OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()), model.variables.orderIdIn, OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()), OS$DataConversion.JSConversions.typeConvertRecordList(model.variables.creditNoteFilesListVar, new (OS$GenericTypeCache.getGenericList(ST_7837994e68174a4794f15e4233b48555Structure))(), function (source, target) {
target.invoiceFileIdAttr = OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier());
target.nameAttr = source.nameAttr;
target.binaryDataAttr = source.binaryDataAttr;
return target;
...
// Trigger Event: SendFiles
return controller.sendFiles$Action(model.variables.filesListVar, model.variables.toStore_InvoiceVar, model.variables.invoiceForeignVar, model.variables.toStore_InvoiceExtendedVar, model.variables.getSupplierDataAct.isNationalOut, model.variables.toStore_ClaveProdServVar, model.variables.toStore_TipoDeComprobanteVar, model.variables.creditNoteFilesListVar, uploadInvoiceFilesVar.value.o_InvoiceOut, true, callContext).then(function () {
// Execute Action: HideLoading
ConectaProveedoresController$hideLoading$Action(callContext);
});
}
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("85+p2j7DFUi1X4ej4UNh2w#Message.875725967.1", "Empty file"), /*Error*/ 3);
// Execute Action: HideLoading3
ConectaProveedoresController$hideLoading$Action(callContext);
}
...
span.setAttribute("outsystems.function.key", "eb716186-b2de-4fd1-8bb0-d16038b5513f");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.RemoveFromListCreditNote$vars"))());
...
span.setAttribute("outsystems.function.key", "f507e5e3-64f8-4a36-bd0f-b0fd61309f57");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.RemoveFromList$vars"))());
vars.value.indexInLocal = indexIn;
return OS$Flow.executeAsyncFlow(function () {
// Execute Action: ListRemove
...
span.setAttribute("outsystems.function.key", "fabbf381-c5e8-4987-aa37-54081d93b223");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.OnClosePopupForeigner$vars"))());
...
return controller.sendFiles$Action(model.variables.filesListVar, vars.value.emptyInvoiceVar, model.variables.invoiceForeignVar, new EN_f81a3d226103fd013068b8763798067aEntityRecord(), model.variables.getSupplierDataAct.isNationalOut, "", "", new (OS$GenericTypeCache.getGenericList(ST_09ca0b4d4a2f96d3f5dee609d73f12b2Structure))(), new EN_d1d0320db36efbb094ad0082361435a0EntityRecord(), false, callContext).then(function () {
// Execute Action: HideLoading3
ConectaProveedoresController$hideLoading$Action(callContext);
});
} else {
...
target.binaryDataAttr = source.binaryDataAttr;
return target;
}), new (OS$GenericTypeCache.getGenericList(ST_7837994e68174a4794f15e4233b48555Structure))(), true, model.variables.invoiceForeignVar, OS$BuiltinFunctions.integerToDecimal(0), false, false, 0, model.variables.accDataVar.orderAccConceptIDAttr, model.variables.importAnticipoIn, OS$DataTypes.LongInteger.defaultValue, ConectaProveedoresClientVariables.getOffsetUtc(), callContext).then(function (value) {
uploadInvoiceFilesVar.value = value;
}).then(function () {
// error?
return OS$Flow.executeSequence(function () {
...
controller._togglePopupForeigner$Action(callContext);
// set subtotal
// UploadInvoiceFiles.o_InvoiceExtended.Subtotal = TextToDecimal
uploadInvoiceFilesVar.value.o_InvoiceExtendedOut.subtotalAttr = OS$BuiltinFunctions.textToDecimal(model.variables.invoiceForeignVar.totalAmountAttr);
// Trigger Event: SendFiles
return controller.sendFiles$Action(model.variables.filesListVar, uploadInvoiceFilesVar.value.o_InvoiceOut, model.variables.invoiceForeignVar, uploadInvoiceFilesVar.value.o_InvoiceExtendedOut, model.variables.getSupplierDataAct.isNationalOut, "", "", new (OS$GenericTypeCache.getGenericList(ST_09ca0b4d4a2f96d3f5dee609d73f12b2Structure))(), new EN_d1d0320db36efbb094ad0082361435a0EntityRecord(), false, callContext).then(function () {
// Execute Action: HideLoading2
ConectaProveedoresController$hideLoading$Action(callContext);
...
wb_FolioAccSelectSendOrderAccConcept$Action(oFolioAccDataIn, callContext) {
var controller = this.controller;
return OS$Logger.startActiveSpan("wb_FolioAccSelectSendOrderAccConcept__proxy", function (span) {
if(span) {
span.setAttribute("code.function", "wb_FolioAccSelectSendOrderAccConcept");
span.setAttribute("outsystems.function.key", "a4f5ff55-37a9-4eac-af1f-08734fe7e36d");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
...
return OS$Flow.tryFinally(function () {
return controller.safeExecuteClientAction(controller._wb_FolioAccSelectSendOrderAccConcept$Action, callContext, oFolioAccDataIn);
}, function () {
if(span) {
span.end();
}
...
get removeFile$Action() {if(!(this.hasOwnProperty("_removeFile$Action"))) {
this._removeFile$Action = function () {
return Promise.resolve();
};
}

return this._removeFile$Action;
}set removeFile$Action(value) {this._removeFile$Action = value;
}

get sendInvoiceType$Action() {if(!(this.hasOwnProperty("_sendInvoiceType$Action"))) {
this._sendInvoiceType$Action = function () {
return Promise.resolve();
};
}

return this._sendInvoiceType$Action;
}set sendInvoiceType$Action(value) {this._sendInvoiceType$Action = value;
}
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload$ActionInvoice_OCR", [{
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload$ActionUploadInvoiceFiles", [{
name: "ErrorMsg",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.CustomUploadOnFileChange$vars", [{
name: "File",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.ValidationMainXMLPdf$vars", [{
name: "File",
attrName: "fileInLocal",
mandatory: false,
dataType: OS$DataTypes.DataTypes.Record,
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.wb_FolioAccSelectSendOrderAccConcept$vars", [{
name: "oFolioAccData",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.ValidationCreditNotes$vars", [{
name: "File",
attrName: "fileInLocal",
mandatory: false,
dataType: OS$DataTypes.DataTypes.Record,
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.DatePickerInvoiceDate$vars", [{
name: "SelectedDate",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.CustomUploadOnFileChangeCreditNote$vars", [{
name: "File",
attrName: "fileInLocal",
mandatory: false,
dataType: OS$DataTypes.DataTypes.Record,
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.RemoveFromListCreditNote$vars", [{
name: "Index",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.RemoveFromList$vars", [{
name: "Index",
attrName: "indexInLocal",
mandatory: true,
dataType: OS$DataTypes.DataTypes.Integer,
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.Wb_InvoiceSAECUpload.OnClosePopupForeigner$vars", [{
name: "IsSave",
