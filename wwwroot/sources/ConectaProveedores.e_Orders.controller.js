...
import ConectaProveedores_e_Orders_Controller_translationsResources from "./ConectaProveedores.e_Orders.controller$translationsResources.js";
...
OS$Logger.debug("e_Orders", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_e_Orders_Controller_translationsResources);
