...
import { SE_size as ConectaProveedores_staticEntities_size, SE_color as ConectaProveedores_staticEntities_color, SE_trigger as ConectaProveedores_staticEntities_trigger, SE_position as ConectaProveedores_staticEntities_position } from "./ConectaProveedores.staticEntities.js";
...
import ModelFactory from "./ConectaProveedores.j_FoliosSAE.Wb_UploadDocumentsConstructionOld.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.j_FoliosSAE.Wb_UploadDocumentsConstructionOld.mvc$controller.js";
...
value: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("xWNyUEK3V0qEs4ll0rdkTw#ValueExpression.791976156.1", "Attach Files"),
_idProps: {
service: idService,
uuid: "4"
},
...
text: [$text(getTranslation("aSFz_EDLNkyiKltPtC6P7g#Value", "Click here or drag files to upload"))],
_idProps: {
service: idService,
uuid: "6"
},
...
extendedProperties: {
style: model.getCachedValue(idService.getId("yTPnvhqvR0G0Rs1r2B4e9Q.style"), function () {
...
style: model.getCachedValue(idService.getId("k_IVK55ZfU6oA5MW4mBgUg.Style"), function () {
...
value: (((((OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("pxG9ED_35U6d0nESN9yNLQ#ValueExpression.1206668878.1", "The filename should be as:") + " ") + model.variables.listAuxVar.getCurrent(callContext.iterationContext).fileNameAttr) + "_") + model.variables.orderNumberIn) + ".{}"),
_idProps: {
service: idService,
uuid: "28"
},
...
return {
codeFunction: "Wb_UploadDocumentsConstructionOld",
functionKey: "e639218e-4dba-4d4c-9e07-f65953eac827",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "j_FoliosSAE.Wb_UploadDocumentsConstructionOld",
...
return ["css/font-awesome.min.css", "css/OutSystemsReactWidgets.css", "css/ConectaProveedores.j_FoliosSAE.Wb_UploadDocumentsConstructionOld.css"];
};
