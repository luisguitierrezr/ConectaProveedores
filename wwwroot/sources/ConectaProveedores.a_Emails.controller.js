...
import ConectaProveedores_a_Emails_Controller_translationsResources from "./ConectaProveedores.a_Emails.controller$translationsResources.js";
...
OS$Logger.debug("a_Emails", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_a_Emails_Controller_translationsResources);
