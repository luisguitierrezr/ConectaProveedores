...
import { ST_bc4abb4233d9ce894e855c520a20c76fStructure, ST_09173c1b0f41f719b9efd6430c2e737dStructure } from "./OutSystemsUI.model.js";
...
import ModelFactory from "./ConectaProveedores.j_FoliosSAE.FoliosSAEForApproval.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.j_FoliosSAE.FoliosSAEForApproval.mvc$controller.js";
...
text: [$text(getTranslation("5C7YkHgaM0aO9ZyWCiA0WA#Value", "Homepage"))],
_idProps: {
service: idService,
uuid: "5"
},
...
text: [$text(getTranslation("zwPPs5h520GAH6hlO778Aw#Value", "Dashboard"))],
_idProps: {
service: idService,
uuid: "9"
},
...
text: [$text(getTranslation("BhbAOWFXPECvD51MZy6j5w#Value", "Folios SAEC"))],
_idProps: {
service: idService,
uuid: "12"
},
...
style: "display",
text: [$text(getTranslation("RD6gyUErKUCCC9ZP9xDYZg#Value", "Folios SAEC"))],
_idProps: {
service: idService,
uuid: "13"
},
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("fgh7HEzpqEGKmgryc3437w#Value", "Search input"))), createElement(OSWidgets$Input, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
mandatory: false,
maxLength: 50,
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("GxLCZ+izt020imAHwDdBEw#ValueExpression.-1141793184.1", "Folio Number"),
style: "form-control",
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("00Qha4sq60mHC9h4XnSYfA#Value", "Search input"))), createElement(OSWidgets$Input, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
mandatory: false,
maxLength: 50,
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("evdmfW6nJU2QCOZivK5D+w#ValueExpression.69519515.1", "Order Number"),
style: "form-control",
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("GIQAmya4+0yH+BxlgPcULg#Value", "Region"))), createElement(OSWidgets$Dropdown, {
_validationProps: {
validationService: validationService
},
dropdownMode: /*Text*/ 0,
emptyValue: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("wnigmjlfk0uMsHypmNuMWQ#ValueExpression.65921.1", "All"),
enabled: true,
...
i_IsValid: true,
i_IsMandatory: false,
i_SupplierId: ConectaProveedoresClientVariables.getFolioForApproval_SupplierId()
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("+PnIVpWmikqh345E4qjyyA#Value", "Created On Date"))), createElement(OutSystemsUI_Interaction_InputWithIcon_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
getOwnerDisposeSpan: function () {
...
inputs: {
i_Date: ConectaProveedoresClientVariables.getFolioForApproval_CreatedOnDate()
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("jHM2u0F8pk60LFAN9fji0g#ValueExpression.65921.1", "All"),
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("YKwxoGtN2kyDc76OfbIYLg#Value", "Created To Date"))), createElement(OutSystemsUI_Interaction_InputWithIcon_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
getOwnerDisposeSpan: function () {
...
inputs: {
i_Date: ConectaProveedoresClientVariables.getFolioForApproval_CreatedToDate()
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("DT0nQDIOYEuP9MVBb9b6_w#ValueExpression.65921.1", "All"),
style: "form-control cursorpointer",
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("xeU2ndl0RE6ueL27z5yKpQ#Value", "Status"))), createElement(OSWidgets$Dropdown, {
_validationProps: {
validationService: validationService
},
dropdownMode: /*Text*/ 0,
emptyValue: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("Ia0z6PPJ80e_cX+qveKdHw#ValueExpression.65921.1", "All"),
enabled: true,
labels: function (elem) {
...
variable: model.createVariable(OS$DataTypes.DataTypes.Integer, ConectaProveedoresClientVariables.getFolioForApproval_StatusId(), function (value) {
ConectaProveedoresClientVariables.setFolioForApproval_StatusId(value);
}),
_idProps: {
service: idService,
...
visible: model.getCachedValue(idService.getId("3MaRsr0jlkGUdKNI1+Lquw.Visible"), function () {
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("4gKvzmbtlEOWe4E5XOKobg#Value", "Approval Level"))), createElement(OSWidgets$Dropdown, {
_validationProps: {
validationService: validationService
},
dropdownMode: /*Text*/ 0,
...
text: [$text(getTranslation("nMUD0uOIGkKyrkksGFSi4A#Value", "There are no pending folios at this time."))],
_idProps: {
service: idService,
uuid: "60"
},
...
text: [$text(getTranslation("oStdoxuuu0GyN36gva15sw#Value", "Bulk Approve"))],
_idProps: {
service: idService,
uuid: "67"
},
...
text: [$text(getTranslation("U2_je1BjQ0iYvwcMKPMDwA#Value", "Table settings"))],
_idProps: {
service: idService,
uuid: "71"
},
...
extendedProperties: {
style: model.getCachedValue(idService.getId("YaZQua_umUeW6DvUS0RBQQ.style"), function () {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("zKxurOBhC0KT1PNxNIlCBg#Value", "Folio Number"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("Lxrc498plEyp9ynH_mgENQ#Value", "Order Number"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("EOL7ArBeLEq4RX7UUc0UkA#Value", "Supplier"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("vGkVxebPpkeJdSMwY1yTEA#Value", "Region"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("J94xiv3jFUSkkVPGPcD0EQ#Value", "Total Amount"))), createElement(OSWidgets$HeaderCell, {
_idProps: {
service: idService,
uuid: "83"
},
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("3hhELDq8bki57u2TB1e5GQ#Value", "Currency"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: center;"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("eePsw2KPPkC7Jk_dWxrZpw#Value", "Upload Date"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("mbqM6OxS0UmHORqbypIf5Q#Value", "Action"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("v4oga6cQOUWN9DK4WQMmNQ#Value", "Folio Status"))), createElement(OSWidgets$HeaderCell, {
sortAttribute: "LastApprover.Name",
_idProps: {
service: idService,
uuid: "87"
},
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("EgZSXr6BKU6MVgpcSrt8Vw#Value", "Last Approver")))];
}),
row: new Widget.IteratorPlaceholderContent(function (idService, callContext) {
return [createElement(OSWidgets$RowCell, {
extendedProperties: {
style: model.getCachedValue(idService.getId("xWgJbVUzLUmzePWwg9K8aA.style"), function () {
...
value: model.getCachedValue(idService.getId("pf0K_q+obEGvTb+Y+fwnsQ.Value"), function () {
...
value: model.getCachedValue(idService.getId("PfhNfKycKEamIh8jWktIJA.Value"), function () {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: [asPrimitiveValue(model.variables.getFoliosSAEAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getFoliosSAEAggr.listOut.getCurrent(callContext.iterationContext).approvalStatusAttr.labelAttr)]
}, createElement(OSWidgets$Expression, {
style: "bold",
value: model.variables.getFoliosSAEAggr.listOut.getCurrent(callContext.iterationContext).approvalStatusAttr.labelAttr,
_idProps: {
service: idService,
uuid: "108"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: [asPrimitiveValue(model.variables.getFoliosSAEAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getFoliosSAEAggr.listOut.getCurrent(callContext.iterationContext).lastApproverAttr.nameAttr)]
}, createElement(Telcel_Theme_Utils_Wb_ShortText_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
...
inputs: {
i_Text: model.variables.getFoliosSAEAggr.listOut.getCurrent(callContext.iterationContext).lastApproverAttr.nameAttr,
_i_TextInDataFetchStatus: OS$Model.calculateDataFetchStatus(model.variables.getFoliosSAEAggr.dataFetchStatusAttr),
i_NChar: 20
},
events: {
...
TableName: idService.getId("FoliosTable2"),
...
inputs: {
l_FormApprovalLevelList: model.getCachedValue(idService.getId("Aio9QaJuaUKHrwuhGuDy4Q.l_FormApprovalLevelList"), function () {
...
inputs: {
i_ConfirmationText: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("mrl8JcldbEuTOh6JPeKbUQ#Value.-1066222683.1", "Are you sure you want to approve the form?"),
i_PopupTitle: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("sxolWeCM6kmQZZhHAGtcGA#Value.-1679196512.1", "Confirm")
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
return [$text(getTranslation("xAYAN+CAHUaz3UM33VAnog#Value", "Approve"))];
})
},
_dependencies: []
...
_widgetRecordProvider: widgetsRecordProvider
}), $text(getTranslation("1ybRHMD0Ik+_CvR5hlsjQg#Value", "records have been affected"))), createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
style: "margin-top-base",
visible: true,
...
_widgetRecordProvider: widgetsRecordProvider
}), $text(getTranslation("nRX4yV9JD0a49hABlZyfyQ#Value", "have been successfully processed"))];
})
},
...
_widgetRecordProvider: widgetsRecordProvider
}), $text(getTranslation("xwsFd9Sl8E+AaY_A6RCIwg#Value", "have given an error:"))];
})
},
...
_dependencies: [asPrimitiveValue(model.variables.notifErrorVar.approvalErrorListAttr), asPrimitiveValue(model.variables.notifContentVar.nrOfRecordsUnsuccessfulAttr), asPrimitiveValue(model.variables.notifContentVar.nrOfRecordsSuccessfulAttr), asPrimitiveValue(model.variables.notifContentVar.nrOfRecordsAffectedAttr), asPrimitiveValue(model.variables.notifContentVar.titleAttr), asPrimitiveValue(model.variables.l_ShowApproveFolioVar), asPrimitiveValue(model.variables.l_FolioApprovalLevelListVar), asPrimitiveValue(model.variables.l_ShowBulkApproveFolioVar), asPrimitiveValue(model.variables.l_StartIndexVar), asPrimitiveValue(ConectaProveedoresClientVariables.getMaxRecords()), asPrimitiveValue(model.variables.l_ReInvokeTogglerVar), asPrimitiveValue(model.variables.l_ColumnJSONVarVar), asPrimitiveValue(model.variables.l_IsSelectedVar), asPrimitiveValue(model.variables.l_IsSelectAllVar), asPrimitiveValue(model.variables.l_IsShowSelectAllVar), asPrimitiveValue(model.variables.getFoliosSAEAggr.countOut), asPrimitiveValue(model.variables.getFoliosSAEAggr.listOut), asPrimitiveValue(model.variables.getFoliosSAEAggr.isDataFetchedAttr), asPrimitiveValue(model.variables.getUserApplicationRolesDataAct.canBulkApproveOut), asPrimitiveValue(model.variables.getUserApplicationRolesDataAct.userRolesListOut), asPrimitiveValue(model.variables.l_ApplicationRoleIdForAggregateVar), asPrimitiveValue(model.variables.l_IsAllowSelectApplicationRolesVar), asPrimitiveValue(model.variables.getFolioStatusAggr.listOut), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_StatusId()), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_CreatedToDate()), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_CreatedOnDate()), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_SupplierId()), asPrimitiveValue(model.variables.getFoliosSAEAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getUserApplicationRolesDataAct.dataFetchStatusAttr), asPrimitiveValue(model.variables.getFolioStatusAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getRegionsAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getRegionsAggr.listOut), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_RegionId()), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_OrderNumber()), asPrimitiveValue(ConectaProveedoresClientVariables.getFolioForApproval_FolioNumber())]
}));
}, {
topLevelComponent: true,
getAttributes: function () {
return {
codeFunction: "FoliosSAEForApproval",
functionKey: "98cef058-3aa5-481f-b2e5-1be98a0c67a4",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "j_FoliosSAE.FoliosSAEForApproval",
...
return ["css/font-awesome.min.css", "css/OutSystemsReactWidgets.css", "css/OutSystemsUI.OutSystemsUI.css", "css/Telcel_Theme.Telcel_Theme.css", "css/ConectaProveedores.j_FoliosSAE.FoliosSAEForApproval.css", "css/OutSystemsUI.OutSystemsUI.extra.css"];
};
