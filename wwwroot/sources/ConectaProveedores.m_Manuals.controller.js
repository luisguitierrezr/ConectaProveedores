...
import ConectaProveedores_m_Manuals_Controller_translationsResources from "./ConectaProveedores.m_Manuals.controller$translationsResources.js";
...
OS$Logger.debug("m_Manuals", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_m_Manuals_Controller_translationsResources);
