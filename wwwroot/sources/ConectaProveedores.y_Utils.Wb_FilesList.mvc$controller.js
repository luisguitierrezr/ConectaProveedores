...
import { Controller as OS$Controller, DataTypes as OS$DataTypes, DataConversion as OS$DataConversion, Flow as OS$Flow, Logger as OS$Logger, Exceptions as OS$Exceptions, BuiltinFunctions as OS$BuiltinFunctions } from "@outsystems/runtime-core-js";
import ConectaProveedoresLanguageResources from "./ConectaProveedores.languageResources.js";
import ConectaProveedoresController$default, { showLoading$Action as ConectaProveedoresController$showLoading$Action, hideLoading$Action as ConectaProveedoresController$hideLoading$Action } from "./ConectaProveedores.controller.js";
import ConectaProveedores_y_Utils_Wb_FilesList_mvc_TranslationsResources from "./ConectaProveedores.y_Utils.Wb_FilesList.mvc$translationsResources.js";

{class ControllerInner extends 
OS$Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, ConectaProveedores_y_Utils_Wb_FilesList_mvc_TranslationsResources);
...
return controller.callServerAction("DownloadZipByStorageIdList", "screenservices/ConectaProveedores/y_Utils/Wb_FilesList/ActionDownloadZipByStorageIdList", "_MlgTXx0PjIU+aZSBjJfmg", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.y_Utils.Wb_FilesList$ActionDownloadZipByStorageIdList"))();
...
span.setAttribute("outsystems.function.key", "3cfecc44-e267-47ba-b231-f7d4e61082c9");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "e158cb7a-bdc1-49ee-a5a8-6045dabeaea4");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "f775ec3a-ca54-4b45-a766-b98929bad9fa");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
model.flush();
return controller.downloadZipByStorageIdList$ServerAction(OS$DataConversion.JSConversions.typeConvertRecordList(model.variables.storageFileListIn, new OS$DataTypes.LongIntegerList(), function (source, target) {
target = source.storageIdAttr;
return target;
}), callContext).then(function (value) {
downloadZipByStorageIdListVar.value = value;
}).then(function () {
return OS$Flow.returnAsync(OS$Controller.BaseViewController.downloadBinary(downloadZipByStorageIdListVar.value.binaryZIPOut, (((((model.variables.nameForZIPIn) !== (""))) ? (model.variables.nameForZIPIn) : (OS$BuiltinFunctions.dateToText(OS$BuiltinFunctions.currDate()))) + ".zip")));
});
});
}, function () {
if(span) {
...
Controller.registerVariableGroupType("ConectaProveedores.y_Utils.Wb_FilesList$ActionDownloadZipByStorageIdList", [{
name: "BinaryZIP",
