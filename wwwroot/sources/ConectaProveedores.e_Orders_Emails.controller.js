...
import ConectaProveedores_e_Orders_Emails_Controller_translationsResources from "./ConectaProveedores.e_Orders_Emails.controller$translationsResources.js";
...
OS$Logger.debug("e_Orders_Emails", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_e_Orders_Emails_Controller_translationsResources);
