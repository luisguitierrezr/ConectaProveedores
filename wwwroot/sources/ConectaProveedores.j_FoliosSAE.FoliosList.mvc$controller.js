...
import ConectaProveedores_j_FoliosSAE_FoliosList_mvc_TranslationsResources from "./ConectaProveedores.j_FoliosSAE.FoliosList.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_j_FoliosSAE_FoliosList_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {};
this.dataFetchDependenciesOriginal = {
getFolios$AggrRefresh: 0
};
this.dataFetchDependentsGraph = {
getFolios$AggrRefresh: []
};
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/j_FoliosSAE/FoliosList/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
get getFolios$AggrRefresh() {if(!(this.hasOwnProperty("_getFolios$AggrRefresh"))) {
this._getFolios$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetFolios", "screenservices/ConectaProveedores/j_FoliosSAE/FoliosList/ScreenDataSetGetFolios", "TmqXVOvvdYfwIh_RbRQw4w", maxRecords, startIndex, function (b) {
model.variables.getFoliosAggr.dataFetchStatusAttr = b;
}, function (json) {
model.variables.getFoliosAggr.replaceWith(OS$DataConversion.ServerDataConverter.from(json, model.variables.getFoliosAggr.constructor));
}, undefined, undefined, undefined, callContext, ConectaProveedoresClientVariables, true);
}.bind(this);
return OS$Logger.startActiveSpan("GetFolios", function (span) {
if(span) {
span.setAttribute("code.function", "GetFolios");
span.setAttribute("outsystems.function.key", "f820809f-0279-4e45-8f5a-dbbaa8afafd3");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
return this._getFolios$AggrRefresh;
}set getFolios$AggrRefresh(value) {this._getFolios$AggrRefresh = value;
}


get dataFetchActionNames() {if(!(this.hasOwnProperty("_dataFetchActionNames"))) {
this._dataFetchActionNames = ["getFolios$AggrRefresh"];
}
...
span.setAttribute("outsystems.function.key", "7ebeedb9-917c-42c1-852e-ff32c6fb1eab");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "9232f363-a8a0-4685-b087-9c33f753ef92");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.FoliosList.OnPaginationNavigate$vars"))());
...
var result = controller.getFolios$AggrRefresh(model.variables.maxRecordsVar, model.variables.startIndexVar, callContext);
model.flush();
return result;
});
}, function () {
...
span.setAttribute("outsystems.function.key", "ac418db9-8ce2-4e78-a226-fe63cb8da086");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.FoliosList.OnSort$vars"))());
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.FoliosList.OnPaginationNavigate$vars", [{
name: "NewStartIndex",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.FoliosList.OnSort$vars", [{
name: "SortBy",
