...
import { RC_99fa4277b2264c97bde8f4525bdc92e0, ST_00c299856fb2c1322ea33527b24c9dd0Structure, ST_a158c76eb93396680623c04244f48b6cStructure } from "./ConectaProveedores.model.js";
...
import ConectaProveedores_e_Orders_OrdersInComplement_mvc_TranslationsResources from "./ConectaProveedores.e_Orders.OrdersInComplement.mvc$translationsResources.js";
import ConectaProveedores_e_OrdersController$default from "./ConectaProveedores.e_Orders.controller.js";

{class ControllerInner extends 
OS$Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, ConectaProveedores_e_Orders_OrdersInComplement_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {};
this.dataFetchDependenciesOriginal = {
getOrdersInComplementFull$AggrRefresh: -1,
getOrdersInComplement$AggrRefresh: 0
};
this.dataFetchDependentsGraph = {
getOrdersInComplementFull$AggrRefresh: [],
getOrdersInComplement$AggrRefresh: []
};
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/e_Orders/OrdersInComplement/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
return controller.callServerAction("ScreenTableDownloadOrderScreen", "screenservices/ConectaProveedores/e_Orders/OrdersInComplement/ActionScreenTableDownloadOrderScreen", "Z+etOKPIMacWeT28jRj_oA", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement$ActionScreenTableDownloadOrderScreen"))();
...
return controller.callServerAction("ColumnTogglerPassColumn", "screenservices/ConectaProveedores/e_Orders/OrdersInComplement/ActionColumnTogglerPassColumn", "CdBjpqOzG3k0+Q1AYbtdhg", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
return controller.callServerAction("GetSettings", "screenservices/ConectaProveedores/e_Orders/OrdersInComplement/ActionGetSettings", "YMh+L1Z1H9xV5gLNPZiIAg", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement$ActionGetSettings"))();
...
get getOrdersInComplementFull$AggrRefresh() {if(!(this.hasOwnProperty("_getOrdersInComplementFull$AggrRefresh"))) {
this._getOrdersInComplementFull$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetOrdersInComplementFull", "screenservices/ConectaProveedores/e_Orders/OrdersInComplement/ScreenDataSetGetOrdersInComplementFull", "Dm11LDcj00hRB+uEQDPtLQ", maxRecords, startIndex, function (b) {
model.variables.getOrdersInComplementFullAggr.dataFetchStatusAttr = b;
}, function (json) {
model.variables.getOrdersInComplementFullAggr.replaceWith(OS$DataConversion.ServerDataConverter.from(json, model.variables.getOrdersInComplementFullAggr.constructor));
}, undefined, undefined, undefined, callContext, ConectaProveedoresClientVariables, true);
}.bind(this);
return OS$Logger.startActiveSpan("GetOrdersInComplementFull", function (span) {
if(span) {
span.setAttribute("code.function", "GetOrdersInComplementFull");
span.setAttribute("outsystems.function.key", "38b2b85e-9cb8-451e-ad4f-2e0dd9224769");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
return this._getOrdersInComplementFull$AggrRefresh;
}set getOrdersInComplementFull$AggrRefresh(value) {this._getOrdersInComplementFull$AggrRefresh = value;
}

get getOrdersInComplement$AggrRefresh() {if(!(this.hasOwnProperty("_getOrdersInComplement$AggrRefresh"))) {
this._getOrdersInComplement$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetOrdersInComplement", "screenservices/ConectaProveedores/e_Orders/OrdersInComplement/ScreenDataSetGetOrdersInComplement", "arkMisWSYA7YW7uaeEA9xg", maxRecords, startIndex, function (b) {
model.variables.getOrdersInComplementAggr.dataFetchStatusAttr = b;
}, function (json) {
model.variables.getOrdersInComplementAggr.replaceWith(OS$DataConversion.ServerDataConverter.from(json, model.variables.getOrdersInComplementAggr.constructor));
}, undefined, undefined, undefined, callContext, ConectaProveedoresClientVariables, true).then(function () {
return controller._getOrdersOnAfterFetch$Action(controller.callContext(callContext));
});
}.bind(this);
return OS$Logger.startActiveSpan("GetOrdersInComplement", function (span) {
if(span) {
span.setAttribute("code.function", "GetOrdersInComplement");
span.setAttribute("outsystems.function.key", "9f010017-7c15-450e-9e22-ed74b02cad62");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "SCREEN_SERVICE_AGGREGATE_CALL");
}
...
return this._getOrdersInComplement$AggrRefresh;
}set getOrdersInComplement$AggrRefresh(value) {this._getOrdersInComplement$AggrRefresh = value;
}


get dataFetchActionNames() {if(!(this.hasOwnProperty("_dataFetchActionNames"))) {
this._dataFetchActionNames = ["getOrdersInComplementFull$AggrRefresh", "getOrdersInComplement$AggrRefresh"];
}
...
span.setAttribute("outsystems.function.key", "0c02c23b-09c5-47dd-bbc3-f6ce65a490f6");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
rec.textAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("7fw037eW4EaJsuER91YvRw#Value.46305069.1", "1 day");
rec.valueAttr = 1;
return rec;
}(), function () {
var rec = new RC_99fa4277b2264c97bde8f4525bdc92e0();
rec.textAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("oRR7nVXiNE6IkHx3KvRZVw#Value.1464086405.1", "2 days");
rec.valueAttr = 2;
return rec;
}(), function () {
var rec = new RC_99fa4277b2264c97bde8f4525bdc92e0();
rec.textAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("zTHq3hxUIka8MkiniGD2bA#Value.-275542184.1", "More than 3 days");
rec.valueAttr = 3;
return rec;
}()]);
return list;
...
span.setAttribute("outsystems.function.key", "2487eead-7559-4454-a1cf-0e5279bb9ee1");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
rec.messageAttr = "";
rec.screenAttr = "FcP - Orders In Complement";
...
span.setAttribute("outsystems.function.key", "24b79218-b4c9-468f-bfa7-498a0afd69f0");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.Wb_DownloadsFloatOnClick$vars"))());
...
// Refresh Query: GetOrdersInComplementFull
var result = controller.getOrdersInComplementFull$AggrRefresh(999999999, 0, callContext);
model.flush();
return result;
}
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("jnPEq_tlPU6LmXpUwQuuDw#Message.-1067972576.1", "There was a problem downloading your file. Please contact an administrator."), /*Error*/ 3);
} else {
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("vG+mWAs0N0mzB3MGj5euhw#Message.269443952.1", "File downloaded with success."), /*Success*/ 1);
...
span.setAttribute("outsystems.function.key", "2b9219a0-2f79-40ba-b7cc-5715d8b7eb10");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.OnSort$vars"))());
...
// Refresh Query: GetOrdersInComplement
var result = controller.getOrdersInComplement$AggrRefresh(ConectaProveedoresClientVariables.getMaxRecords(), model.variables.l_StartIndexVar, callContext);
model.flush();
...
if(span) {
span.setAttribute("code.function", "ColumnTogglerPassColumn");
span.setAttribute("outsystems.function.key", "2e710452-9624-4366-b1d2-4e3a546e2f82");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.ColumnTogglerPassColumn$vars"))());
...
span.setAttribute("outsystems.function.key", "7c5c57b7-92ae-49b0-b718-69bb6525b986");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.DropdownSuppliersOnChanged$vars"))());
vars.value.supplierIdInLocal = supplierIdIn;
return OS$Flow.executeAsyncFlow(function () {
// OrderInComplement_SupplierId = SupplierId
ConectaProveedoresClientVariables.setOrderInComplement_SupplierId(vars.value.supplierIdInLocal);
...
span.setAttribute("outsystems.function.key", "8733aa3f-b602-444d-8341-2d6773adcf92");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "ae18a3ae-5526-431c-90c7-ab13a0f1508e");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.OnPaginationNavigate$vars"))());
...
span.setAttribute("outsystems.function.key", "c7a63d68-3b44-49a9-89d5-aed363959ec8");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "d40563f3-8037-48a7-8977-86200424452b");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.RefreshList$vars"))());
...
// Reset Filters
// OrderInComplement_Number = ""
ConectaProveedoresClientVariables.setOrderInComplement_Number("");
// OrderInComplement_SupplierId = NullIdentifier
ConectaProveedoresClientVariables.setOrderInComplement_SupplierId(OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier()));
// OrderInComplement_Days = 0
ConectaProveedoresClientVariables.setOrderInComplement_Days(0);
// Execute Action: DropdownClear2
dropdownClear2Var.value = OutSystemsUIController$dropdownClear$Action(idService.getId("Dropdown_OrderInComplement_Days"), true, callContext);
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement$ActionScreenTableDownloadOrderScreen", [{
name: "o_File",
attrName: "o_FileOut",
mandatory: false,
dataType: OS$DataTypes.DataTypes.Record,
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement$ActionGetSettings", [{
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.Wb_DownloadsFloatOnClick$vars", [{
name: "i_IsCSV",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.OnSort$vars", [{
name: "SortBy",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.ColumnTogglerPassColumn$vars", [{
name: "ColumnJSON",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.DropdownSuppliersOnChanged$vars", [{
name: "SupplierId",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.OnPaginationNavigate$vars", [{
name: "NewStartIndex",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.OrdersInComplement.RefreshList$vars", [{
