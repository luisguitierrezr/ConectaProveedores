...
import ConectaProveedores_z_Testing_Controller_translationsResources from "./ConectaProveedores.z_Testing.controller$translationsResources.js";
...
OS$Logger.debug("z_Testing", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_z_Testing_Controller_translationsResources);
