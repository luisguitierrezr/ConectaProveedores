...
import ConectaProveedores_a_Common_UserProfile_mvc_TranslationsResources from "./ConectaProveedores.a_Common.UserProfile.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_a_Common_UserProfile_mvc_TranslationsResources);
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/a_Common/UserProfile/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "87a0fa5c-4442-4604-b67d-86c1dc446aa8");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
roles: [ConectaProveedoresController$default.roles.Proveedor, ConectaProveedoresController$default.roles.ConectaProveedores]
});
}
