...
import { Container as OSWidgets$Container, Text as OSWidgets$Text, Expression as OSWidgets$Expression, Link as OSWidgets$Link, Icon as OSWidgets$Icon, List as OSWidgets$List, Button as OSWidgets$Button } from "@outsystems/runtime-widgets-js";
...
import ModelFactory from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.mvc$controller.js";
...
text: [$text(getTranslation("l+Nopl1Q7EOfYj+Naidf9g#Value", "Multiple Invoices Upload"))],
_idProps: {
service: idService,
uuid: "2"
},
...
isValid: true,
ShowStatus: true,
Label: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("83cYV5Bsz0mvIHkpq1b7uA#Value.806138567.1", "Attach Main Files (zip/rar)"),
IsEnable: true,
IsMandatory: false
},
events: {
...
text: [$text(getTranslation("tvPHxHAo3UiKZyuPthGJDw#Value", "Click here or drag files to upload"))],
_idProps: {
service: idService,
uuid: "10"
},
...
Color: model.getCachedValue(idService.getId("njcu0Hq+GE+B8w8bEgWT5A.Color"), function () {
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("nFXBQ8Cn+U2WQ7L8KK+iMA#Value", "Close"))), createElement(OSWidgets$Button, {
enabled: ((!(model.variables.isSavingVar)) && (!(model.variables.isExecutingVar))),
isDefault: false,
onClick: function () {
return Promise.resolve().then(function () {
...
value: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("oZGngWjd3E+PPoA25269eQ#ValueExpression.2569629.1", "Save"),
_idProps: {
service: idService,
uuid: "23"
},
...
value: model.getCachedValue(idService.getId("FD_qn2PmNEGqmMqD2nsf4A.Value"), function () {
return ((((model.variables.invoiceStatusIdIn) !== (ConectaProveedores_staticEntities_invoiceStatus.modify))) ? (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("pdHPvppEU0q_XcSxscXuAw#ValueExpression.-1582438992.1", "Start approval process")) : (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("pdHPvppEU0q_XcSxscXuAw#ValueExpression.1436936423.1", "Resubmit approval process")));
}, function () {
...
return {
codeFunction: "Wb_PopupInvoiceUploadMultipleBigFiles",
functionKey: "e0d986ad-2b89-41b7-8e79-f745028fd0ed",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles",
...
return [BigUpload_BigUpload_wb_BigUploadMultipleFiles_mvc_view, OutSystemsUI_Content_Tag_mvc_view, Telcel_Theme_Utils_Wb_ShortText_mvc_view, OutSystemsUI_Utilities_ButtonLoading_mvc_view];
};
