...
import { Injector as OS$Injector, ServiceNames as OS$ServiceNames, BuiltinFunctions as OS$BuiltinFunctions, DataTypes as OS$DataTypes, Navigation as OS$Navigation } from "@outsystems/runtime-core-js";
...
import ModelFactory from "./ConectaProveedores.j_FoliosSAE.Wb_SupportSAEUploadEdit.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.j_FoliosSAE.Wb_SupportSAEUploadEdit.mvc$controller.js";
...
value: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("ikj5zz3zeU+WaJFwWy5rFg#ValueExpression.-1651890490.1", "Support files"),
_idProps: {
service: idService,
uuid: "4"
},
...
text: [$text(getTranslation("XHVflFfqJkSpB9mJnnxdSA#Value", "Click here or drag files to upload"))],
_idProps: {
service: idService,
uuid: "6"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: [asPrimitiveValue(model.variables.filesListVar.getCurrent(callContext.iterationContext).binaryDataAttr), asPrimitiveValue(model.variables.filesListVar.getCurrent(callContext.iterationContext).storageIdAttr), asPrimitiveValue(model.variables.filesListVar.getCurrent(callContext.iterationContext).nameAttr)]
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}), $if((model.variables.filesListVar.getCurrent(callContext.iterationContext).storageIdAttr.equals(OS$BuiltinFunctions.integerToLongInteger(OS$BuiltinFunctions.nullIdentifier())) && !(OS$DataTypes.areBinaryNulls(model.variables.filesListVar.getCurrent(callContext.iterationContext).binaryDataAttr, OS$BuiltinFunctions.nullBinary()))), false, this, function () {
return [createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
style: "margin-left-s",
...
extendedProperties: {
style: model.getCachedValue(idService.getId("HK2N0joH90+cMsizIzpWJg.style"), function () {
...
return {
codeFunction: "Wb_SupportSAEUploadEdit",
functionKey: "41daf330-fea5-4252-ab35-d98450973c42",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "j_FoliosSAE.Wb_SupportSAEUploadEdit",
