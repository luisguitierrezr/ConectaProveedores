import { withBaseWebBlock, ifWidget as $if, textWidget as $text, getTranslation, Widget, asPrimitiveValue, useTracing } from "@outsystems/runtime-view-js";
...
import ModelFactory from "./ConectaProveedores.g_Reports.wb_documentExtrationByUUID.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.g_Reports.wb_documentExtrationByUUID.mvc$controller.js";
...
_widgetRecordProvider: widgetsRecordProvider
}, "UUID"), createElement(OSWidgets$Input, {
_validationProps: {
...
maxLength: 50,
style: "form-control",
variable: model.createVariable(OS$DataTypes.DataTypes.Text, model.variables.uUIdVar, function (value) {
model.variables.uUIdVar = value;
}),
_idProps: {
service: idService,
name: "Input_TextVar"
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("na4ixnBH_kSK+mKV5q26xA#Value", "Supplier Name"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("B7D__Ki690iRASAo3WHK4g#Value", "Invoice Number"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("6zbj4eke2EGD83Ut495inQ#Value", "Requisition"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("ZktxfYMYg0eqwnJLOewVfg#Value", "Total Amount"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("mn52ZQlGCkWywWNGYILaiA#Value", "Currency"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("Sjqh9TNnRUCF5OauysIjhw#Value", "Filename"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: right"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("hRw9eMNSJUelMEIMdzbvrg#Value", "Created On"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: right"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("dzj_MbBbWUGxK+SBgorO_Q#Value", "Account Date"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "width: 1%;"
},
_idProps: {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("kaccYIMa7ke3eRSaQNCr6g#Value", "Options")))];
}),
...
value: model.getCachedValue(idService.getId("hpmI72VJ8EC4el1xdMYr_g.Value"), function () {
...
value: model.getCachedValue(idService.getId("v6l0eUOLSUSenjj_46_7dQ.Value"), function () {
...
return {
codeFunction: "wb_documentExtrationByUUID",
functionKey: "abbfc7aa-7ce4-4455-927f-5064b659f440",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "g_Reports.wb_documentExtrationByUUID",
...
return [CloneOfDebounce_DebounceFlow_Debounce_mvc_view, ConectaProveedores_g_Reports_Wb_PreviewFile_mvc_view, ConectaProveedores_s_Storage_wb_DownloadFile_mvc_view, OutSystemsUI_Navigation_Pagination_mvc_view];
};
