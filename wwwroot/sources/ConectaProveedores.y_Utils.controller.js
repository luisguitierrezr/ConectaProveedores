...
import ConectaProveedores_y_Utils_Controller_translationsResources from "./ConectaProveedores.y_Utils.controller$translationsResources.js";
...
OS$Logger.debug("y_Utils", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_y_Utils_Controller_translationsResources);
