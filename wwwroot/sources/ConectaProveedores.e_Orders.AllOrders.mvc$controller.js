...
import ConectaProveedores_e_Orders_AllOrders_mvc_TranslationsResources from "./ConectaProveedores.e_Orders.AllOrders.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_e_Orders_AllOrders_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {};
this.dataFetchDependenciesOriginal = {
getOrderMain$AggrRefresh: 0
};
this.dataFetchDependentsGraph = {
getOrderMain$AggrRefresh: []
};
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/e_Orders/AllOrders/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
get getOrderMain$AggrRefresh() {if(!(this.hasOwnProperty("_getOrderMain$AggrRefresh"))) {
this._getOrderMain$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetOrderMain", "screenservices/ConectaProveedores/e_Orders/AllOrders/ScreenDataSetGetOrderMain", "7_6f3ytD4mV2IJF0NIBjmQ", maxRecords, startIndex, function (b) {
model.variables.getOrderMainAggr.dataFetchStatusAttr = b;
}, function (json) {
model.variables.getOrderMainAggr.replaceWith(OS$DataConversion.ServerDataConverter.from(json, model.variables.getOrderMainAggr.constructor));
}, undefined, undefined, undefined, callContext, ConectaProveedoresClientVariables, true);
}.bind(this);
return OS$Logger.startActiveSpan("GetOrderMain", function (span) {
if(span) {
span.setAttribute("code.function", "GetOrderMain");
span.setAttribute("outsystems.function.key", "7842171e-c625-4e07-819c-0ed035bae7e9");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
return this._getOrderMain$AggrRefresh;
}set getOrderMain$AggrRefresh(value) {this._getOrderMain$AggrRefresh = value;
}


get dataFetchActionNames() {if(!(this.hasOwnProperty("_dataFetchActionNames"))) {
this._dataFetchActionNames = ["getOrderMain$AggrRefresh"];
}
...
span.setAttribute("outsystems.function.key", "395b68bd-5045-4bf5-b7eb-1bb7a2468fd5");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "c456793d-a4a7-4370-851b-044813f5902b");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.AllOrders.OnPaginationNavigate$vars"))());
vars.value.newStartIndexInLocal = newStartIndexIn;
return OS$Flow.executeAsyncFlow(function () {
// StartIndex = NewStartIndex
// StartIndex = NewStartIndex
model.variables.startIndexVar = vars.value.newStartIndexInLocal;
// Refresh Query: GetOrderMain
var result = controller.getOrderMain$AggrRefresh(model.variables.maxRecordsVar, model.variables.startIndexVar, callContext);
model.flush();
return result;
});
}, function () {
...
span.setAttribute("outsystems.function.key", "eb4d72d3-277b-479a-9dc0-6fdc4f65f7da");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.AllOrders.OnSort$vars"))());
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.AllOrders.OnPaginationNavigate$vars", [{
name: "NewStartIndex",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.AllOrders.OnSort$vars", [{
name: "SortBy",
