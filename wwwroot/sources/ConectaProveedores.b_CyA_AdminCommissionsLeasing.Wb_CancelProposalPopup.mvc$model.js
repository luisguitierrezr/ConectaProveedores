...
return [
this.attr("l_CancelReason", "l_CancelReasonVar", "l_CancelReason", true, false, OS$DataTypes.DataTypes.Text, function () {
return "";
}, false), 
...
return {
TextArea_l_CancelReason: OS$Model.ValidationWidgetRecord
};
}
