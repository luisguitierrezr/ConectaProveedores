...
import ConectaProveedores_c_Requisitions_Requisitions_mvc_TranslationsResources from "./ConectaProveedores.c_Requisitions.Requisitions.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_c_Requisitions_Requisitions_mvc_TranslationsResources);
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/c_Requisitions/Requisitions/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
return controller.callDataAction("DataActionGetSettings", "screenservices/ConectaProveedores/c_Requisitions/Requisitions/DataActionGetSettings", "rMKKhV5FAazj5Sw3qKWkoQ", function (b) {
...
span.setAttribute("outsystems.function.key", "cddcbcfe-f7eb-4290-895d-0c1c285e59ff");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "8d9faa7e-f52d-422c-9a13-2848422394e9");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
rec.messageAttr = "";
rec.screenAttr = "FsP - Requisitions";
