...
import ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_mvc_TranslationsResources from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.mvc$translationsResources.js";

{class ControllerInner extends 
OS$Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_mvc_TranslationsResources);
...
return controller.callServerAction("UploadInvoiceFilesMultiple", "screenservices/ConectaProveedores/d_InvoicePopups/Wb_PopupInvoiceUploadMultipleBigFiles/ActionUploadInvoiceFilesMultiple", "+dvOmjQ2E0nvA84QUnSsRQ", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles$ActionUploadInvoiceFilesMultiple"))();
...
return controller.callServerAction("ValidateZIPInvoices", "screenservices/ConectaProveedores/d_InvoicePopups/Wb_PopupInvoiceUploadMultipleBigFiles/ActionValidateZIPInvoices", "H_Veye90wmWbWmS8rwLNrw", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles$ActionValidateZIPInvoices"))();
...
return controller.callDataAction("DataActionGetInvoicesByRequisitionOrFolio", "screenservices/ConectaProveedores/d_InvoicePopups/Wb_PopupInvoiceUploadMultipleBigFiles/DataActionGetInvoicesByRequisitionOrFolio", "+5mzVrZaW0x1hOwVdK+6iQ", function (b) {
...
span.setAttribute("outsystems.function.key", "33a09a94-27a0-4d70-aee1-01126356474a");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callDataAction("DataActionGetSupplier", "screenservices/ConectaProveedores/d_InvoicePopups/Wb_PopupInvoiceUploadMultipleBigFiles/DataActionGetSupplier", "1iS_e72X9zgr0D2tjUCYKQ", function (b) {
...
span.setAttribute("outsystems.function.key", "a927739b-e112-412b-968d-2cff30155e2a");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "SCREEN_SERVICE_DATA_ACTION_CALL");
}
...
span.setAttribute("outsystems.function.key", "041a50cc-fd6c-4e82-be38-af857fba95c7");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "0dbac2ff-eabf-4663-9a2e-30d6da71ec8e");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
span.setAttribute("outsystems.function.key", "0e027f8e-70cb-4fa9-b058-d4d62628dc86");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.SaveOnClick$vars"))());
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("vRjxUPgOwEKohLOn7_udxw#Message.-701348175.1", "Please insert a file to proceed."), /*Error*/ 3);
// IsExecuting = False
model.variables.isExecutingVar = false;
// IsSaving = False
model.variables.isSavingVar = false;
...
OS$Logger.debug("Wb_PopupInvoiceUploadMultipleBigFiles.SaveOnClick", OS$Exceptions.getMessage(ex));
...
span.setAttribute("outsystems.function.key", "992da63c-7c21-4bcb-8acc-78b5ccaa6cd9");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
return OS$Flow.tryFinally(function () {
return OS$Flow.executeAsyncFlow(function () {
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("_WS2n8IL5UiNQA1SeOom2g#Message.-892909564.1", "Error while trying to upload invoice. Please try again later"), /*Error*/ 3);
// IsExecuting = False
model.variables.isExecutingVar = false;
// IsSaving = False
model.variables.isSavingVar = false;
...
span.setAttribute("outsystems.function.key", "46a3a268-74f5-49d3-a6e9-8da63d6cbcd8");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.CustomUploadOnFileChange$vars"))());
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("1OWEiqqaK0CQiVzyln4qXw#Message.1572004662.1", "Duplicated files were not included."), /*Warning*/ 2);
// Execute Action: HideLoading2
ConectaProveedoresController$hideLoading$Action(callContext);
} else {
...
validateZIPInvoicesVar.value.multiUploadInvoiceFileStructOut.errorMsgAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("5ViUml+Oj060miLyl6NTRg#Value.-719604230.1", "Duplicated invoice ");
}
...
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("tjuS5FzCMEKJciTf8nlRVA#Message.875725967.1", "Empty file"), /*Error*/ 3);
// Execute Action: HideLoading3
ConectaProveedoresController$hideLoading$Action(callContext);
}
...
span.setAttribute("outsystems.function.key", "72fc5a9a-96e7-42f0-a48a-8623a9738de6");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.RemoveFromList$vars"))());
...
span.setAttribute("outsystems.function.key", "ef106eb1-cdd0-4067-971e-84865366a8c1");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.wb_BigUploadMultipleFilesNotifyFileId$vars"))());
vars.value.fileIdInLocal = fileIdIn;
vars.value.filenameInLocal = filenameIn;
vars.value.mimeTypeInLocal = mimeTypeIn;
return OS$Flow.executeAsyncFlow(function () {
// Execute Action: ListAppend
OS$SystemActions.listAppend(model.variables.filesListVar, function () {
var rec = new ST_5478c3bb197e3019856d4a634c17d91dStructure();
rec.nameAttr = model.variables.getSupplierDataAct.nameOut;
rec.binaryDataZIPAttr = OS$BuiltinFunctions.nullBinary();
rec.binaryDataXMLAttr = OS$BuiltinFunctions.nullBinary();
rec.binaryDataPDFAttr = OS$BuiltinFunctions.nullBinary();
rec.fileIdAttr = OS$BuiltinFunctions.longIntegerToIdentifier(vars.value.fileIdInLocal);
return rec;
}(), callContext);
// Execute Action: CustomUploadOnFileChange
return controller._customUploadOnFileChange$Action(function () {
...
return rec;
}(), new ST_f9f8b40f5330871047e55e068d129447Structure(), callContext);
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "f1be66ba-3d7e-4205-88c9-3b45aa2ba67e");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles$ActionUploadInvoiceFilesMultiple", [{
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles$ActionValidateZIPInvoices", [{
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.SaveOnClick$vars", [{
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.CustomUploadOnFileChange$vars", [{
name: "File",
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.RemoveFromList$vars", [{
name: "Index",
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceUploadMultipleBigFiles.wb_BigUploadMultipleFilesNotifyFileId$vars", [{
name: "FileId",
