...
import { Model as OS$Model, Navigation as OS$Navigation, Injector as OS$Injector, ServiceNames as OS$ServiceNames } from "@outsystems/runtime-core-js";
...
import ModelFactory from "./ConectaProveedores.c_Requisitions.Wb_RequisitionEntra_Historic.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.c_Requisitions.Wb_RequisitionEntra_Historic.mvc$controller.js";
...
}, $text(getTranslation("UYuiVw6MskOthjzpudBFPA#Value", "Approval"))), createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
extendedProperties: {
style: " "
...
_widgetRecordProvider: widgetsRecordProvider
}, $if(((model.variables.getRequisitionByIdAggr.listOut.getCurrent(callContext.iterationContext).approvalProcessAttr.isSpecialAttr) ? (model.variables.getSpecialApprovalLevelsDataAct.isDataFetchedAttr) : ((model.variables.getRequisitionsApprovalLevelsAggr.isDataFetchedAttr && model.variables.getEntraUserManagerListDataAct.isDataFetchedAttr))), false, this, function () {
...
inputs: {
Status: model.getCachedValue(idService.getId("ax9LcJIeOUCg9b1ljVszhw.Status"), function () {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}), $if((model.variables.listVar.getCurrent(callContext.iterationContext).isReassignedAttr || model.variables.listVar.getCurrent(callContext.iterationContext).isSubstituteAttr), false, this, function () {
...
return [createElement(OSWidgets$Expression, {
value: model.getCachedValue(idService.getId("6llgyfUhDk2j24I6czpAkw.Value"), function () {
return ((model.variables.listVar.getCurrent(callContext.iterationContext).isReassignedAttr) ? (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("dUQOPMQ9rkS0hoDjzdPKZw#ValueExpression.1256100571.1", "Through reassignment")) : (OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("dUQOPMQ9rkS0hoDjzdPKZw#ValueExpression.328918168.1", "Through substitution")));
}, function () {
return model.variables.listVar.getCurrent(callContext.iterationContext).isReassignedAttr;
}),
_idProps: {
service: idService,
uuid: "12"
...
_dependencies: [asPrimitiveValue(model.variables.listVar.getCurrent(callContext.iterationContext).isReassignedAttr)]
})];
}, function () {
return [];
...
tooltip: new Widget.PlaceholderContent(function () {
return [$text(getTranslation("OOITnRdq8kOWRTqyF93Lug#Value", "Without Contract or Proof Of Foreign Residence"))];
})
},
_dependencies: []
})];
...
tooltip: new Widget.PlaceholderContent(function () {
return [$text(getTranslation("Hf8OYIJapUS91cW0V8VJHA#Value", "Role not yet mapped to an application role."))];
})
},
_dependencies: []
})];
...
tooltip: new Widget.PlaceholderContent(function () {
return [$text(getTranslation("cpq0tJ76ZUWEdbnZFlIBaQ#Value", "Without Contract or Proof Of Foreign Residence"))];
})
},
_dependencies: []
})];
...
return {
codeFunction: "Wb_RequisitionEntra_Historic",
functionKey: "a498bec4-fd8f-4834-9b64-0e14745631ef",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "c_Requisitions.Wb_RequisitionEntra_Historic",
