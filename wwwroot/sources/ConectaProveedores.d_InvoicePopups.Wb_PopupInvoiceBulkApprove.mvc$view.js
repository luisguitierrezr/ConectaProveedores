...
import ModelFactory from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceBulkApprove.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceBulkApprove.mvc$controller.js";
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("MOJFvJ_+ekOdBo2URmnPhg#Value", "Approve Invoices"))), createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
extendedProperties: {
...
text: [$text(getTranslation("y9kv2VLbYU+QCGntRoz5Ww#Value", "You\'re approving the following invoices:"))],
_idProps: {
service: idService,
uuid: "9"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("7Shon0NNmkuKUxi+n5omjA#Value", "Name"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: right"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("F1aiwdFbR06TaiaSZcCiXQ#Value", "Total Amount")))];
}),
...
value: model.getCachedValue(idService.getId("8qH+HAcy2Um6neW_WHwE2Q.Value"), function () {
...
align: /*Default*/ 0,
animate: false,
style: model.getCachedValue(idService.getId("thbhhyclqkGpycNJFpyj8g.Style"), function () {
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("U6RcCFVyuUm+D82ndEUVZw#Value", "Comment"))), createElement(OSWidgets$TextArea, {
_validationProps: {
validationService: validationService
},
enabled: true,
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("ziSDHa3d6Ui2URgfzfj1_A#Value", "Close"))), createElement(OSWidgets$Container, {
align: /*Default*/ 0,
animate: false,
gridProperties: {
classes: "OSInline"
...
style: "reject",
text: [$text(getTranslation("bHrcgOb1g0qVKKUyD1Ucqw#Value", "Approve"))],
_idProps: {
service: idService,
uuid: "30"
},
...
return {
codeFunction: "Wb_PopupInvoiceBulkApprove",
functionKey: "d7db0d61-6512-4fe2-9843-254af33300cb",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "d_InvoicePopups.Wb_PopupInvoiceBulkApprove",
