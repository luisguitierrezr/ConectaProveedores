...
import ModelFactory from "./ConectaProveedores.g_Reports.wb_documentExtrationByAccount.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.g_Reports.wb_documentExtrationByAccount.mvc$controller.js";
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("HrsP2KD0JUOLjJ+NQPFniw#Value", "Account Number"))), createElement(OSWidgets$Input, {
_validationProps: {
...
maxLength: 50,
style: "form-control",
variable: model.createVariable(OS$DataTypes.DataTypes.Text, model.variables.accountNumberVar, function (value) {
model.variables.accountNumberVar = value;
}),
_idProps: {
service: idService,
name: "Input_TextVar"
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("GJ6uZu+Vo0maUVoASKxOsQ#Value", "Start Date"))), createElement(OutSystemsUI_Interaction_InputWithIcon_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
getOwnerDisposeSpan: function () {
...
enabled: true,
extendedProperties: {
"aria-label": OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("uK4SnVdYkEmG+uVfwT7qjg#Value.1002767249.1", "Select a date")
},
gridProperties: {
classes: "OSFillParent"
},
...
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("66kOUPqpPUmchwvoJE9F+g#ValueExpression.65921.1", "All"),
...
_widgetRecordProvider: widgetsRecordProvider
}, $text(getTranslation("CH0+iOJGvEGhwHmwpSgwCQ#Value", "End Date"))), createElement(OutSystemsUI_Interaction_InputWithIcon_mvc_view, {
getOwnerSpan: function () {
return spanProvider.getChildSpan("render");
},
getOwnerDisposeSpan: function () {
...
enabled: true,
extendedProperties: {
"aria-label": OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("v70HOThzNEeS9o+WwgXtmA#Value.1002767249.1", "Select a date")
},
gridProperties: {
classes: "OSFillParent"
},
...
prompt: OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("bf553qDwwUep2tXxIqCfSg#ValueExpression.65921.1", "All"),
style: "form-control cursorpointer",
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("DxAVe7SfU0GC9EAy20wqsw#Value", "Supplier Name"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("jazPUDKNIUCgz5XMW3e+pA#Value", "Invoice Number"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("s4W2Oj39_EyfQMcPtdzy2Q#Value", "Requisition"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("Ow+JC6fNekawA2jeTKW4QA#Value", "Total Amount"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("B+e9zk+5BkSfAQgZ2l1hPg#Value", "Currency"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("zl2qeQTkY0e3X+p2O6FDLA#Value", "UUID"))), createElement(OSWidgets$HeaderCell, {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("9Z0k_QxwqUOhTgb2PZT0cw#Value", "Filename"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: right"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("LDSp97T+2kmZQMeRnnK4cA#Value", "Created On"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "text-align: right"
},
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("uJNSaWBRe0GBO7kQK4Lh+g#Value", "Account Date"))), createElement(OSWidgets$HeaderCell, {
extendedProperties: {
style: "width: 1%;"
},
_idProps: {
...
_widgetRecordProvider: widgetsRecordProvider,
_dependencies: []
}, $text(getTranslation("sw_bwAuG1EWhP+8pmiZMOA#Value", "Options")))];
}),
...
value: model.getCachedValue(idService.getId("XU8zvpuBpk6gPsboQsmA_w.Value"), function () {
...
value: model.getCachedValue(idService.getId("SqlyueIQ9kC_Aff1HNXfXQ.Value"), function () {
...
return {
codeFunction: "wb_documentExtrationByAccount",
functionKey: "9e07b3df-f580-45af-aa2a-0dd780b116b6",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "g_Reports.wb_documentExtrationByAccount",
