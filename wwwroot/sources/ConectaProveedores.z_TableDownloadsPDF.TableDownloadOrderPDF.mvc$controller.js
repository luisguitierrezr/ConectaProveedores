...
import ConectaProveedores_z_TableDownloadsPDF_TableDownloadOrderPDF_mvc_TranslationsResources from "./ConectaProveedores.z_TableDownloadsPDF.TableDownloadOrderPDF.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_z_TableDownloadsPDF_TableDownloadOrderPDF_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {};
this.dataFetchDependenciesOriginal = {
getOrders$DataActRefresh: -1
};
...
return controller.callServerAction("String_Split", "screenservices/ConectaProveedores/z_TableDownloadsPDF/TableDownloadOrderPDF/ActionString_Split", "KCCQ2PmqBTFATtdp2LjyhQ", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.z_TableDownloadsPDF.TableDownloadOrderPDF$ActionString_Split"))();
...
return controller.callDataAction("DataActionGetOrders", "screenservices/ConectaProveedores/z_TableDownloadsPDF/TableDownloadOrderPDF/DataActionGetOrders", "k53IPI7cVYcEiuwxUQocBw", function (b) {
...
span.setAttribute("outsystems.function.key", "8b6c020e-d5a5-46bc-9928-08057beba9dd");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
this._dataFetchActionNames = ["getOrders$DataActRefresh"];
}
...
span.setAttribute("outsystems.function.key", "c47483f9-774c-4a90-b4e6-42e61735bb2f");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
// OrderIdList = String_Split.List
model.variables.orderIdListVar = OS$DataConversion.JSConversions.typeConvertRecordList(string_SplitVar.value.listOut, new (OS$GenericTypeCache.getGenericList(TextRec))(), function (source, target) {
...
Controller.registerVariableGroupType("ConectaProveedores.z_TableDownloadsPDF.TableDownloadOrderPDF$ActionString_Split", [{
name: "List",
attrName: "listOut",
mandatory: false,
