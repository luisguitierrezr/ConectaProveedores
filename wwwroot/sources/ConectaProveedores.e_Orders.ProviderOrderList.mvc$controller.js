...
import ConectaProveedores_e_Orders_ProviderOrderList_mvc_TranslationsResources from "./ConectaProveedores.e_Orders.ProviderOrderList.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_e_Orders_ProviderOrderList_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {};
this.dataFetchDependenciesOriginal = {
getOrders$AggrRefresh: 0
};
this.dataFetchDependentsGraph = {
getOrders$AggrRefresh: []
};
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/e_Orders/ProviderOrderList/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
get getOrders$AggrRefresh() {if(!(this.hasOwnProperty("_getOrders$AggrRefresh"))) {
this._getOrders$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetOrders", "screenservices/ConectaProveedores/e_Orders/ProviderOrderList/ScreenDataSetGetOrders", "C7ZclqB26UqeiyiNwFAYEA", maxRecords, startIndex, function (b) {
model.variables.getOrdersAggr.dataFetchStatusAttr = b;
}, function (json) {
model.variables.getOrdersAggr.replaceWith(OS$DataConversion.ServerDataConverter.from(json, model.variables.getOrdersAggr.constructor));
}, undefined, undefined, undefined, callContext, ConectaProveedoresClientVariables, true);
}.bind(this);
return OS$Logger.startActiveSpan("GetOrders", function (span) {
if(span) {
span.setAttribute("code.function", "GetOrders");
span.setAttribute("outsystems.function.key", "220d7cd9-9268-4cee-9bd6-6bf46cd12fd7");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
return this._getOrders$AggrRefresh;
}set getOrders$AggrRefresh(value) {this._getOrders$AggrRefresh = value;
}


get dataFetchActionNames() {if(!(this.hasOwnProperty("_dataFetchActionNames"))) {
this._dataFetchActionNames = ["getOrders$AggrRefresh"];
}
...
span.setAttribute("outsystems.function.key", "084cbab7-d9ea-4da2-81b8-202e56e557a4");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.ProviderOrderList.RefreshList$vars"))());
...
// Reset Filters
// OrderProviderList_Number = ""
ConectaProveedoresClientVariables.setOrderProviderList_Number("");
}

// Refresh Query: GetOrders
var result = controller.getOrders$AggrRefresh(ConectaProveedoresClientVariables.getMaxRecords(), model.variables.l_StartIndexVar, callContext);
model.flush();
return result;
});
}, function () {
...
span.setAttribute("outsystems.function.key", "49fb8ac3-e0f9-4094-8633-e07c3e8b8f6c");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
rec.messageAttr = "";
rec.screenAttr = "FcP - Provider Order List";
...
span.setAttribute("outsystems.function.key", "a1a17101-21b0-48d9-84a2-6cb04dfb4dbb");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.ProviderOrderList.OnPaginationNavigate$vars"))());
...
span.setAttribute("outsystems.function.key", "de36637f-83e0-4956-8a54-7a6a5e5d1935");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.e_Orders.ProviderOrderList.OnSort$vars"))());
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.ProviderOrderList.RefreshList$vars", [{
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.ProviderOrderList.OnPaginationNavigate$vars", [{
name: "NewStartIndex",
...
Controller.registerVariableGroupType("ConectaProveedores.e_Orders.ProviderOrderList.OnSort$vars", [{
name: "SortBy",
