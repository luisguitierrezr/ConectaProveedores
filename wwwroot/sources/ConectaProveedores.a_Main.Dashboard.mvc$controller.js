...
import { Controller as OS$Controller, DataTypes as OS$DataTypes, DataConversion as OS$DataConversion, Flow as OS$Flow, Logger as OS$Logger, BuiltinFunctions as OS$BuiltinFunctions, Exceptions as OS$Exceptions, Transitions as OS$Transitions, Navigation as OS$Navigation, Authorization as OS$Authorization } from "@outsystems/runtime-core-js";
...
import ConectaProveedores_a_Main_Dashboard_mvc_TranslationsResources from "./ConectaProveedores.a_Main.Dashboard.mvc$translationsResources.js";
import ConectaProveedores_a_MainController$default from "./ConectaProveedores.a_Main.controller.js";

{class ControllerInner extends 
OS$Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, ConectaProveedores_a_Main_Dashboard_mvc_TranslationsResources);
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/a_Main/Dashboard/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "29320dfc-a791-42e1-83b4-43003fba7905");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
span.setAttribute("outsystems.function.key", "485a0b51-87b9-4d80-a8e9-8145e73cb43d");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
if((!((((ConectaProveedoresController$default.checkComissionesArrendamientosRole$Action(callContext).hasRoleOut || ConectaProveedoresController$default.checkComissionesArrendamientosAdminRole$Action(callContext).hasRoleOut) || ConectaProveedoresController$default.checkComissionesArrendamientosViewerRole$Action(callContext).hasRoleOut) || ConectaProveedoresController$default.checkTesoreriaRole$Action(callContext).hasRoleOut)))) {
if(((ConectaProveedoresController$default.checkRequisicionesRole$Action(callContext).hasRoleOut || ConectaProveedoresController$default.checkProveedorRole$Action(callContext).hasRoleOut))) {
