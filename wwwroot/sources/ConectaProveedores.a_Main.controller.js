...
import ConectaProveedores_a_Main_Controller_translationsResources from "./ConectaProveedores.a_Main.controller$translationsResources.js";
...
OS$Logger.debug("a_Main", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_a_Main_Controller_translationsResources);
