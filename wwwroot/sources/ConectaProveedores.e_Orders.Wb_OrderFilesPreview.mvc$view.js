...
import ModelFactory from "./ConectaProveedores.e_Orders.Wb_OrderFilesPreview.mvc$model.js";
import ControllerFactory from "./ConectaProveedores.e_Orders.Wb_OrderFilesPreview.mvc$controller.js";
...
return createElement("div", props.rootNodeProperties, $if(model.variables.getOrderRequestFileByIdAggr.isDataFetchedAttr, false, this, function () {
...
return [$text(getTranslation("5iAXchbz30GljyoS5tvIKA#Value", "others"))];
})
},
_dependencies: []
}))];
...
inputs: {
StorageFileList: model.getCachedValue(idService.getId("x0Y2DMWR2US2RpKoQ25ctw.StorageFileList"), function () {
return OS$DataConversion.JSConversions.typeConvertRecordList(model.variables.getOrderRequestFileByIdAggr.listOut, new (OS$GenericTypeCache.getGenericList(ST_8917d167cfa0f31ec1ed2a0d24e80bccStructure))(), function (source, target) {
target.storageIdAttr = source.orderRequestFileAttr.storageIdAttr;
target.filenameAttr = source.orderRequestFileAttr.filenameAttr;
return target;
});
}, function () {
return model.variables.getOrderRequestFileByIdAggr.listOut;
}),
_storageFileListInDataFetchStatus: OS$Model.calculateDataFetchStatus(model.variables.getOrderRequestFileByIdAggr.dataFetchStatusAttr)
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
return {
codeFunction: "Wb_OrderFilesPreview",
functionKey: "8e850ecb-ad7f-4307-b48c-a226b4ef0951",
functionOwnerName: "ConectaProveedores",
functionOwnerKey: "588dd3e9-ffc1-4591-bd4e-2f57e6c30828",
screen: ""
};
},
displayName: "e_Orders.Wb_OrderFilesPreview",
...
return ["css/OutSystemsReactWidgets.css", "css/ConectaProveedores.e_Orders.Wb_OrderFilesPreview.css"];
};
