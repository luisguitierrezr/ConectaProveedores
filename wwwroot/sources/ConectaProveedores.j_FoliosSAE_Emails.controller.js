...
import ConectaProveedores_j_FoliosSAE_Emails_Controller_translationsResources from "./ConectaProveedores.j_FoliosSAE_Emails.controller$translationsResources.js";
...
OS$Logger.debug("j_FoliosSAE_Emails", OS$Exceptions.getMessage(ex));
...
export default new Controller(ConectaProveedores_j_FoliosSAE_Emails_Controller_translationsResources);
