...
import ConectaProveedores_j_FoliosSAE_CheckDirectReports_mvc_TranslationsResources from "./ConectaProveedores.j_FoliosSAE.CheckDirectReports.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_j_FoliosSAE_CheckDirectReports_mvc_TranslationsResources);
var controller = this.controller;
this.clientActionProxies = {};
this.dataFetchDependenciesOriginal = {
getFolios$DataActRefresh: 0
};
this.dataFetchDependentsGraph = {
getFolios$DataActRefresh: []
};
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/j_FoliosSAE/CheckDirectReports/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
return controller.callServerAction("ColumnTogglerPassColumn", "screenservices/ConectaProveedores/j_FoliosSAE/CheckDirectReports/ActionColumnTogglerPassColumn", "CdBjpqOzG3k0+Q1AYbtdhg", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
get getFolios$DataActRefresh() {if(!(this.hasOwnProperty("_getFolios$DataActRefresh"))) {
this._getFolios$DataActRefresh = function () {
var innerBody = function (callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
var callContext = controller.callContext(callContext);
return controller.callDataAction("DataActionGetFolios", "screenservices/ConectaProveedores/j_FoliosSAE/CheckDirectReports/DataActionGetFolios", "lu8lmJCBZ7CCmY6IkVqa3A", function (b) {
model.variables.getFoliosDataAct.dataFetchStatusAttr = b;
}, function (json) {
model.variables.getFoliosDataAct.replaceWith(OS$DataConversion.ServerDataConverter.from(json, model.variables.getFoliosDataAct.constructor));
}, undefined, undefined, undefined, callContext, ConectaProveedoresClientVariables, true);
}.bind(this);
return OS$Logger.startActiveSpan("GetFolios", function (span) {
if(span) {
span.setAttribute("code.function", "GetFolios");
span.setAttribute("outsystems.function.key", "4e2b868a-5237-40a6-8ec4-f964c4eba37c");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
return this._getFolios$DataActRefresh;
}set getFolios$DataActRefresh(value) {this._getFolios$DataActRefresh = value;
}


get dataFetchActionNames() {if(!(this.hasOwnProperty("_dataFetchActionNames"))) {
this._dataFetchActionNames = ["getFolios$DataActRefresh"];
}
...
span.setAttribute("outsystems.function.key", "08123593-c860-4f0e-9a85-2b19c8b7ee4c");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
rec.messageAttr = "";
rec.screenAttr = "Check Direct Reports";
...
span.setAttribute("outsystems.function.key", "70050a22-3938-468c-84b2-a01f10a81966");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.CheckDirectReports.OnSort$vars"))());
...
// Refresh Query: GetFolios
var result = controller.getFolios$DataActRefresh(callContext);
model.flush();
...
if(span) {
span.setAttribute("code.function", "ColumnTogglerPassColumn");
span.setAttribute("outsystems.function.key", "a530e964-3483-4a31-b288-b81c8f3fe8c7");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
callContext = controller.callContext(callContext);
var vars = new OS$DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("ConectaProveedores.j_FoliosSAE.CheckDirectReports.ColumnTogglerPassColumn$vars"))());
vars.value.columnJSONInLocal = columnJSONIn;
return OS$Flow.executeAsyncFlow(function () {
// Execute Action: ColumnTogglerPassColumn
model.flush();
return controller.columnTogglerPassColumn$ServerAction(vars.value.columnJSONInLocal, idService.getId("DirectReportsFormsTable"), OS$BuiltinFunctions.getUserId(), callContext).then(function () {
...
span.setAttribute("outsystems.function.key", "bb43b040-92b6-4508-a012-dbd37d5b04a3");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.CheckDirectReports.OnSort$vars", [{
name: "SortBy",
...
Controller.registerVariableGroupType("ConectaProveedores.j_FoliosSAE.CheckDirectReports.ColumnTogglerPassColumn$vars", [{
name: "ColumnJSON",
