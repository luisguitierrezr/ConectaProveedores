...
import ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceCancel_mvc_TranslationsResources from "./ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceCancel.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceCancel_mvc_TranslationsResources);
...
invoiceCancel$ServerAction(i_InvoiceIdIn, i_InvoiceApprovalLevelIdIn, i_CancelReasonIn, i_GetUserIdIn, callContext) {
var controller = this.controller;
return OS$Logger.startActiveSpan("InvoiceCancel", function (span) {
if(span) {
span.setAttribute("code.function", "InvoiceCancel");
span.setAttribute("outsystems.function.key", "cabf43bf-8d9f-4c3d-89fb-35bb9cd4dc85");
...
return controller.callServerAction("InvoiceCancel", "screenservices/ConectaProveedores/d_InvoicePopups/Wb_PopupInvoiceCancel/ActionInvoiceCancel", "ilrLsvE5LlREVqPT77AGrw", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceCancel$ActionInvoiceCancel"))();
...
span.setAttribute("outsystems.function.key", "7168f83f-8e72-4eec-8c65-c4748db790f2");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
var invoiceCancelVar = new OS$DataTypes.VariableHolder();
...
model.widgets.get(idService.getId("TextArea_l_RejectReason")).validationMessageAttr = OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("_MUXR0vGtkiGJqtsaSdliw#Value.-1792125606.1", "You must state a reason to reject this proposal line.");
// l_IsExecuting = False
model.variables.l_IsExecutingVar = false;
} else {
// Execute Action: InvoiceCancel
model.flush();
return controller.invoiceCancel$ServerAction(model.variables.i_InvoiceIdIn, model.variables.i_InvoiceApprovalLevelIdIn, model.variables.l_RejectReasonVar, "", callContext).then(function (value) {
invoiceCancelVar.value = value;
}).then(function () {
// Trigger Event: Close
return controller.close$Action(true, callContext);
}).then(function () {
OS$FeedbackMessageService.showFeedbackMessage(OS$Injector.resolve(OS$ServiceNames.TranslationsService).getMessage("wq0dIEQcDUmZE5UlLu4vRw#Message.-1464385412.1", "This invoice has been canceled."), /*Warning*/ 2);
// l_IsExecuting = False
model.variables.l_IsExecutingVar = false;
});
}
...
span.setAttribute("outsystems.function.key", "8bf9ecfd-46c0-4290-b1d6-ecd00ceb8c4b");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
Controller.registerVariableGroupType("ConectaProveedores.d_InvoicePopups.Wb_PopupInvoiceCancel$ActionInvoiceCancel", [{
name: "o_Output",
