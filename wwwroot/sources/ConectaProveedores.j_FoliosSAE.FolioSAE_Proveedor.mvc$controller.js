...
import ConectaProveedores_j_FoliosSAE_FolioSAE_Proveedor_mvc_TranslationsResources from "./ConectaProveedores.j_FoliosSAE.FolioSAE_Proveedor.mvc$translationsResources.js";
...
super(model, messagesProvider, idService, ConectaProveedores_j_FoliosSAE_FolioSAE_Proveedor_mvc_TranslationsResources);
...
return controller.callServerAction("AuditCreateWrapper", "screenservices/ConectaProveedores/j_FoliosSAE/FolioSAE_Proveedor/ActionAuditCreateWrapper", "R9ncJjtM_dSZmMkM5XAN_g", inputs, controller.callContext(callContext), undefined, undefined, true, pendingPromises).then(function (outputs) {
});
}, function () {
if(span) {
span.end();
...
span.setAttribute("outsystems.function.key", "237e1549-10cf-4188-8333-2c9dc3ec05c7");
span.setAttribute("outsystems.function.owner.name", "ConectaProveedores");
span.setAttribute("outsystems.function.owner.key", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
rec.messageAttr = "";
rec.screenAttr = "Folio SAE Proveedor";
