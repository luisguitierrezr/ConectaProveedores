...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public ssConectaProveedores.RestRecords.RESTRC_0b2176705fa164c9531eb643caf0e9d4 outParamo_SummaryRec;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs FromOutputs(IBehaviorsConfiguration conf, RC_0b2176705fa164c9531eb643caf0e9d4 outParamo_SummaryRec) {RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Model ToModel(RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs variables) {ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Model result = new ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs();
