...
[Route("screenservices/ConectaProveedores/c_Requisitions/Wb_RequisitionsList_Internal_OldRequisitions")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController("ssOutSystemsUI.ScreenServices.OutSystemsUI_Controller", "OutSystemsUI", childControllers);
    ...
    static ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller() {
...
/*c_Requisitions.Wb_RequisitionsList_Internal_OldRequisitions.RefreshList*/"6dONWMH_kUW9Ti9X5sMIKA*x9KCvbXZskuVO2iCeScb8w", 
/*c_Requisitions.Wb_RequisitionsList_Internal_OldRequisitions.ShowHideCancelPopup*/"6dONWMH_kUW9Ti9X5sMIKA*uPSFw_o9lUi86t9HqwJIOw", 
...
/*System_.ListClear*/"uXCIR2Atc0+es3zYuZSnNw*veU0xTJwTE2X4au_He4_vw"});
    ...
    public ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetCompanies",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetCompanies(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "dUlLiZXilCXZfHjYY_ZYJg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel model = null;
...
try {model = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
[RESTScreenServicesActionProperties(Name="GetApprovalStatuses",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel.datasetGetApprovalStatuses(requestContext,datasetGetApprovalStatuses_maxRecords,datasetGetApprovalStatuses_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetProjectAssetServices",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel.datasetGetProjectAssetServices(requestContext,datasetGetProjectAssetServices_maxRecords,datasetGetProjectAssetServices_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetCostCenters",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel.datasetGetCostCenters(requestContext,datasetGetCostCenters_maxRecords,datasetGetCostCenters_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetRequisitionStatuses",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel.datasetGetRequisitionStatuses(requestContext,datasetGetRequisitionStatuses_maxRecords,datasetGetRequisitionStatuses_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetEntraRole",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel.datasetGetEntraRole(requestContext,datasetGetEntraRole_maxRecords,datasetGetEntraRole_startIndex,IterationMultiplicity.Multiple,BuiltInFunction.GetUserId (),cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetRequisitionsFull",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.DataAction)]
public async Task<ActionResult<Payload.ServiceResponse>> DataActionGetRequisitionsFull(CancellationToken cancellationToken) {
    using Stream input = HttpContext.Request.Body;
    return await EndpointAsync(input, "AJ1LpUgQHea1RSHPoqf9kA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel model = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
...
RL_a88cee033f640538574578015052224b outParamList;
...
var output = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitionsFull_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamList, outParamSortClause);
return output;
...
[RESTScreenServicesActionProperties(Name="GetUserApplicationRolesAndMore",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.DataAction)]
...
[RESTScreenServicesActionProperties(Name="GetRequisitions",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.DataAction)]
public async Task<ActionResult<Payload.ServiceResponse>> DataActionGetRequisitions(CancellationToken cancellationToken) {
    using Stream input = HttpContext.Request.Body;
    return await EndpointAsync(input, "BzbyKeA6+dCLL9ymkZGkdg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel model = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
...
var output = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamList, outParamTotalCount, outParamSortClause);
return output;
...
[RESTScreenServicesActionProperties(Name="ScreenTableDownloadWbRequisitionsListInternal",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionScreenTableDownloadWbRequisitionsListInternal(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "Z7ZqthqRTO4gO6E2yjKD8w", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionScreenTableDownloadWbRequisitionsListInternal_Model inputs = null;
...
try {inputs = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionScreenTableDownloadWbRequisitionsListInternal_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionScreenTableDownloadWbRequisitionsListInternal_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_File, res.outParamo_StringListIds, res.outParamo_StringListLevelIds, res.outParamo_ErrorMsg);
return output;
...
[RESTScreenServicesActionProperties(Name="ColumnTogglerPassColumn",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionColumnTogglerPassColumn(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "CdBjpqOzG3k0+Q1AYbtdhg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionColumnTogglerPassColumn_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionColumnTogglerPassColumn_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
[RESTScreenServicesActionProperties(Name="GetSettings",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetSettings(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "YMh+L1Z1H9xV5gLNPZiIAg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionGetSettings_Model inputs = null;
...
try {inputs = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionGetSettings_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionGetSettings_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamOutSettingsText);
return output;
...
[RESTScreenServicesActionProperties(Name="RequisitionCancel",Screen="Wb_RequisitionsList_Internal_OldRequisitions",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionRequisitionCancel(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "t_Cz8TUtEbxHcmD_3NS1BQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionRequisitionCancel_Model inputs = null;
...
try {inputs = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionRequisitionCancel_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ActionRequisitionCancel_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_Output);
return output;
