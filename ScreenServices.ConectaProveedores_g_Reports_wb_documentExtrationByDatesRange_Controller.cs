...
[Route("screenservices/ConectaProveedores/g_Reports/wb_documentExtrationByDatesRange")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController("ssOutSystemsUI.ScreenServices.OutSystemsUI_Controller", "OutSystemsUI", childControllers);
    ...
    static ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller() {
...
/*g_Reports.wb_documentExtrationByDatesRange.Refresh*/"6dONWMH_kUW9Ti9X5sMIKA*79SGvwwmr0izds0PKFlyxA", 
/*OutSystemsUI.DatePickerClose*/"Kn_hixxDWEm4lMd7mIpycQ*Ng5_r9LHuEShqJ_OLWbntg"});

    }

    public ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetInvoiceFiles",Screen="wb_documentExtrationByDatesRange",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetInvoiceFiles(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "iRsas8z3jx0E6MBaWarAqA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel model = null;
...
try {model = RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
[RESTScreenServicesActionProperties(Name="ServiceGetDocumentsByListId",Screen="wb_documentExtrationByDatesRange",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ServiceAPIServiceGetDocumentsByListId(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "B_km2SQBw90cnqn+1+_34g", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ServiceAPIServiceGetDocumentsByListId_Model inputs = null;
...
try {inputs = RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ServiceAPIServiceGetDocumentsByListId_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_g_Reports_wb_documentExtrationByDatesRange_ServiceAPIServiceGetDocumentsByListId_Outputs.FromOutputs(this.BehaviorsConfiguration, res_outParamBinaryZip);
return output;
