...
public static Func<ssConectaProveedores.RestRecords.JSONRC_a091342374a4b333cc44c9d3c7cd8caa, RC_a091342374a4b333cc44c9d3c7cd8caa> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_a091342374a4b333cc44c9d3c7cd8caa s) => ToStructure(s, config);
}
public static RC_a091342374a4b333cc44c9d3c7cd8caa ToStructure(ssConectaProveedores.RestRecords.JSONRC_a091342374a4b333cc44c9d3c7cd8caa obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_a091342374a4b333cc44c9d3c7cd8caa, ssConectaProveedores.RestRecords.JSONRC_a091342374a4b333cc44c9d3c7cd8caa> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_a091342374a4b333cc44c9d3c7cd8caa s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_a091342374a4b333cc44c9d3c7cd8caa FromStructure(RC_a091342374a4b333cc44c9d3c7cd8caa s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_a091342374a4b333cc44c9d3c7cd8caa(s, config);
}
