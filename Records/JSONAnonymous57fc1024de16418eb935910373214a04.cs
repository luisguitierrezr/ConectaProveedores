...
public static Func<ssConectaProveedores.RestRecords.JSONRC_66db0edcff7ea9b0aa258e335add1ccc, RC_66db0edcff7ea9b0aa258e335add1ccc> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_66db0edcff7ea9b0aa258e335add1ccc s) => ToStructure(s, config);
}
public static RC_66db0edcff7ea9b0aa258e335add1ccc ToStructure(ssConectaProveedores.RestRecords.JSONRC_66db0edcff7ea9b0aa258e335add1ccc obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_66db0edcff7ea9b0aa258e335add1ccc, ssConectaProveedores.RestRecords.JSONRC_66db0edcff7ea9b0aa258e335add1ccc> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_66db0edcff7ea9b0aa258e335add1ccc s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_66db0edcff7ea9b0aa258e335add1ccc FromStructure(RC_66db0edcff7ea9b0aa258e335add1ccc s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_66db0edcff7ea9b0aa258e335add1ccc(s, config);
}
