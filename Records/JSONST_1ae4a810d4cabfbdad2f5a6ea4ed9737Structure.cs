...
public static Func<ssConectaProveedores.RestRecords.JSONST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure, ST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure s) => ToStructure(s, config);
}
public static ST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure, ssConectaProveedores.RestRecords.JSONST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure FromStructure(ST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_1ae4a810d4cabfbdad2f5a6ea4ed9737Structure(s, config);
}
