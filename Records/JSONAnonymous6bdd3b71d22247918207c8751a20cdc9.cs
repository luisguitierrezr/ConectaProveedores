...
// InvoiceInvoiceFileRequisitionInvoiceAccountingServicesInvoiceAccountingInvoiceExtendedSelectStorageSupplierRegionRecord
public class JSONRC_347b60df6e6a3a0faa9891794d99f22d : AbstractRESTStructure<RC_347b60df6e6a3a0faa9891794d99f22d> {
...
public JSONRC_347b60df6e6a3a0faa9891794d99f22d() { }

public JSONRC_347b60df6e6a3a0faa9891794d99f22d (RC_347b60df6e6a3a0faa9891794d99f22d s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONRC_347b60df6e6a3a0faa9891794d99f22d, RC_347b60df6e6a3a0faa9891794d99f22d> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_347b60df6e6a3a0faa9891794d99f22d s) => ToStructure(s, config);
}
public static RC_347b60df6e6a3a0faa9891794d99f22d ToStructure(ssConectaProveedores.RestRecords.JSONRC_347b60df6e6a3a0faa9891794d99f22d obj, IBehaviorsConfiguration config) { 
  RC_347b60df6e6a3a0faa9891794d99f22d s = new RC_347b60df6e6a3a0faa9891794d99f22d();
  if(obj != null) {
...
public static Func<RC_347b60df6e6a3a0faa9891794d99f22d, ssConectaProveedores.RestRecords.JSONRC_347b60df6e6a3a0faa9891794d99f22d> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_347b60df6e6a3a0faa9891794d99f22d s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_347b60df6e6a3a0faa9891794d99f22d FromStructure(RC_347b60df6e6a3a0faa9891794d99f22d s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_347b60df6e6a3a0faa9891794d99f22d(s, config);
}
