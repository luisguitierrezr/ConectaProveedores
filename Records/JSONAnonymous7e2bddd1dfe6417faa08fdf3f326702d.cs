...
public class JSONRC_95ccc9074d33a4c760deaadf0253611a : AbstractRESTStructure<RC_95ccc9074d33a4c760deaadf0253611a> {
[JsonProperty("Folio")]
...
public JSONRC_95ccc9074d33a4c760deaadf0253611a() { }

public JSONRC_95ccc9074d33a4c760deaadf0253611a (RC_95ccc9074d33a4c760deaadf0253611a s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONRC_95ccc9074d33a4c760deaadf0253611a, RC_95ccc9074d33a4c760deaadf0253611a> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_95ccc9074d33a4c760deaadf0253611a s) => ToStructure(s, config);
}
public static RC_95ccc9074d33a4c760deaadf0253611a ToStructure(ssConectaProveedores.RestRecords.JSONRC_95ccc9074d33a4c760deaadf0253611a obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_95ccc9074d33a4c760deaadf0253611a, ssConectaProveedores.RestRecords.JSONRC_95ccc9074d33a4c760deaadf0253611a> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_95ccc9074d33a4c760deaadf0253611a s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_95ccc9074d33a4c760deaadf0253611a FromStructure(RC_95ccc9074d33a4c760deaadf0253611a s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_95ccc9074d33a4c760deaadf0253611a(s, config);
}
