...
public class RESTST_452088c4ad7c6718df20290248661783Structure : AbstractRESTStructure<ST_452088c4ad7c6718df20290248661783Structure> {
...
public RestList<string> AttrInvoiceUsageKeyList;

public RESTST_452088c4ad7c6718df20290248661783Structure() { }

public RESTST_452088c4ad7c6718df20290248661783Structure (ST_452088c4ad7c6718df20290248661783Structure s, IBehaviorsConfiguration config) {
...
AttrInvoiceUsageKeyList = s.ssInvoiceUsageKeyList.Length == 0 ? null : s.ssInvoiceUsageKeyList.ToRestList();
  } else {
...
AttrInvoiceUsageKeyList = s.ssInvoiceUsageKeyList.ToRestList();
  }
}

public static ST_452088c4ad7c6718df20290248661783Structure ToStructure(ssConectaProveedores.RestRecords.RESTST_452088c4ad7c6718df20290248661783Structure obj) { 
  ...
  s.ssInvoiceUsageKeyList = BasicTypeList<string>.FromRestList(obj.AttrInvoiceUsageKeyList);
  }
  return s;
}

public static Func<ST_452088c4ad7c6718df20290248661783Structure, ssConectaProveedores.RestRecords.RESTST_452088c4ad7c6718df20290248661783Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_452088c4ad7c6718df20290248661783Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.RESTST_452088c4ad7c6718df20290248661783Structure FromStructure(ST_452088c4ad7c6718df20290248661783Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.RESTST_452088c4ad7c6718df20290248661783Structure(s, config);
}
