...
// CurrencyUserOrderStatusOrderApprovalOrderMainDiffDaysCompanySupplierRegionRecord
public class JSONRC_f100e5d5057b18be95e8602dfe9dd2af : AbstractRESTStructure<RC_f100e5d5057b18be95e8602dfe9dd2af> {
...
[JsonProperty("DiffDays")]
[JsonPropertyName("DiffDays")]
public int? AttrDiffDays;
...
public JSONRC_f100e5d5057b18be95e8602dfe9dd2af() { }

public JSONRC_f100e5d5057b18be95e8602dfe9dd2af (RC_f100e5d5057b18be95e8602dfe9dd2af s, IBehaviorsConfiguration config) {
...
AttrDiffDays = ConvertToRestWithoutDefaults(s.ssDiffDays, 0);
...
public static Func<ssConectaProveedores.RestRecords.JSONRC_f100e5d5057b18be95e8602dfe9dd2af, RC_f100e5d5057b18be95e8602dfe9dd2af> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_f100e5d5057b18be95e8602dfe9dd2af s) => ToStructure(s, config);
}
public static RC_f100e5d5057b18be95e8602dfe9dd2af ToStructure(ssConectaProveedores.RestRecords.JSONRC_f100e5d5057b18be95e8602dfe9dd2af obj, IBehaviorsConfiguration config) { 
  RC_f100e5d5057b18be95e8602dfe9dd2af s = new RC_f100e5d5057b18be95e8602dfe9dd2af();
  if(obj != null) {
  ...
  s.ssDiffDays = obj.AttrDiffDays == null ? 0 : obj.AttrDiffDays.Value;
...
public static Func<RC_f100e5d5057b18be95e8602dfe9dd2af, ssConectaProveedores.RestRecords.JSONRC_f100e5d5057b18be95e8602dfe9dd2af> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_f100e5d5057b18be95e8602dfe9dd2af s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_f100e5d5057b18be95e8602dfe9dd2af FromStructure(RC_f100e5d5057b18be95e8602dfe9dd2af s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_f100e5d5057b18be95e8602dfe9dd2af(s, config);
}
