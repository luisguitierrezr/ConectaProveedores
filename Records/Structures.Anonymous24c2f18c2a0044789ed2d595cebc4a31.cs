...
/// <summary>
/// [AnonymousStructure] Record (jPHCJAAqeESe0tWVzrxKMQ)
///  <code>RC_26eb8683712e8211ad6c0f473a3d11d4</code> that represent
/// s
///  <code>CurrencyUser_ApplicantUser_UpdatedByApprovalStatusRequisitionRequisitionApprovalLevelRequisit
/// ionApprovalRequisitionStatusDontShowActionIsUserFromThisRegionApplicationRoleCompanySupplierCostCent
/// erSAPTelcelDirectionSegmentAccGroupProject_Asset_ServiceSegmentAccGroupTelcelDirRegionRecord</code>
///  <p>Description: </p>
/// </summary>
// Name: CurrencyUser_ApplicantUser_UpdatedByApprovalStatusRequisitionRequisitionApprovalLevelRequisitionApprovalRequisitionStatusDontShowActionIsUserFromThisRegionApplicationRoleCompanySupplierCostCenterSAPTelcelDirectionSegmentAccGroupProject_Asset_ServiceSegmentAccGroupTelcelDirRegionRecord
public partial struct RC_26eb8683712e8211ad6c0f473a3d11d4 : ITypedRecord<RC_26eb8683712e8211ad6c0f473a3d11d4> {
internal static readonly GlobalObjectKey IdCurrency = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*L_BoBOY11sygkvMhxdiojg");
internal static readonly GlobalObjectKey IdUser_Applicant = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*yAZK5P49q5qgN5FDB+SSLg");
...
public ENUserEntityRecord ssENUser_Applicant;
...
public RC_26eb8683712e8211ad6c0f473a3d11d4() {
OptimizedAttributes = null;
ssENCurrency = new EN_327b52812b8badb247bde4975c10d441EntityRecord();
ssENUser_Applicant = new ENUserEntityRecord();
...
set{
    ...
    ssENUser_Applicant.OptimizedAttributes = GetDefaultOptimizedValues()[1];
    ...
    ssENRequisitionApproval.OptimizedAttributes = GetDefaultOptimizedValues()[6];
    ssENRequisitionStatus.OptimizedAttributes = GetDefaultOptimizedValues()[7];
    ...
    ssENUser_Applicant.OptimizedAttributes = value[1];
    ...
    ssENRequisitionApproval.OptimizedAttributes = value[6];
    ssENRequisitionStatus.OptimizedAttributes = value[7];
...
get{
    ...
    all[1] = ssENUser_Applicant.OptimizedAttributes;
    ...
    all[6] = ssENRequisitionApproval.OptimizedAttributes;
    all[7] = ssENRequisitionStatus.OptimizedAttributes;
    all[8] = null;
    all[9] = null;
...
ssENUser_Applicant.Read( r, ref index);
...
public void ReadIM(RC_26eb8683712e8211ad6c0f473a3d11d4 r) {
this = r;
}


public static bool operator == (RC_26eb8683712e8211ad6c0f473a3d11d4 a, RC_26eb8683712e8211ad6c0f473a3d11d4 b) {
if (a.ssENCurrency != b.ssENCurrency) return false;
if (a.ssENUser_Applicant != b.ssENUser_Applicant) return false;
...
if (o.GetType() != typeof (RC_26eb8683712e8211ad6c0f473a3d11d4)) return false;
return (this == (RC_26eb8683712e8211ad6c0f473a3d11d4)o);
}
...
return base.GetHashCode()
 ...
 ^ ssENUser_Applicant.GetHashCode()
...
ssENUser_Applicant.RecursiveReset();
...
ssENUser_Applicant.InternalRecursiveSave();
...
public RC_26eb8683712e8211ad6c0f473a3d11d4 Duplicate() {
RC_26eb8683712e8211ad6c0f473a3d11d4 t;
t.ssENCurrency = (EN_327b52812b8badb247bde4975c10d441EntityRecord)this.ssENCurrency.Duplicate();
t.ssENUser_Applicant = (ENUserEntityRecord)this.ssENUser_Applicant.Duplicate();
...
} else if (head == "user_applicant") {
if (!VarValue.FieldIsOptimized(parent, baseName + ".User_Applicant")) variable.Value = ssENUser_Applicant; else variable.Optimized = true;
variable.SetFieldName("user_applicant");
...
if (key == IdUser_Applicant) {
return ssENUser_Applicant;
}
...
if (attributeKey == IdUser_Applicant.Key.AsGuid) {
return ssENUser_Applicant;
}
...
ssENUser_Applicant.FillFromOther((IRecord) other.AttributeGet(IdUser_Applicant));
...
} // RC_26eb8683712e8211ad6c0f473a3d11d4
/// <summary>
/// RecordList type
///  <code>CurrencyUser_ApplicantUser_UpdatedByApprovalStatusRequisitionRequisitionApprovalLevelRequisit
/// ionApprovalRequisitionStatusDontShowActionIsUserFromThisRegionApplicationRoleCompanySupplierCostCent
/// erSAPTelcelDirectionSegmentAccGroupProject_Asset_ServiceSegmentAccGroupTelcelDirRegionRecordList</co
/// de> that represents a record list of <code>Currency, User, User, ApprovalStatus, Requisition,
///  RequisitionApprovalLevel, RequisitionApproval, RequisitionStatus, Boolean, Boolean
...
/// </summary>
public partial class RL_50b9c4d0facccc9677374d1779eeeebb : GenericRecordList<RC_26eb8683712e8211ad6c0f473a3d11d4>, IEnumerable, IEnumerator {

protected override RC_26eb8683712e8211ad6c0f473a3d11d4 GetElementDefaultValue() {
return new RC_26eb8683712e8211ad6c0f473a3d11d4();
}

public T[] ToArray<T>(Func<RC_26eb8683712e8211ad6c0f473a3d11d4, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_50b9c4d0facccc9677374d1779eeeebb recordList, Func<RC_26eb8683712e8211ad6c0f473a3d11d4, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_50b9c4d0facccc9677374d1779eeeebb(RC_26eb8683712e8211ad6c0f473a3d11d4[] array) {
  RL_50b9c4d0facccc9677374d1779eeeebb result = new RL_50b9c4d0facccc9677374d1779eeeebb();
result.InnerFromArray(array);
    return result;
}

public static RL_50b9c4d0facccc9677374d1779eeeebb ToList<T>(T[] array, Func <T, RC_26eb8683712e8211ad6c0f473a3d11d4> converter) {
  RL_50b9c4d0facccc9677374d1779eeeebb result = new RL_50b9c4d0facccc9677374d1779eeeebb();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_50b9c4d0facccc9677374d1779eeeebb FromRestList<T>(RestList<T> restList, Func <T, RC_26eb8683712e8211ad6c0f473a3d11d4> converter) {
  RL_50b9c4d0facccc9677374d1779eeeebb result = new RL_50b9c4d0facccc9677374d1779eeeebb();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_50b9c4d0facccc9677374d1779eeeebb() : base() {
}
...
protected override OSList<RC_26eb8683712e8211ad6c0f473a3d11d4> NewList() {
return new RL_50b9c4d0facccc9677374d1779eeeebb();
}


} // RL_50b9c4d0facccc9677374d1779eeeebb
}
