...
public static Func<ssConectaProveedores.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure, ST_b8bada9441ba6abcbadb418a924fe551Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure s) => ToStructure(s, config);
}
public static ST_b8bada9441ba6abcbadb418a924fe551Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_b8bada9441ba6abcbadb418a924fe551Structure, ssConectaProveedores.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_b8bada9441ba6abcbadb418a924fe551Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure FromStructure(ST_b8bada9441ba6abcbadb418a924fe551Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure(s, config);
}
