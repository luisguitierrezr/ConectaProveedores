...
/// <summary>
/// [AnonymousStructure] Record (cTvdayLSkUeCB8h1GiDNyQ)
///  <code>RC_347b60df6e6a3a0faa9891794d99f22d</code> that represent
/// s
///  <code>InvoiceInvoiceFileRequisitionInvoiceAccountingServicesInvoiceAccountingInvoiceExtendedSelectS
/// torageSupplierRegionRecord</code> <p>Description: </p>
/// </summary>
// Name: InvoiceInvoiceFileRequisitionInvoiceAccountingServicesInvoiceAccountingInvoiceExtendedSelectStorageSupplierRegionRecord
public partial struct RC_347b60df6e6a3a0faa9891794d99f22d : ITypedRecord<RC_347b60df6e6a3a0faa9891794d99f22d> {
...
internal static readonly GlobalObjectKey IdSelect = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*WWsfJPyzQRJjxo17bH9X1Q");
...
public RC_347b60df6e6a3a0faa9891794d99f22d() {
...
set{
    ...
    ssENInvoiceAccountingServices.OptimizedAttributes = GetDefaultOptimizedValues()[3];
    ...
    ssENStorage.OptimizedAttributes = GetDefaultOptimizedValues()[6];
    ...
    ssENInvoiceAccountingServices.OptimizedAttributes = value[3];
    ssENInvoiceAccounting.OptimizedAttributes = value[4];
    ssENInvoiceExtended.OptimizedAttributes = value[5];
    ssENStorage.OptimizedAttributes = value[6];
...
get{
    ...
    all[3] = ssENInvoiceAccountingServices.OptimizedAttributes;
    all[4] = ssENInvoiceAccounting.OptimizedAttributes;
    all[5] = ssENInvoiceExtended.OptimizedAttributes;
    all[6] = ssENStorage.OptimizedAttributes;
...
ssSelect = r.ReadBoolean(index++, "InvoiceInvoiceFileRequisitionInvoiceAccountingServicesInvoiceAccountingInvoiceExtendedSelectStorageSupplierRegionRecord.Select", false);
...
public void ReadIM(RC_347b60df6e6a3a0faa9891794d99f22d r) {
this = r;
}


public static bool operator == (RC_347b60df6e6a3a0faa9891794d99f22d a, RC_347b60df6e6a3a0faa9891794d99f22d b) {
...
if (o.GetType() != typeof (RC_347b60df6e6a3a0faa9891794d99f22d)) return false;
return (this == (RC_347b60df6e6a3a0faa9891794d99f22d)o);
}
...
public RC_347b60df6e6a3a0faa9891794d99f22d Duplicate() {
RC_347b60df6e6a3a0faa9891794d99f22d t;
...
} else if (head == "invoiceaccountingservices") {
...
} // RC_347b60df6e6a3a0faa9891794d99f22d
/// <summary>
/// RecordList type
///  <code>InvoiceInvoiceFileRequisitionInvoiceAccountingServicesInvoiceAccountingInvoiceExtendedSelectS
/// torageSupplierRegionRecordList</code> that represents a record list of <code>Invoice, InvoiceFile,
///  Requisition, InvoiceAccountingServices, InvoiceAccounting, InvoiceExtended, Boolean, Storage
/// , Supplier, Region</code>
/// </summary>
public partial class RL_3b5fd7e8774e3e50b2a4c100f837401e : GenericRecordList<RC_347b60df6e6a3a0faa9891794d99f22d>, IEnumerable, IEnumerator {

protected override RC_347b60df6e6a3a0faa9891794d99f22d GetElementDefaultValue() {
return new RC_347b60df6e6a3a0faa9891794d99f22d();
}

public T[] ToArray<T>(Func<RC_347b60df6e6a3a0faa9891794d99f22d, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_3b5fd7e8774e3e50b2a4c100f837401e recordList, Func<RC_347b60df6e6a3a0faa9891794d99f22d, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_3b5fd7e8774e3e50b2a4c100f837401e(RC_347b60df6e6a3a0faa9891794d99f22d[] array) {
  RL_3b5fd7e8774e3e50b2a4c100f837401e result = new RL_3b5fd7e8774e3e50b2a4c100f837401e();
result.InnerFromArray(array);
    return result;
}

public static RL_3b5fd7e8774e3e50b2a4c100f837401e ToList<T>(T[] array, Func <T, RC_347b60df6e6a3a0faa9891794d99f22d> converter) {
  RL_3b5fd7e8774e3e50b2a4c100f837401e result = new RL_3b5fd7e8774e3e50b2a4c100f837401e();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_3b5fd7e8774e3e50b2a4c100f837401e FromRestList<T>(RestList<T> restList, Func <T, RC_347b60df6e6a3a0faa9891794d99f22d> converter) {
  RL_3b5fd7e8774e3e50b2a4c100f837401e result = new RL_3b5fd7e8774e3e50b2a4c100f837401e();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_3b5fd7e8774e3e50b2a4c100f837401e() : base() {
}
...
protected override OSList<RC_347b60df6e6a3a0faa9891794d99f22d> NewList() {
return new RL_3b5fd7e8774e3e50b2a4c100f837401e();
}


} // RL_3b5fd7e8774e3e50b2a4c100f837401e
}
