...
// InvoiceExtended
public class RESTEN_f81a3d226103fd013068b8763798067aEntityRecord : AbstractRESTStructure<EN_f81a3d226103fd013068b8763798067aEntityRecord> {
[JsonProperty("Id")]
public long? AttrId;
...
public RESTEN_f81a3d226103fd013068b8763798067aEntityRecord() { }

public RESTEN_f81a3d226103fd013068b8763798067aEntityRecord (EN_f81a3d226103fd013068b8763798067aEntityRecord s, IBehaviorsConfiguration config) {
...
public static EN_f81a3d226103fd013068b8763798067aEntityRecord ToStructure(ssConectaProveedores.RestRecords.RESTEN_f81a3d226103fd013068b8763798067aEntityRecord obj) { 
...
public static Func<EN_f81a3d226103fd013068b8763798067aEntityRecord, ssConectaProveedores.RestRecords.RESTEN_f81a3d226103fd013068b8763798067aEntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_f81a3d226103fd013068b8763798067aEntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.RESTEN_f81a3d226103fd013068b8763798067aEntityRecord FromStructure(EN_f81a3d226103fd013068b8763798067aEntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.RESTEN_f81a3d226103fd013068b8763798067aEntityRecord(s, config);
}
