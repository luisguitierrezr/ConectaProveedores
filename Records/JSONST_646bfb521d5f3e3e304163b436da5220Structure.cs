...
public static Func<ssConectaProveedores.RestRecords.JSONST_646bfb521d5f3e3e304163b436da5220Structure, ST_646bfb521d5f3e3e304163b436da5220Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_646bfb521d5f3e3e304163b436da5220Structure s) => ToStructure(s, config);
}
public static ST_646bfb521d5f3e3e304163b436da5220Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_646bfb521d5f3e3e304163b436da5220Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_646bfb521d5f3e3e304163b436da5220Structure, ssConectaProveedores.RestRecords.JSONST_646bfb521d5f3e3e304163b436da5220Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_646bfb521d5f3e3e304163b436da5220Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_646bfb521d5f3e3e304163b436da5220Structure FromStructure(ST_646bfb521d5f3e3e304163b436da5220Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_646bfb521d5f3e3e304163b436da5220Structure(s, config);
}
