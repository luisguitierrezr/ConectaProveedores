...
public static Func<ssConectaProveedores.RestRecords.JSONEN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord, EN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONEN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord s) => ToStructure(s, config);
}
public static EN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord ToStructure(ssConectaProveedores.RestRecords.JSONEN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord obj, IBehaviorsConfiguration config) { 
...
public static Func<EN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord, ssConectaProveedores.RestRecords.JSONEN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONEN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord FromStructure(EN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONEN_2a34dd0db0e0295f5091c15f08aa6001EntityRecord(s, config);
}
