...
/// <summary>
/// [AnonymousStructure] Record (Lh9WEIhwj0SOu274jCV24Q)
///  <code>RC_4cb48735c6c0de4a1d3871eb33750007</code> that represent
/// s
///  <code>CurrencyUserUser_UpdateByApprovalStatusRequisitionRequisitionApprovalLevelRequisitionApproval
/// RequisitionStatusCompanySupplierCostCenterSAPProject_Asset_ServiceRegionRecord</code>
///  <p>Description: </p>
/// </summary>
// Name: CurrencyUserUser_UpdateByApprovalStatusRequisitionRequisitionApprovalLevelRequisitionApprovalRequisitionStatusCompanySupplierCostCenterSAPProject_Asset_ServiceRegionRecord
public partial struct RC_4cb48735c6c0de4a1d3871eb33750007 : ITypedRecord<RC_4cb48735c6c0de4a1d3871eb33750007> {
...
internal static readonly GlobalObjectKey IdUser_UpdateBy = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*5YAB8PumO9J1fA3ciYQ4Tg");
...
public ENUserEntityRecord ssENUser_UpdateBy;
...
public RC_4cb48735c6c0de4a1d3871eb33750007() {
OptimizedAttributes = null;
ssENCurrency = new EN_327b52812b8badb247bde4975c10d441EntityRecord();
ssENUser = new ENUserEntityRecord();
ssENUser_UpdateBy = new ENUserEntityRecord();
...
set{
    ...
    ssENUser_UpdateBy.OptimizedAttributes = GetDefaultOptimizedValues()[2];
    ...
    ssENUser_UpdateBy.OptimizedAttributes = value[2];
...
get{
    ...
    all[2] = ssENUser_UpdateBy.OptimizedAttributes;
...
ssENUser_UpdateBy.Read( r, ref index);
...
public void ReadIM(RC_4cb48735c6c0de4a1d3871eb33750007 r) {
this = r;
}


public static bool operator == (RC_4cb48735c6c0de4a1d3871eb33750007 a, RC_4cb48735c6c0de4a1d3871eb33750007 b) {
if (a.ssENCurrency != b.ssENCurrency) return false;
if (a.ssENUser != b.ssENUser) return false;
if (a.ssENUser_UpdateBy != b.ssENUser_UpdateBy) return false;
...
if (o.GetType() != typeof (RC_4cb48735c6c0de4a1d3871eb33750007)) return false;
return (this == (RC_4cb48735c6c0de4a1d3871eb33750007)o);
}
...
ssENUser_UpdateBy.RecursiveReset();
...
ssENUser_UpdateBy.InternalRecursiveSave();
...
public RC_4cb48735c6c0de4a1d3871eb33750007 Duplicate() {
RC_4cb48735c6c0de4a1d3871eb33750007 t;
t.ssENCurrency = (EN_327b52812b8badb247bde4975c10d441EntityRecord)this.ssENCurrency.Duplicate();
t.ssENUser = (ENUserEntityRecord)this.ssENUser.Duplicate();
t.ssENUser_UpdateBy = (ENUserEntityRecord)this.ssENUser_UpdateBy.Duplicate();
...
} else if (head == "user_updateby") {
if (!VarValue.FieldIsOptimized(parent, baseName + ".User_UpdateBy")) variable.Value = ssENUser_UpdateBy; else variable.Optimized = true;
variable.SetFieldName("user_updateby");
...
if (key == IdUser_UpdateBy) {
return ssENUser_UpdateBy;
}
...
if (attributeKey == IdUser_UpdateBy.Key.AsGuid) {
return ssENUser_UpdateBy;
}
...
ssENUser_UpdateBy.FillFromOther((IRecord) other.AttributeGet(IdUser_UpdateBy));
...
} // RC_4cb48735c6c0de4a1d3871eb33750007
/// <summary>
/// RecordList type
///  <code>CurrencyUserUser_UpdateByApprovalStatusRequisitionRequisitionApprovalLevelRequisitionApproval
/// RequisitionStatusCompanySupplierCostCenterSAPProject_Asset_ServiceRegionRecordList</code> that
///  represents a record list of <code>Currency, User, User, ApprovalStatus, Requisition
/// , RequisitionApprovalLevel, RequisitionApproval, RequisitionStatus, Company, Supplier,
///  CostCenterSAP, Project_Asset_Service, Region</code>
/// </summary>
public partial class RL_736d97877f60cf41325c2e16af4510d1 : GenericRecordList<RC_4cb48735c6c0de4a1d3871eb33750007>, IEnumerable, IEnumerator {

protected override RC_4cb48735c6c0de4a1d3871eb33750007 GetElementDefaultValue() {
return new RC_4cb48735c6c0de4a1d3871eb33750007();
}

public T[] ToArray<T>(Func<RC_4cb48735c6c0de4a1d3871eb33750007, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_736d97877f60cf41325c2e16af4510d1 recordList, Func<RC_4cb48735c6c0de4a1d3871eb33750007, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_736d97877f60cf41325c2e16af4510d1(RC_4cb48735c6c0de4a1d3871eb33750007[] array) {
  RL_736d97877f60cf41325c2e16af4510d1 result = new RL_736d97877f60cf41325c2e16af4510d1();
result.InnerFromArray(array);
    return result;
}

public static RL_736d97877f60cf41325c2e16af4510d1 ToList<T>(T[] array, Func <T, RC_4cb48735c6c0de4a1d3871eb33750007> converter) {
  RL_736d97877f60cf41325c2e16af4510d1 result = new RL_736d97877f60cf41325c2e16af4510d1();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_736d97877f60cf41325c2e16af4510d1 FromRestList<T>(RestList<T> restList, Func <T, RC_4cb48735c6c0de4a1d3871eb33750007> converter) {
  RL_736d97877f60cf41325c2e16af4510d1 result = new RL_736d97877f60cf41325c2e16af4510d1();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_736d97877f60cf41325c2e16af4510d1() : base() {
}
...
protected override OSList<RC_4cb48735c6c0de4a1d3871eb33750007> NewList() {
return new RL_736d97877f60cf41325c2e16af4510d1();
}


} // RL_736d97877f60cf41325c2e16af4510d1
}
