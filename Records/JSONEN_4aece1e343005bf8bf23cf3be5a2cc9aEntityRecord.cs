...
public static Func<ssConectaProveedores.RestRecords.JSONEN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord, EN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONEN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord s) => ToStructure(s, config);
}
public static EN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord ToStructure(ssConectaProveedores.RestRecords.JSONEN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord obj, IBehaviorsConfiguration config) { 
...
public static Func<EN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord, ssConectaProveedores.RestRecords.JSONEN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONEN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord FromStructure(EN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONEN_4aece1e343005bf8bf23cf3be5a2cc9aEntityRecord(s, config);
}
