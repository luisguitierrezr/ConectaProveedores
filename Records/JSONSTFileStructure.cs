...
public static Func<ssConectaProveedores.RestRecords.JSONSTFileStructure, STFileStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONSTFileStructure s) => ToStructure(s, config);
}
public static STFileStructure ToStructure(ssConectaProveedores.RestRecords.JSONSTFileStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<STFileStructure, ssConectaProveedores.RestRecords.JSONSTFileStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (STFileStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONSTFileStructure FromStructure(STFileStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONSTFileStructure(s, config);
}
