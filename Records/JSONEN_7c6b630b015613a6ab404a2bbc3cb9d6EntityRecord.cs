...
// ProposalLine
public class JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord : AbstractRESTStructure<EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord> {
[JsonProperty("Id")]
[JsonPropertyName("Id")]
public long? AttrId;
...
[JsonPropertyName("Fe_contab_")]
public String AttrFe_contab_;

[JsonProperty("Ej__mes")]
[JsonPropertyName("Ej__mes")]
...
[JsonPropertyName("UnpaidBy")]
public string AttrUnpaidBy;

[JsonProperty("UnpaidOn")]
[JsonPropertyName("UnpaidOn")]
...
public JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord() { }

public JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord (EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord, EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord s) => ToStructure(s, config);
}
public static EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord ToStructure(ssConectaProveedores.RestRecords.JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord obj, IBehaviorsConfiguration config) { 
  ...
  s.ssPaidOn = obj.AttrPaidOn == null ? new DateTime(1900, 1, 1, 0, 0, 0, DateTimeKind.Utc) : OutSystems.RESTService.Runtime.Abstractions.Conversions.TextToDateTime(obj.AttrPaidOn, config.DateTimeFormat);
  s.ssUnpaidBy = obj.AttrUnpaidBy == null ? "" : obj.AttrUnpaidBy;
  s.ssUnpaidOn = obj.AttrUnpaidOn == null ? new DateTime(1900, 1, 1, 0, 0, 0, DateTimeKind.Utc) : OutSystems.RESTService.Runtime.Abstractions.Conversions.TextToDateTime(obj.AttrUnpaidOn, config.DateTimeFormat);
...
public static Func<EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord, ssConectaProveedores.RestRecords.JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord FromStructure(EN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONEN_7c6b630b015613a6ab404a2bbc3cb9d6EntityRecord(s, config);
}
