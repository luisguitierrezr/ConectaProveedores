...
public static Func<ssConectaProveedores.RestRecords.JSONRC_33e6e9ec201f65e0eb7bd5d251178def, RC_33e6e9ec201f65e0eb7bd5d251178def> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_33e6e9ec201f65e0eb7bd5d251178def s) => ToStructure(s, config);
}
public static RC_33e6e9ec201f65e0eb7bd5d251178def ToStructure(ssConectaProveedores.RestRecords.JSONRC_33e6e9ec201f65e0eb7bd5d251178def obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_33e6e9ec201f65e0eb7bd5d251178def, ssConectaProveedores.RestRecords.JSONRC_33e6e9ec201f65e0eb7bd5d251178def> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_33e6e9ec201f65e0eb7bd5d251178def s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_33e6e9ec201f65e0eb7bd5d251178def FromStructure(RC_33e6e9ec201f65e0eb7bd5d251178def s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_33e6e9ec201f65e0eb7bd5d251178def(s, config);
}
