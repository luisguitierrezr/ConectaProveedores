...
// Folio
public class JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord : AbstractRESTStructure<EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord> {
[JsonProperty("Id")]
[JsonPropertyName("Id")]
public long? AttrId;
...
[JsonPropertyName("CanProveedorCancel")]
...
[JsonPropertyName("FolioStatusId")]
...
[JsonPropertyName("TotalIVA_Amount")]
...
[JsonPropertyName("FirstApproverUserId")]
...
[JsonPropertyName("SAPEntryError")]
...
[JsonPropertyName("MinuteSelected")]
public int? AttrMinuteSelected;

public JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord() { }

public JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord (EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord, EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord s) => ToStructure(s, config);
}
public static EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord ToStructure(ssConectaProveedores.RestRecords.JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord obj, IBehaviorsConfiguration config) { 
...
public static Func<EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord, ssConectaProveedores.RestRecords.JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord FromStructure(EN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONEN_764a7cdbc8a8735aa4be34db0d0a0f0aEntityRecord(s, config);
}
