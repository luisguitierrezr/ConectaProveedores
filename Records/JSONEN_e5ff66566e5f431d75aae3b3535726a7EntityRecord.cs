...
public class JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord : AbstractRESTStructure<EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord> {
[JsonProperty("Id")]
[JsonPropertyName("Id")]
public long? AttrId;

[JsonProperty("RequisitionAccountingId")]
[JsonPropertyName("RequisitionAccountingId")]
...
[JsonPropertyName("RequisitionAccConceptsId")]
...
public JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord() { }

public JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord (EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord, EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord s) => ToStructure(s, config);
}
public static EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord ToStructure(ssConectaProveedores.RestRecords.JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord obj, IBehaviorsConfiguration config) { 
...
public static Func<EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord, ssConectaProveedores.RestRecords.JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord FromStructure(EN_e5ff66566e5f431d75aae3b3535726a7EntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONEN_e5ff66566e5f431d75aae3b3535726a7EntityRecord(s, config);
}
