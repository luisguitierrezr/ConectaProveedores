...
public static Func<ssConectaProveedores.RestRecords.JSONST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure, ST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure s) => ToStructure(s, config);
}
public static ST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure, ssConectaProveedores.RestRecords.JSONST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure FromStructure(ST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_a84a1a1cfcb637021c4d3a23fe7a72d6Structure(s, config);
}
