...
public static Func<ssConectaProveedores.RestRecords.JSONST_ab77394b00ae0f5875687584d175cf59Structure, ST_ab77394b00ae0f5875687584d175cf59Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_ab77394b00ae0f5875687584d175cf59Structure s) => ToStructure(s, config);
}
public static ST_ab77394b00ae0f5875687584d175cf59Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_ab77394b00ae0f5875687584d175cf59Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_ab77394b00ae0f5875687584d175cf59Structure, ssConectaProveedores.RestRecords.JSONST_ab77394b00ae0f5875687584d175cf59Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_ab77394b00ae0f5875687584d175cf59Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_ab77394b00ae0f5875687584d175cf59Structure FromStructure(ST_ab77394b00ae0f5875687584d175cf59Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_ab77394b00ae0f5875687584d175cf59Structure(s, config);
}
