...
public static Func<ssConectaProveedores.RestRecords.JSONRC_ceec47435de563c2690b605ecca69a94, RC_ceec47435de563c2690b605ecca69a94> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_ceec47435de563c2690b605ecca69a94 s) => ToStructure(s, config);
}
public static RC_ceec47435de563c2690b605ecca69a94 ToStructure(ssConectaProveedores.RestRecords.JSONRC_ceec47435de563c2690b605ecca69a94 obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_ceec47435de563c2690b605ecca69a94, ssConectaProveedores.RestRecords.JSONRC_ceec47435de563c2690b605ecca69a94> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_ceec47435de563c2690b605ecca69a94 s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_ceec47435de563c2690b605ecca69a94 FromStructure(RC_ceec47435de563c2690b605ecca69a94 s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_ceec47435de563c2690b605ecca69a94(s, config);
}
