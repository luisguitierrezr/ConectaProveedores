...
/// <summary>
/// [AnonymousStructure] Record (dSPcxAQ+yk+gQWexbp3Reg)
///  <code>RC_06eea14cc287e1e6b6d33a1bc97971e2</code> that represent
/// s
///  <code>OrderStatusOrderApprovalOrderMainOrderDetailOrderApprovalLevelSupplierUserSupplierRecord</cod
/// e> <p>Description: </p>
/// </summary>
// Name: OrderStatusOrderApprovalOrderMainOrderDetailOrderApprovalLevelSupplierUserSupplierRecord
public partial struct RC_06eea14cc287e1e6b6d33a1bc97971e2 : ITypedRecord<RC_06eea14cc287e1e6b6d33a1bc97971e2> {
...
public RC_06eea14cc287e1e6b6d33a1bc97971e2() {
...
public void ReadIM(RC_06eea14cc287e1e6b6d33a1bc97971e2 r) {
this = r;
}


public static bool operator == (RC_06eea14cc287e1e6b6d33a1bc97971e2 a, RC_06eea14cc287e1e6b6d33a1bc97971e2 b) {
...
if (o.GetType() != typeof (RC_06eea14cc287e1e6b6d33a1bc97971e2)) return false;
return (this == (RC_06eea14cc287e1e6b6d33a1bc97971e2)o);
}
...
public RC_06eea14cc287e1e6b6d33a1bc97971e2 Duplicate() {
RC_06eea14cc287e1e6b6d33a1bc97971e2 t;
...
} // RC_06eea14cc287e1e6b6d33a1bc97971e2
/// <summary>
/// RecordList type
///  <code>OrderStatusOrderApprovalOrderMainOrderDetailOrderApprovalLevelSupplierUserSupplierRecordList<
/// /code> that represents a record list of <code>OrderStatus, OrderApproval, OrderMain, OrderDetail,
///  OrderApprovalLevel, SupplierUser, Supplier</code>
/// </summary>
public partial class RL_4f9bb0401ba1a9d16c01e66cc4639c20 : GenericRecordList<RC_06eea14cc287e1e6b6d33a1bc97971e2>, IEnumerable, IEnumerator {

protected override RC_06eea14cc287e1e6b6d33a1bc97971e2 GetElementDefaultValue() {
return new RC_06eea14cc287e1e6b6d33a1bc97971e2();
}

public T[] ToArray<T>(Func<RC_06eea14cc287e1e6b6d33a1bc97971e2, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_4f9bb0401ba1a9d16c01e66cc4639c20 recordList, Func<RC_06eea14cc287e1e6b6d33a1bc97971e2, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_4f9bb0401ba1a9d16c01e66cc4639c20(RC_06eea14cc287e1e6b6d33a1bc97971e2[] array) {
  RL_4f9bb0401ba1a9d16c01e66cc4639c20 result = new RL_4f9bb0401ba1a9d16c01e66cc4639c20();
result.InnerFromArray(array);
    return result;
}

public static RL_4f9bb0401ba1a9d16c01e66cc4639c20 ToList<T>(T[] array, Func <T, RC_06eea14cc287e1e6b6d33a1bc97971e2> converter) {
  RL_4f9bb0401ba1a9d16c01e66cc4639c20 result = new RL_4f9bb0401ba1a9d16c01e66cc4639c20();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_4f9bb0401ba1a9d16c01e66cc4639c20 FromRestList<T>(RestList<T> restList, Func <T, RC_06eea14cc287e1e6b6d33a1bc97971e2> converter) {
  RL_4f9bb0401ba1a9d16c01e66cc4639c20 result = new RL_4f9bb0401ba1a9d16c01e66cc4639c20();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_4f9bb0401ba1a9d16c01e66cc4639c20() : base() {
}
...
protected override OSList<RC_06eea14cc287e1e6b6d33a1bc97971e2> NewList() {
return new RL_4f9bb0401ba1a9d16c01e66cc4639c20();
}


} // RL_4f9bb0401ba1a9d16c01e66cc4639c20
}
