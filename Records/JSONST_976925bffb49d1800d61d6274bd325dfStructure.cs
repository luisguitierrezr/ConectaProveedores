...
public static Func<ssConectaProveedores.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure, ST_976925bffb49d1800d61d6274bd325dfStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure s) => ToStructure(s, config);
}
public static ST_976925bffb49d1800d61d6274bd325dfStructure ToStructure(ssConectaProveedores.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_976925bffb49d1800d61d6274bd325dfStructure, ssConectaProveedores.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_976925bffb49d1800d61d6274bd325dfStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure FromStructure(ST_976925bffb49d1800d61d6274bd325dfStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure(s, config);
}
