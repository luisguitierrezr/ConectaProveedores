...
/// <summary>
/// [AnonymousStructure] Record (ei9UNzJn0UyfvnyLO6EriA)
///  <code>RC_334fa46a307bf0dfedbddfd14d3375f8</code> that represent
/// s <code>UserEntraRoleUserExtensionUser_Extended_InternalDepartmentTelcelDirectionRecord</code>
///  <p>Description: </p>
/// </summary>
// Name: UserEntraRoleUserExtensionUser_Extended_InternalDepartmentTelcelDirectionRecord
public partial struct RC_334fa46a307bf0dfedbddfd14d3375f8 : ITypedRecord<RC_334fa46a307bf0dfedbddfd14d3375f8> {
...
public RC_334fa46a307bf0dfedbddfd14d3375f8() {
...
public void ReadIM(RC_334fa46a307bf0dfedbddfd14d3375f8 r) {
this = r;
}


public static bool operator == (RC_334fa46a307bf0dfedbddfd14d3375f8 a, RC_334fa46a307bf0dfedbddfd14d3375f8 b) {
...
if (o.GetType() != typeof (RC_334fa46a307bf0dfedbddfd14d3375f8)) return false;
return (this == (RC_334fa46a307bf0dfedbddfd14d3375f8)o);
}
...
public RC_334fa46a307bf0dfedbddfd14d3375f8 Duplicate() {
RC_334fa46a307bf0dfedbddfd14d3375f8 t;
...
} // RC_334fa46a307bf0dfedbddfd14d3375f8
/// <summary>
/// RecordList type
///  <code>UserEntraRoleUserExtensionUser_Extended_InternalDepartmentTelcelDirectionRecordList</code
/// > that represents a record list of <code>User, EntraRole, UserExtension, User_Extended_Internal,
///  Department, TelcelDirection</code>
/// </summary>
public partial class RL_9c381d2572dc5728206299b483871a2e : GenericRecordList<RC_334fa46a307bf0dfedbddfd14d3375f8>, IEnumerable, IEnumerator {

protected override RC_334fa46a307bf0dfedbddfd14d3375f8 GetElementDefaultValue() {
return new RC_334fa46a307bf0dfedbddfd14d3375f8();
}

public T[] ToArray<T>(Func<RC_334fa46a307bf0dfedbddfd14d3375f8, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_9c381d2572dc5728206299b483871a2e recordList, Func<RC_334fa46a307bf0dfedbddfd14d3375f8, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_9c381d2572dc5728206299b483871a2e(RC_334fa46a307bf0dfedbddfd14d3375f8[] array) {
  RL_9c381d2572dc5728206299b483871a2e result = new RL_9c381d2572dc5728206299b483871a2e();
result.InnerFromArray(array);
    return result;
}

public static RL_9c381d2572dc5728206299b483871a2e ToList<T>(T[] array, Func <T, RC_334fa46a307bf0dfedbddfd14d3375f8> converter) {
  RL_9c381d2572dc5728206299b483871a2e result = new RL_9c381d2572dc5728206299b483871a2e();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_9c381d2572dc5728206299b483871a2e FromRestList<T>(RestList<T> restList, Func <T, RC_334fa46a307bf0dfedbddfd14d3375f8> converter) {
  RL_9c381d2572dc5728206299b483871a2e result = new RL_9c381d2572dc5728206299b483871a2e();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_9c381d2572dc5728206299b483871a2e() : base() {
}
...
protected override OSList<RC_334fa46a307bf0dfedbddfd14d3375f8> NewList() {
return new RL_9c381d2572dc5728206299b483871a2e();
}


} // RL_9c381d2572dc5728206299b483871a2e
}
