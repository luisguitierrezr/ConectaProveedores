...
public static Func<ssConectaProveedores.RestRecords.JSONST_ce06f43cf108d98e4f79c0106fcfd0acStructure, ST_ce06f43cf108d98e4f79c0106fcfd0acStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_ce06f43cf108d98e4f79c0106fcfd0acStructure s) => ToStructure(s, config);
}
public static ST_ce06f43cf108d98e4f79c0106fcfd0acStructure ToStructure(ssConectaProveedores.RestRecords.JSONST_ce06f43cf108d98e4f79c0106fcfd0acStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_ce06f43cf108d98e4f79c0106fcfd0acStructure, ssConectaProveedores.RestRecords.JSONST_ce06f43cf108d98e4f79c0106fcfd0acStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_ce06f43cf108d98e4f79c0106fcfd0acStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_ce06f43cf108d98e4f79c0106fcfd0acStructure FromStructure(ST_ce06f43cf108d98e4f79c0106fcfd0acStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_ce06f43cf108d98e4f79c0106fcfd0acStructure(s, config);
}
