...
public static Func<ssConectaProveedores.RestRecords.JSONST_5728db9d26b9364eef512c59f8517473Structure, ST_5728db9d26b9364eef512c59f8517473Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_5728db9d26b9364eef512c59f8517473Structure s) => ToStructure(s, config);
}
public static ST_5728db9d26b9364eef512c59f8517473Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_5728db9d26b9364eef512c59f8517473Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_5728db9d26b9364eef512c59f8517473Structure, ssConectaProveedores.RestRecords.JSONST_5728db9d26b9364eef512c59f8517473Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_5728db9d26b9364eef512c59f8517473Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_5728db9d26b9364eef512c59f8517473Structure FromStructure(ST_5728db9d26b9364eef512c59f8517473Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_5728db9d26b9364eef512c59f8517473Structure(s, config);
}
