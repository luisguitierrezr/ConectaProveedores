...
public class JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure : AbstractRESTStructure<ST_93db82ada2d57fd9d5e68feb0d1d4360Structure> {
...
[JsonPropertyName("RequisitionStatus_ES")]
public string AttrRequisitionStatus_ES;

[JsonProperty("RequisitionStatusClass")]
[JsonPropertyName("RequisitionStatusClass")]
...
[JsonPropertyName("ApprovalStatus_ES")]
...
public JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure() { }

public JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure (ST_93db82ada2d57fd9d5e68feb0d1d4360Structure s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure, ST_93db82ada2d57fd9d5e68feb0d1d4360Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure s) => ToStructure(s, config);
}
public static ST_93db82ada2d57fd9d5e68feb0d1d4360Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_93db82ada2d57fd9d5e68feb0d1d4360Structure, ssConectaProveedores.RestRecords.JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_93db82ada2d57fd9d5e68feb0d1d4360Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure FromStructure(ST_93db82ada2d57fd9d5e68feb0d1d4360Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_93db82ada2d57fd9d5e68feb0d1d4360Structure(s, config);
}
