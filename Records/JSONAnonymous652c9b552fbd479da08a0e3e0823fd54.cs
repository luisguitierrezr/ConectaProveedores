...
public class JSONRC_24dd7a73eff50484286a3caaeb8033d4 : AbstractRESTStructure<RC_24dd7a73eff50484286a3caaeb8033d4> {
[JsonProperty("User")]
...
public JSONRC_24dd7a73eff50484286a3caaeb8033d4() { }

public JSONRC_24dd7a73eff50484286a3caaeb8033d4 (RC_24dd7a73eff50484286a3caaeb8033d4 s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONRC_24dd7a73eff50484286a3caaeb8033d4, RC_24dd7a73eff50484286a3caaeb8033d4> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_24dd7a73eff50484286a3caaeb8033d4 s) => ToStructure(s, config);
}
public static RC_24dd7a73eff50484286a3caaeb8033d4 ToStructure(ssConectaProveedores.RestRecords.JSONRC_24dd7a73eff50484286a3caaeb8033d4 obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_24dd7a73eff50484286a3caaeb8033d4, ssConectaProveedores.RestRecords.JSONRC_24dd7a73eff50484286a3caaeb8033d4> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_24dd7a73eff50484286a3caaeb8033d4 s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_24dd7a73eff50484286a3caaeb8033d4 FromStructure(RC_24dd7a73eff50484286a3caaeb8033d4 s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_24dd7a73eff50484286a3caaeb8033d4(s, config);
}
