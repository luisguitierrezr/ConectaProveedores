...
/// <summary>
/// [ReferenceStructure] PI_HEADER4 (L9OtNWtIOk6yp5wkoFm5lQ)
///  <code>ST_b8bada9441ba6abcbadb418a924fe551Structure</code> that represents <code>PI_HEADER4</code
/// > <p>Description: </p>
/// </summary>
// Name: PI_HEADER4
public partial struct ST_b8bada9441ba6abcbadb418a924fe551Structure : ITypedRecord<ST_b8bada9441ba6abcbadb418a924fe551Structure> {
internal static readonly GlobalObjectKey IdPEDIDO = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*mxSVpLmIfUe6IahXvOBZ6A");
internal static readonly GlobalObjectKey IdPROVEEDOR = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*parNEbiFgkG4Oy+oYt5rdw");
internal static readonly GlobalObjectKey IdNUMERO_FACTURA = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*b6BUdXgBQkiyRfH0lPQagg");
internal static readonly GlobalObjectKey IdCARTA_PORTE = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*S+sSalV4Ik6yxsKOzM5WFA");
internal static readonly GlobalObjectKey IdTEXTO_CABECERA = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*19biFvsBtkukLWJ_g4Ok6w");
internal static readonly GlobalObjectKey IdUUID = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*EAqOqZTlpEeiFy0WRkq7ag");
internal static readonly GlobalObjectKey IdFECHA_CONTABILIZACION = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*wosMkMwyF0aoSDea_przhA");
internal static readonly GlobalObjectKey IdFECHA_REGISTRO = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*iIPzfC7zIUS_F73j05torg");
internal static readonly GlobalObjectKey IdVALE_MATERIAL_SM = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*ZfVoggb0SUmE4FAWYC4eHQ");
internal static readonly GlobalObjectKey IdTEXTO_CABECERA_SM = GlobalObjectKey.Parse("FvvBXIMuYECDNGg_V11vbA*K4dIMHRL_Uy97lhLjJcEnQ");
...
public ST_b8bada9441ba6abcbadb418a924fe551Structure() {
...
ssPEDIDO = r.ReadText(index++, "PI_HEADER4.PEDIDO", "");
ssPROVEEDOR = r.ReadText(index++, "PI_HEADER4.PROVEEDOR", "");
ssNUMERO_FACTURA = r.ReadText(index++, "PI_HEADER4.NUMERO_FACTURA", "");
ssCARTA_PORTE = r.ReadText(index++, "PI_HEADER4.CARTA_PORTE", "");
ssTEXTO_CABECERA = r.ReadText(index++, "PI_HEADER4.TEXTO_CABECERA", "");
ssUUID = r.ReadText(index++, "PI_HEADER4.UUID", "");
ssFECHA_CONTABILIZACION = r.ReadText(index++, "PI_HEADER4.FECHA_CONTABILIZACION", "");
ssFECHA_REGISTRO = r.ReadText(index++, "PI_HEADER4.FECHA_REGISTRO", "");
ssVALE_MATERIAL_SM = r.ReadText(index++, "PI_HEADER4.VALE_MATERIAL_SM", "");
ssTEXTO_CABECERA_SM = r.ReadText(index++, "PI_HEADER4.TEXTO_CABECERA_SM", "");
}
/// <summary>
/// Read from database
/// </summary>
...
public void ReadIM(ST_b8bada9441ba6abcbadb418a924fe551Structure r) {
this = r;
}


public static bool operator == (ST_b8bada9441ba6abcbadb418a924fe551Structure a, ST_b8bada9441ba6abcbadb418a924fe551Structure b) {
...
if (o.GetType() != typeof (ST_b8bada9441ba6abcbadb418a924fe551Structure)) return false;
return (this == (ST_b8bada9441ba6abcbadb418a924fe551Structure)o);
}
...
public ST_b8bada9441ba6abcbadb418a924fe551Structure Duplicate() {
ST_b8bada9441ba6abcbadb418a924fe551Structure t;
...
} // ST_b8bada9441ba6abcbadb418a924fe551Structure
/// <summary>
/// RecordList type <code>PI_HEADER4List</code> that represents a record list of
///  <code>PI_HEADER4</code>
/// </summary>
public partial class RL_316955d0a9c17076340fd99eb3e24e57 : GenericRecordList<ST_b8bada9441ba6abcbadb418a924fe551Structure>, IEnumerable, IEnumerator {

protected override ST_b8bada9441ba6abcbadb418a924fe551Structure GetElementDefaultValue() {
return new ST_b8bada9441ba6abcbadb418a924fe551Structure();
}

public T[] ToArray<T>(Func<ST_b8bada9441ba6abcbadb418a924fe551Structure, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_316955d0a9c17076340fd99eb3e24e57 recordList, Func<ST_b8bada9441ba6abcbadb418a924fe551Structure, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_316955d0a9c17076340fd99eb3e24e57(ST_b8bada9441ba6abcbadb418a924fe551Structure[] array) {
  RL_316955d0a9c17076340fd99eb3e24e57 result = new RL_316955d0a9c17076340fd99eb3e24e57();
result.InnerFromArray(array);
    return result;
}

public static RL_316955d0a9c17076340fd99eb3e24e57 ToList<T>(T[] array, Func <T, ST_b8bada9441ba6abcbadb418a924fe551Structure> converter) {
  RL_316955d0a9c17076340fd99eb3e24e57 result = new RL_316955d0a9c17076340fd99eb3e24e57();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_316955d0a9c17076340fd99eb3e24e57 FromRestList<T>(RestList<T> restList, Func <T, ST_b8bada9441ba6abcbadb418a924fe551Structure> converter) {
  RL_316955d0a9c17076340fd99eb3e24e57 result = new RL_316955d0a9c17076340fd99eb3e24e57();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_316955d0a9c17076340fd99eb3e24e57() : base() {
}
...
protected override OSList<ST_b8bada9441ba6abcbadb418a924fe551Structure> NewList() {
return new RL_316955d0a9c17076340fd99eb3e24e57();
}


} // RL_316955d0a9c17076340fd99eb3e24e57
}
