...
public static Func<ssConectaProveedores.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure, ST_cab398c7a09085084636430b80f5aa0dStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure s) => ToStructure(s, config);
}
public static ST_cab398c7a09085084636430b80f5aa0dStructure ToStructure(ssConectaProveedores.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_cab398c7a09085084636430b80f5aa0dStructure, ssConectaProveedores.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_cab398c7a09085084636430b80f5aa0dStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure FromStructure(ST_cab398c7a09085084636430b80f5aa0dStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure(s, config);
}
