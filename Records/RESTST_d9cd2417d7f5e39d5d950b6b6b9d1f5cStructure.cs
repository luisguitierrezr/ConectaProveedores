...
// AccountingTable
public class RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure : AbstractRESTStructure<ST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure> {
...
public ssConectaProveedores.RestRecords.RESTEN_a1a752e04a72b49d9ac24eb8f53d0c86EntityRecord AttrCostCenter;
...
public RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure() { }

public RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure (ST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure s, IBehaviorsConfiguration config) {
...
AttrInvoiceAccounting = ConvertToRestWithoutDefaults(s.ssInvoiceAccounting, new EN_b3917cbd7cc45d0b71b8ce3e028f14a3EntityRecord(), ssConectaProveedores.RestRecords.RESTEN_b3917cbd7cc45d0b71b8ce3e028f14a3EntityRecord.FromStructure, config);
AttrInvoiceAccountingServices = ConvertToRestWithoutDefaults(s.ssInvoiceAccountingServices, new EN_103cfe3736a71d97f9a0699797cf8ac2EntityRecord(), ssConectaProveedores.RestRecords.RESTEN_103cfe3736a71d97f9a0699797cf8ac2EntityRecord.FromStructure, config);
AttrCostCenter = ConvertToRestWithoutDefaults(s.ssCostCenter, new EN_a1a752e04a72b49d9ac24eb8f53d0c86EntityRecord(), ssConectaProveedores.RestRecords.RESTEN_a1a752e04a72b49d9ac24eb8f53d0c86EntityRecord.FromStructure, config);
...
AttrInvoiceAccounting = ssConectaProveedores.RestRecords.RESTEN_b3917cbd7cc45d0b71b8ce3e028f14a3EntityRecord.FromStructure(s.ssInvoiceAccounting, config);
AttrInvoiceAccountingServices = ssConectaProveedores.RestRecords.RESTEN_103cfe3736a71d97f9a0699797cf8ac2EntityRecord.FromStructure(s.ssInvoiceAccountingServices, config);
AttrCostCenter = ssConectaProveedores.RestRecords.RESTEN_a1a752e04a72b49d9ac24eb8f53d0c86EntityRecord.FromStructure(s.ssCostCenter, config);
...
public static ST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure ToStructure(ssConectaProveedores.RestRecords.RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure obj) { 
  ...
  s.ssInvoiceAccounting = ssConectaProveedores.RestRecords.RESTEN_b3917cbd7cc45d0b71b8ce3e028f14a3EntityRecord.ToStructure(obj.AttrInvoiceAccounting);
  s.ssInvoiceAccountingServices = ssConectaProveedores.RestRecords.RESTEN_103cfe3736a71d97f9a0699797cf8ac2EntityRecord.ToStructure(obj.AttrInvoiceAccountingServices);
  s.ssCostCenter = ssConectaProveedores.RestRecords.RESTEN_a1a752e04a72b49d9ac24eb8f53d0c86EntityRecord.ToStructure(obj.AttrCostCenter);
...
public static Func<ST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure, ssConectaProveedores.RestRecords.RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure FromStructure(ST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.RESTST_d9cd2417d7f5e39d5d950b6b6b9d1f5cStructure(s, config);
}
