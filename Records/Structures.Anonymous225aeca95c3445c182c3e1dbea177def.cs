...
/// <summary>
/// [AnonymousStructure] Record (qexaIjRcwUWCw+Hb6hd97w)
///  <code>RC_7b8200225d1e3acafed4d42f9fce9055</code> that represent
/// s <code>UserRoleConceptApplicationRoleEntraRoleUser_Extended_InternalRecord</code> <p>Description:
///  </p>
/// </summary>
// Name: UserRoleConceptApplicationRoleEntraRoleUser_Extended_InternalRecord
public partial struct RC_7b8200225d1e3acafed4d42f9fce9055 : ITypedRecord<RC_7b8200225d1e3acafed4d42f9fce9055> {
...
public RC_7b8200225d1e3acafed4d42f9fce9055() {
...
public void ReadIM(RC_7b8200225d1e3acafed4d42f9fce9055 r) {
this = r;
}


public static bool operator == (RC_7b8200225d1e3acafed4d42f9fce9055 a, RC_7b8200225d1e3acafed4d42f9fce9055 b) {
...
if (o.GetType() != typeof (RC_7b8200225d1e3acafed4d42f9fce9055)) return false;
return (this == (RC_7b8200225d1e3acafed4d42f9fce9055)o);
}
...
public RC_7b8200225d1e3acafed4d42f9fce9055 Duplicate() {
RC_7b8200225d1e3acafed4d42f9fce9055 t;
...
} // RC_7b8200225d1e3acafed4d42f9fce9055
/// <summary>
/// RecordList type
///  <code>UserRoleConceptApplicationRoleEntraRoleUser_Extended_InternalRecordList</code> tha
/// t represents a record list of <code>User, RoleConcept, ApplicationRole, EntraRole,
///  User_Extended_Internal</code>
/// </summary>
public partial class RL_137ca0bd922b82f91f39dd017e999a51 : GenericRecordList<RC_7b8200225d1e3acafed4d42f9fce9055>, IEnumerable, IEnumerator {

protected override RC_7b8200225d1e3acafed4d42f9fce9055 GetElementDefaultValue() {
return new RC_7b8200225d1e3acafed4d42f9fce9055();
}

public T[] ToArray<T>(Func<RC_7b8200225d1e3acafed4d42f9fce9055, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_137ca0bd922b82f91f39dd017e999a51 recordList, Func<RC_7b8200225d1e3acafed4d42f9fce9055, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_137ca0bd922b82f91f39dd017e999a51(RC_7b8200225d1e3acafed4d42f9fce9055[] array) {
  RL_137ca0bd922b82f91f39dd017e999a51 result = new RL_137ca0bd922b82f91f39dd017e999a51();
result.InnerFromArray(array);
    return result;
}

public static RL_137ca0bd922b82f91f39dd017e999a51 ToList<T>(T[] array, Func <T, RC_7b8200225d1e3acafed4d42f9fce9055> converter) {
  RL_137ca0bd922b82f91f39dd017e999a51 result = new RL_137ca0bd922b82f91f39dd017e999a51();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_137ca0bd922b82f91f39dd017e999a51 FromRestList<T>(RestList<T> restList, Func <T, RC_7b8200225d1e3acafed4d42f9fce9055> converter) {
  RL_137ca0bd922b82f91f39dd017e999a51 result = new RL_137ca0bd922b82f91f39dd017e999a51();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_137ca0bd922b82f91f39dd017e999a51() : base() {
}
...
protected override OSList<RC_7b8200225d1e3acafed4d42f9fce9055> NewList() {
return new RL_137ca0bd922b82f91f39dd017e999a51();
}


} // RL_137ca0bd922b82f91f39dd017e999a51
}
