...
public static Func<ssConectaProveedores.RestRecords.JSONRC_3ae851ff8b62d3b4ff8041de781ce47d, RC_3ae851ff8b62d3b4ff8041de781ce47d> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_3ae851ff8b62d3b4ff8041de781ce47d s) => ToStructure(s, config);
}
public static RC_3ae851ff8b62d3b4ff8041de781ce47d ToStructure(ssConectaProveedores.RestRecords.JSONRC_3ae851ff8b62d3b4ff8041de781ce47d obj, IBehaviorsConfiguration config) { 
...
public static Func<RC_3ae851ff8b62d3b4ff8041de781ce47d, ssConectaProveedores.RestRecords.JSONRC_3ae851ff8b62d3b4ff8041de781ce47d> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_3ae851ff8b62d3b4ff8041de781ce47d s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_3ae851ff8b62d3b4ff8041de781ce47d FromStructure(RC_3ae851ff8b62d3b4ff8041de781ce47d s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_3ae851ff8b62d3b4ff8041de781ce47d(s, config);
}
