...
public static Func<ssConectaProveedores.RestRecords.JSONST_af46d22a4ab690d6a003acf927bb2771Structure, ST_af46d22a4ab690d6a003acf927bb2771Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONST_af46d22a4ab690d6a003acf927bb2771Structure s) => ToStructure(s, config);
}
public static ST_af46d22a4ab690d6a003acf927bb2771Structure ToStructure(ssConectaProveedores.RestRecords.JSONST_af46d22a4ab690d6a003acf927bb2771Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_af46d22a4ab690d6a003acf927bb2771Structure, ssConectaProveedores.RestRecords.JSONST_af46d22a4ab690d6a003acf927bb2771Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_af46d22a4ab690d6a003acf927bb2771Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONST_af46d22a4ab690d6a003acf927bb2771Structure FromStructure(ST_af46d22a4ab690d6a003acf927bb2771Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONST_af46d22a4ab690d6a003acf927bb2771Structure(s, config);
}
