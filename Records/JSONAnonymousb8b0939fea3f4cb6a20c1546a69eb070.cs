...
// InvoiceInvoiceApprovalRequisitionInvoiceApprovalLevelSupplierRecord
public class JSONRC_eac76b624d2264108f6fbeb95d9d43ba : AbstractRESTStructure<RC_eac76b624d2264108f6fbeb95d9d43ba> {
...
public JSONRC_eac76b624d2264108f6fbeb95d9d43ba() { }

public JSONRC_eac76b624d2264108f6fbeb95d9d43ba (RC_eac76b624d2264108f6fbeb95d9d43ba s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.RestRecords.JSONRC_eac76b624d2264108f6fbeb95d9d43ba, RC_eac76b624d2264108f6fbeb95d9d43ba> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.RestRecords.JSONRC_eac76b624d2264108f6fbeb95d9d43ba s) => ToStructure(s, config);
}
public static RC_eac76b624d2264108f6fbeb95d9d43ba ToStructure(ssConectaProveedores.RestRecords.JSONRC_eac76b624d2264108f6fbeb95d9d43ba obj, IBehaviorsConfiguration config) { 
  RC_eac76b624d2264108f6fbeb95d9d43ba s = new RC_eac76b624d2264108f6fbeb95d9d43ba();
  if(obj != null) {
...
public static Func<RC_eac76b624d2264108f6fbeb95d9d43ba, ssConectaProveedores.RestRecords.JSONRC_eac76b624d2264108f6fbeb95d9d43ba> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (RC_eac76b624d2264108f6fbeb95d9d43ba s) => FromStructure(s, config);
}
public static ssConectaProveedores.RestRecords.JSONRC_eac76b624d2264108f6fbeb95d9d43ba FromStructure(RC_eac76b624d2264108f6fbeb95d9d43ba s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.RestRecords.JSONRC_eac76b624d2264108f6fbeb95d9d43ba(s, config);
}
