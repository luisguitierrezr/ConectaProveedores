...
public class RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public decimal? outParamImportetotaldefacturasmonedaextranjera2;
    ...
    public static RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs FromOutputs(IBehaviorsConfiguration conf, ST_382afa1d8361f400b6ea03403d75e294Structure outParamList, decimal outParamTotalenmonedanacional, decimal outParamImportetotaldefacturasmonedaextranjera, decimal outParamTotalenmonedanacional2, decimal outParamImportetotaldefacturasmonedaextranjera2) {RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs result = new RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs();
...
// Write optimized result.outParamList.AttrT_DAT_PROV_Out
result.outParamList.AttrT_DAT_PROV_Out = new RL_467e1836e09ca6c5339502ff533527b0().ToRestList<ssConectaProveedores.RestRecords.RESTST_4639a265770186863b3ecaeafd29fb96Structure>(ssConectaProveedores.RestRecords.RESTST_4639a265770186863b3ecaeafd29fb96Structure.FromStructureDelegate(conf));
...
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrWRBT2
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrWRBT2 = (decimal?) 0.0M;
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrWRBT3
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrWRBT3 = (decimal?) 0.0M;
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrUMSKZ
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrUMSKZ = "";
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrBLART
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrBLART = "";
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrZLSCH
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrZLSCH = "";
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrKURSF
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrKURSF = (decimal?) 0.0M;
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrUSNAM
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrUSNAM = "";
// Write optimized tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrUSRID_LONG
tmpoutParamList_ssT_FACT_PEN_PAG_OutElement.AttrUSRID_LONG = "";
...
return result;
    ...
    public static ConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Model ToModel(RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs variables) {ConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Model result = new ConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Model();
...
return result;
    ...
    public static RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs result = new RESTConectaProveedores_c_Proveedor_ReportCurrentAccount_DataActionGetSapData_Outputs();
