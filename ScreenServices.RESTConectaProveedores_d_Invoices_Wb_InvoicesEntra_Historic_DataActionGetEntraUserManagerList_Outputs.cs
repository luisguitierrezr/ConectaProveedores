...
public class RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs : ScreenServicesApiController.Payload.IDataPayload {

    [JsonProperty("UserList")]
public RestList<ssConectaProveedores.RestRecords.RESTST_34625f5643caa3d12448dcec7dd4c7d3Structure> outParamUserList;


    public static RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_4af3045b114dbc57d1481fed5aceb93a outParamUserList) {RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs result = new RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs();
...
tmpoutParamUserListElement.AttrIsSubstitute = (bool?) outParamUserList.CurrentRec.ssIsSubstitute;
...
return result;
    ...
    public static ConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Model ToModel(RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs variables) {ConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Model result = new ConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Model();
...
return result;
    ...
    public static RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs result = new RESTConectaProveedores_d_Invoices_Wb_InvoicesEntra_Historic_DataActionGetEntraUserManagerList_Outputs();
