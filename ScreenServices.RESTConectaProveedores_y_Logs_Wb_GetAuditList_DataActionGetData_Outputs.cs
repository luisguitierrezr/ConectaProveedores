...
public class RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public long? outParamCount;
    ...
    public static RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_d271bd6e591b75c186c4ae8d222dee55 outParamAuditList, long outParamCount) {RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs result = new RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs();
...
tmpoutParamAuditListElement.AttrIdentifier = (long?) outParamAuditList.CurrentRec.ssIdentifier;
...
// Write optimized tmpoutParamAuditListElement.AttrIsError
tmpoutParamAuditListElement.AttrIsError = (bool?) false;
...
return result;
    ...
    public static ConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Model ToModel(RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs variables) {ConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Model result = new ConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Model();
...
return result;
    ...
    public static RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs result = new RESTConectaProveedores_y_Logs_Wb_GetAuditList_DataActionGetData_Outputs();
