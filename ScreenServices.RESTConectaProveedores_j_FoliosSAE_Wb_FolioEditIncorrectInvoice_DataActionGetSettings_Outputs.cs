...
public class RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamo_IsActiveDEV_HU13046;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs FromOutputs(IBehaviorsConfiguration conf, bool outParamIsActiveAmountValidation, bool outParamIsForceForeigner, decimal outParamo_ForeignCurrencyMargin, decimal outParamo_NationalCurrencyMargin, bool outParamo_IsActiveDEV_HU13008_Complement, bool outParamo_IsActiveDEV_HU13046) {RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Model ToModel(RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs variables) {ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Model result = new ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_FolioEditIncorrectInvoice_DataActionGetSettings_Outputs();
