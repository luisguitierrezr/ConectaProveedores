...
// PI_HEADER4
public class JSONST_b8bada9441ba6abcbadb418a924fe551Structure : AbstractRESTStructure<ST_b8bada9441ba6abcbadb418a924fe551Structure> {
[JsonProperty("PEDIDO")]
...
public JSONST_b8bada9441ba6abcbadb418a924fe551Structure() { }

public JSONST_b8bada9441ba6abcbadb418a924fe551Structure (ST_b8bada9441ba6abcbadb418a924fe551Structure s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure, ST_b8bada9441ba6abcbadb418a924fe551Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure s) => ToStructure(s, config);
}
public static ST_b8bada9441ba6abcbadb418a924fe551Structure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure obj, IBehaviorsConfiguration config) { 
  ST_b8bada9441ba6abcbadb418a924fe551Structure s = new ST_b8bada9441ba6abcbadb418a924fe551Structure();
  if(obj != null) {
...
public static Func<ST_b8bada9441ba6abcbadb418a924fe551Structure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_b8bada9441ba6abcbadb418a924fe551Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure FromStructure(ST_b8bada9441ba6abcbadb418a924fe551Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_b8bada9441ba6abcbadb418a924fe551Structure(s, config);
}
