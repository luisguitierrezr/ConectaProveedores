...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord, EN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord s) => ToStructure(s, config);
}
public static EN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord obj, IBehaviorsConfiguration config) { 
...
public static Func<EN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord, ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord FromStructure(EN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_9d6ffd765945bcc9a7f807d4f431bd00EntityRecord(s, config);
}
