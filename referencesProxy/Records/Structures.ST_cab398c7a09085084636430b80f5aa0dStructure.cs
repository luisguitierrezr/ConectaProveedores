...
/// <summary>
/// [ReferenceStructure] PI_HEADER_RM (G6m8ZmAGCUmN0+zaASE0tg)
///  <code>ST_cab398c7a09085084636430b80f5aa0dStructure</code> that represents <code>PI_HEADER_RM</code
/// > <p>Description: PI_HEADER_RM</p>
/// </summary>
// Name: PI_HEADER_RM
public partial struct ST_cab398c7a09085084636430b80f5aa0dStructure : ITypedRecord<ST_cab398c7a09085084636430b80f5aa0dStructure> {
internal static readonly GlobalObjectKey IdPEDIDO = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*0uNzjcNp7UuUL+A1ZkYx2w");
internal static readonly GlobalObjectKey IdPROVEEDOR = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*tSpdM3nWIUmFhZWENnvuUw");
internal static readonly GlobalObjectKey IdNUMERO_FACTURA = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*saPGMi21l0OenIAJqAbUow");
internal static readonly GlobalObjectKey IdCARTA_PORTE = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*AwVOwNa4p0SD2qk4+s+3HA");
internal static readonly GlobalObjectKey IdTEXTO_CABECERA = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*4Aeis+eGdkq8gQ73vBaQeA");
internal static readonly GlobalObjectKey IdUUID = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*h323kpyQLkqtAPT86Wf8DQ");
internal static readonly GlobalObjectKey IdFECHA_CONTABILIZACION = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*Y_ROVY3NGUmpPxZ0Uo7dVA");
internal static readonly GlobalObjectKey IdFECHA_REGISTRO = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*p_P5lygNwkKjIZ1up6vtbg");
internal static readonly GlobalObjectKey IdVALE_MATERIAL_SM = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*_t_VvmSZL0mwpnlF+koBwg");
internal static readonly GlobalObjectKey IdTEXTO_CABECERA_SM = GlobalObjectKey.Parse("W2g2vJ1htkyBZ_pD4Lqsqw*yYjTBWGFxUqZXy1S5XpEMg");
...
public ST_cab398c7a09085084636430b80f5aa0dStructure() {
...
ssPEDIDO = r.ReadText(index++, "PI_HEADER_RM.PEDIDO", "");
ssPROVEEDOR = r.ReadText(index++, "PI_HEADER_RM.PROVEEDOR", "");
ssNUMERO_FACTURA = r.ReadText(index++, "PI_HEADER_RM.NUMERO_FACTURA", "");
ssCARTA_PORTE = r.ReadText(index++, "PI_HEADER_RM.CARTA_PORTE", "");
ssTEXTO_CABECERA = r.ReadText(index++, "PI_HEADER_RM.TEXTO_CABECERA", "");
ssUUID = r.ReadText(index++, "PI_HEADER_RM.UUID", "");
ssFECHA_CONTABILIZACION = r.ReadText(index++, "PI_HEADER_RM.FECHA_CONTABILIZACION", "");
ssFECHA_REGISTRO = r.ReadText(index++, "PI_HEADER_RM.FECHA_REGISTRO", "");
ssVALE_MATERIAL_SM = r.ReadText(index++, "PI_HEADER_RM.VALE_MATERIAL_SM", "");
ssTEXTO_CABECERA_SM = r.ReadText(index++, "PI_HEADER_RM.TEXTO_CABECERA_SM", "");
}
/// <summary>
/// Read from database
/// </summary>
...
public void ReadIM(ST_cab398c7a09085084636430b80f5aa0dStructure r) {
this = r;
}


public static bool operator == (ST_cab398c7a09085084636430b80f5aa0dStructure a, ST_cab398c7a09085084636430b80f5aa0dStructure b) {
...
if (o.GetType() != typeof (ST_cab398c7a09085084636430b80f5aa0dStructure)) return false;
return (this == (ST_cab398c7a09085084636430b80f5aa0dStructure)o);
}
...
public ST_cab398c7a09085084636430b80f5aa0dStructure Duplicate() {
ST_cab398c7a09085084636430b80f5aa0dStructure t;
...
} // ST_cab398c7a09085084636430b80f5aa0dStructure
/// <summary>
/// RecordList type <code>PI_HEADER_RMList</code> that represents a record list of
///  <code>PI_HEADER_RM</code>
/// </summary>
public partial class RL_8faf528c3a36d5ecbc47b336e83e13ee : GenericRecordList<ST_cab398c7a09085084636430b80f5aa0dStructure>, IEnumerable, IEnumerator {

protected override ST_cab398c7a09085084636430b80f5aa0dStructure GetElementDefaultValue() {
return new ST_cab398c7a09085084636430b80f5aa0dStructure();
}

public T[] ToArray<T>(Func<ST_cab398c7a09085084636430b80f5aa0dStructure, T> converter) {
  return ToArray(this, converter);
}

public static T[] ToArray<T>(RL_8faf528c3a36d5ecbc47b336e83e13ee recordList, Func<ST_cab398c7a09085084636430b80f5aa0dStructure, T> converter) {
  return InnerToArray(recordList, converter);
}
public static implicit operator RL_8faf528c3a36d5ecbc47b336e83e13ee(ST_cab398c7a09085084636430b80f5aa0dStructure[] array) {
  RL_8faf528c3a36d5ecbc47b336e83e13ee result = new RL_8faf528c3a36d5ecbc47b336e83e13ee();
result.InnerFromArray(array);
    return result;
}

public static RL_8faf528c3a36d5ecbc47b336e83e13ee ToList<T>(T[] array, Func <T, ST_cab398c7a09085084636430b80f5aa0dStructure> converter) {
  RL_8faf528c3a36d5ecbc47b336e83e13ee result = new RL_8faf528c3a36d5ecbc47b336e83e13ee();
  result.InnerFromArray(array, converter);
  return result;
}

public static RL_8faf528c3a36d5ecbc47b336e83e13ee FromRestList<T>(RestList<T> restList, Func <T, ST_cab398c7a09085084636430b80f5aa0dStructure> converter) {
  RL_8faf528c3a36d5ecbc47b336e83e13ee result = new RL_8faf528c3a36d5ecbc47b336e83e13ee();
  result.InnerFromRestList(restList, converter);
  return result;
}
public RL_8faf528c3a36d5ecbc47b336e83e13ee() : base() {
}
...
protected override OSList<ST_cab398c7a09085084636430b80f5aa0dStructure> NewList() {
return new RL_8faf528c3a36d5ecbc47b336e83e13ee();
}


} // RL_8faf528c3a36d5ecbc47b336e83e13ee
}
