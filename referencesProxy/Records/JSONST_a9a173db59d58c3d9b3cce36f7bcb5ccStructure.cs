...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure, ST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure s) => ToStructure(s, config);
}
public static ST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure FromStructure(ST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_a9a173db59d58c3d9b3cce36f7bcb5ccStructure(s, config);
}
