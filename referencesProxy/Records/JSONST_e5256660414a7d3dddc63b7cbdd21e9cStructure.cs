...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_e5256660414a7d3dddc63b7cbdd21e9cStructure, ST_e5256660414a7d3dddc63b7cbdd21e9cStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_e5256660414a7d3dddc63b7cbdd21e9cStructure s) => ToStructure(s, config);
}
public static ST_e5256660414a7d3dddc63b7cbdd21e9cStructure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_e5256660414a7d3dddc63b7cbdd21e9cStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_e5256660414a7d3dddc63b7cbdd21e9cStructure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_e5256660414a7d3dddc63b7cbdd21e9cStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_e5256660414a7d3dddc63b7cbdd21e9cStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_e5256660414a7d3dddc63b7cbdd21e9cStructure FromStructure(ST_e5256660414a7d3dddc63b7cbdd21e9cStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_e5256660414a7d3dddc63b7cbdd21e9cStructure(s, config);
}
