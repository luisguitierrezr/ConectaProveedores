...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure, ST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure s) => ToStructure(s, config);
}
public static ST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure FromStructure(ST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_f6aefb5d1f2e48348e16fc4d9e0699f9Structure(s, config);
}
