...
// PI_ITEM
public class JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure : AbstractRESTStructure<ST_d34c4878f870709fdbf7a3e48e70a4edStructure> {
...
public JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure() { }

public JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure (ST_d34c4878f870709fdbf7a3e48e70a4edStructure s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure, ST_d34c4878f870709fdbf7a3e48e70a4edStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure s) => ToStructure(s, config);
}
public static ST_d34c4878f870709fdbf7a3e48e70a4edStructure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_d34c4878f870709fdbf7a3e48e70a4edStructure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_d34c4878f870709fdbf7a3e48e70a4edStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure FromStructure(ST_d34c4878f870709fdbf7a3e48e70a4edStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_d34c4878f870709fdbf7a3e48e70a4edStructure(s, config);
}
