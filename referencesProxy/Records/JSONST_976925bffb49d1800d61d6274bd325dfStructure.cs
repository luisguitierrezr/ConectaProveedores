...
// PI_HEADER5
public class JSONST_976925bffb49d1800d61d6274bd325dfStructure : AbstractRESTStructure<ST_976925bffb49d1800d61d6274bd325dfStructure> {
[JsonProperty("PEDIDO")]
...
public JSONST_976925bffb49d1800d61d6274bd325dfStructure() { }

public JSONST_976925bffb49d1800d61d6274bd325dfStructure (ST_976925bffb49d1800d61d6274bd325dfStructure s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure, ST_976925bffb49d1800d61d6274bd325dfStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure s) => ToStructure(s, config);
}
public static ST_976925bffb49d1800d61d6274bd325dfStructure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure obj, IBehaviorsConfiguration config) { 
  ST_976925bffb49d1800d61d6274bd325dfStructure s = new ST_976925bffb49d1800d61d6274bd325dfStructure();
  if(obj != null) {
...
public static Func<ST_976925bffb49d1800d61d6274bd325dfStructure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_976925bffb49d1800d61d6274bd325dfStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure FromStructure(ST_976925bffb49d1800d61d6274bd325dfStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_976925bffb49d1800d61d6274bd325dfStructure(s, config);
}
