...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord, EN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord s) => ToStructure(s, config);
}
public static EN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord obj, IBehaviorsConfiguration config) { 
...
public static Func<EN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord, ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (EN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord FromStructure(EN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONEN_77ae46bb58c1a7be39d9a1b304bdae01EntityRecord(s, config);
}
