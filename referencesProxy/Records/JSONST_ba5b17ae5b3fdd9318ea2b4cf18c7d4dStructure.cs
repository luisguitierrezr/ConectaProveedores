...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure, ST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure s) => ToStructure(s, config);
}
public static ST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure FromStructure(ST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_ba5b17ae5b3fdd9318ea2b4cf18c7d4dStructure(s, config);
}
