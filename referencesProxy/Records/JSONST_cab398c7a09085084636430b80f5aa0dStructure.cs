...
// PI_HEADER_RM
public class JSONST_cab398c7a09085084636430b80f5aa0dStructure : AbstractRESTStructure<ST_cab398c7a09085084636430b80f5aa0dStructure> {
[JsonProperty("PEDIDO")]
...
public JSONST_cab398c7a09085084636430b80f5aa0dStructure() { }

public JSONST_cab398c7a09085084636430b80f5aa0dStructure (ST_cab398c7a09085084636430b80f5aa0dStructure s, IBehaviorsConfiguration config) {
...
public static Func<ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure, ST_cab398c7a09085084636430b80f5aa0dStructure> ToStructureDelegate(IBehaviorsConfiguration config) { 
  return (ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure s) => ToStructure(s, config);
}
public static ST_cab398c7a09085084636430b80f5aa0dStructure ToStructure(ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure obj, IBehaviorsConfiguration config) { 
...
public static Func<ST_cab398c7a09085084636430b80f5aa0dStructure, ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure> FromStructureDelegate(IBehaviorsConfiguration config) { 
  return (ST_cab398c7a09085084636430b80f5aa0dStructure s) => FromStructure(s, config);
}
public static ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure FromStructure(ST_cab398c7a09085084636430b80f5aa0dStructure s, IBehaviorsConfiguration config) { 
  return new ssConectaProveedores.ReferencesProxy.RestRecords.JSONST_cab398c7a09085084636430b80f5aa0dStructure(s, config);
}
