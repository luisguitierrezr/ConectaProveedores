...
public class RESTConectaProveedores_z_TableDownloadsPDF_TableDownloadInvoiceScreenPDF_ActionString_Split_Outputs : ScreenServicesApiController.Payload.IDataPayload {

    [JsonProperty("List")]
public RestList<ssConectaProveedores.RestRecords.RESTRCTextRecord> outParamList;


    public static RESTConectaProveedores_z_TableDownloadsPDF_TableDownloadInvoiceScreenPDF_ActionString_Split_Outputs FromOutputs(IBehaviorsConfiguration conf, RLTextRecordList outParamList) {RESTConectaProveedores_z_TableDownloadsPDF_TableDownloadInvoiceScreenPDF_ActionString_Split_Outputs result = new RESTConectaProveedores_z_TableDownloadsPDF_TableDownloadInvoiceScreenPDF_ActionString_Split_Outputs();
