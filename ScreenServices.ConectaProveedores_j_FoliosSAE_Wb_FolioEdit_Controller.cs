...
[Route("screenservices/ConectaProveedores/j_FoliosSAE/Wb_FolioEdit")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController(ConectaProveedores_j_FoliosSAE_Wb_SupportSAEUploadEdit_Controller.ProxyInstance, childControllers);
...
SafeAddChildController(ConectaProveedores_Controller.ProxyInstance, childControllers);
    ...
    static ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller() {
        Permissions = new CheckPermissionsIndex();
        Permissions.AddPermissionPropagationPath(/* Any Usage */CheckPermissionsIndex.ANY_USAGE_KEY, new String[] { CheckPermissionsIndex.ANY_USAGE_KEY, 
/*j_FoliosSAE.Wb_FolioEdit.ValidateDatesInvoiceQttPEP*/"6dONWMH_kUW9Ti9X5sMIKA*ObXJLLaAzEaUWhvsZY58Fw", 
/*j_FoliosSAE.Wb_FolioEdit.ValidateNewFiles*/"6dONWMH_kUW9Ti9X5sMIKA*ZGAYPsplwkSJYicvZeI3Dg", 
...
/*j_FoliosSAE.Wb_FolioEdit.ValidateFiles*/"6dONWMH_kUW9Ti9X5sMIKA*wXLeaVuX7ECmmkZKS5voOA", 
...
/*j_FoliosSAE.Wb_FolioEdit.ValidateFinal*/"6dONWMH_kUW9Ti9X5sMIKA*zotJuNEiHEuZntutKugB6w", 
/*j_FoliosSAE.Wb_FolioEdit.CalcInvoiceAmount*/"6dONWMH_kUW9Ti9X5sMIKA*1A2nvLUmh0ap3nZh1i6xuQ", 
/*j_FoliosSAE.Wb_FolioEdit.InitialValidate*/"6dONWMH_kUW9Ti9X5sMIKA*t9aTy__7XkKplzphsZQFAg", 
...
/*System_.ListClear*/"uXCIR2Atc0+es3zYuZSnNw*veU0xTJwTE2X4au_He4_vw"});
    ...
    public ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetFolioCommentsByFolioId",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetFolioCommentsByFolioId(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "s3ajRFHrpTi7XECBOWhi2g", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel model = null;
...
try {model = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.datasetGetFolioCommentsByFolioId(requestContext,datasetGetFolioCommentsByFolioId_maxRecords,datasetGetFolioCommentsByFolioId_startIndex,IterationMultiplicity.Multiple,model.inParamFolioId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetApprovalList",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.datasetGetApprovalList(requestContext,datasetGetApprovalList_maxRecords,datasetGetApprovalList_startIndex,IterationMultiplicity.Multiple,model.ScreenDataSetGetOrderDetail.List.CurrentRec.ssENOrderMain.ssTelcelDirectionId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetFolioById",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.datasetGetFolioById(requestContext,datasetGetFolioById_maxRecords,datasetGetFolioById_startIndex,IterationMultiplicity.Multiple,model.inParamFolioId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetFolioItemsByFolioId",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.datasetGetFolioItemsByFolioId(requestContext,datasetGetFolioItemsByFolioId_maxRecords,datasetGetFolioItemsByFolioId_startIndex,IterationMultiplicity.Multiple,model.inParamFolioId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetFolioObservationsByFolioId",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.datasetGetFolioObservationsByFolioId(requestContext,datasetGetFolioObservationsByFolioId_maxRecords,datasetGetFolioObservationsByFolioId_startIndex,IterationMultiplicity.Multiple,model.inParamFolioId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetOrderDetail",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ScreenModel.datasetGetOrderDetail(requestContext,datasetGetOrderDetail_maxRecords,datasetGetOrderDetail_startIndex,IterationMultiplicity.Multiple,model.inParami_OrderId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetOrderMainItems",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetOrderMainItems_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamList);
return output;
...
[RESTScreenServicesActionProperties(Name="GetSummary",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSummary_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamo_SummaryRec);
return output;
...
[RESTScreenServicesActionProperties(Name="GetSettings",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetSettings_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamIsActiveAmountValidation, outParamIsForceForeigner, outParamo_ForeignCurrencyMargin, outParamo_NationalCurrencyMargin, outParamo_IsActiveDEV_HU13008_Complement, outParamo_IsActiveDEV_HU13046);
return output;
...
[RESTScreenServicesActionProperties(Name="GetFolioFiles",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_DataActionGetFolioFiles_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamInvoiceMainFiles);
return output;
...
[RESTScreenServicesActionProperties(Name="FolioUpdate",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionFolioUpdate(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "Ij3zNtckafeTs_J8EUnUiQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ActionFolioUpdate_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ActionFolioUpdate_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ActionFolioUpdate_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_FolioName, res.outParamErrorMsg);
return output;
...
[RESTScreenServicesActionProperties(Name="Call_ZMXMIMMF_VISUALIZAR_SAL_ANT",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "mEDBUNKMySFTPNFDy4Vl+Q", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ServiceAPICall_ZMXMIMMF_VISUALIZAR_SAL_ANT_Outputs.FromOutputs(this.BehaviorsConfiguration, res_outParamResponse);
return output;
...
[RESTScreenServicesActionProperties(Name="GetAllAvailableQuantity",Screen="Wb_FolioEdit",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetAllAvailableQuantity(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "P4fB3c4JvQ+qBOZ0I70ViA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ActionGetAllAvailableQuantity_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ActionGetAllAvailableQuantity_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_Wb_FolioEdit_ActionGetAllAvailableQuantity_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamLocalSelectedLines);
return output;
