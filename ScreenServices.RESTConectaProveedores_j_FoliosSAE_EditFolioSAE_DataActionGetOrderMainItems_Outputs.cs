...
public class RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs : ScreenServicesApiController.Payload.IDataPayload {

    [JsonProperty("List")]
public RestList<ssConectaProveedores.RestRecords.RESTST_1bddfac19e9b0cef65924aa7568fd106Structure> outParamList;


    public static RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_4e1292c876d12cf32f3c04367498157e outParamList) {RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs result = new RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Model ToModel(RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs variables) {ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Model result = new ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs result = new RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetOrderMainItems_Outputs();
