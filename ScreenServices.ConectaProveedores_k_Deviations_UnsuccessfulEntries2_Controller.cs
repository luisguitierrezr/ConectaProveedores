...
[Route("screenservices/ConectaProveedores/k_Deviations/UnsuccessfulEntries2")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController(ConectaProveedores_Controller.ProxyInstance, childControllers);
                ...
                Permissions.AddAsyncCheckPermissions(new ScreenName("k_Deviations.UnsuccessfulEntries2"), ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller.CheckPermissionsAsync);
            }
        }
    }
...
throw new Ex_NotConectaProveedoresRoleException( "ConectaProveedores role required");
    ...
    static ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller() {
        Permissions = new CheckPermissionsIndex();
        Permissions.AddPermissionPropagationPath(/* Any Usage */CheckPermissionsIndex.ANY_USAGE_KEY, new String[] { CheckPermissionsIndex.ANY_USAGE_KEY, 
/*AuditCreateWrapper*/"6dONWMH_kUW9Ti9X5sMIKA*S0jtKfG3KkOVGGsZs_98+Q", 
/*k_Deviations.UnsuccessfulEntries2.RefreshList*/"6dONWMH_kUW9Ti9X5sMIKA*XyKkQZWyv0y56Ago13dO1g", 
/*ColumnTogglerPassColumn*/"6dONWMH_kUW9Ti9X5sMIKA*ATNHaNXDeE2mUnzjhMTL1w", 
/*k_Deviations.UnsuccessfulEntries2.ResetFilters*/"6dONWMH_kUW9Ti9X5sMIKA*khcgd+FudkCyyzssXxHrJQ", 
...
/*a_Common.OnException*/"6dONWMH_kUW9Ti9X5sMIKA*B4kRGvrnOEmQonA8ir4Pyg.#FlowExceptionHandler"});
    ...
    public ConectaProveedores_k_Deviations_UnsuccessfulEntries2_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetData",Screen="UnsuccessfulEntries2",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetData(CancellationToken cancellationToken) {
    using Stream input = HttpContext.Request.Body;
    return await EndpointAsync(input, "Dp1YfIykoT+z3Rs53RdfTA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ScreenModel model = null;
...
try {model = RESTConectaProveedores_k_Deviations_UnsuccessfulEntries2_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ScreenModel.datasetGetData(requestContext,datasetGetData_maxRecords,datasetGetData_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetSuppliers",Screen="UnsuccessfulEntries2",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ScreenModel.datasetGetSuppliers(requestContext,datasetGetSuppliers_maxRecords,datasetGetSuppliers_startIndex,IterationMultiplicity.Multiple,(await Functions.ActionCheckUserSession(requestContext,cancellationToken)),(await Functions.ActionGetMR00RegionId(requestContext,cancellationToken)),(await Functions.ActionGetUserRegionId(requestContext,"",cancellationToken)),cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetFolioStatus",Screen="UnsuccessfulEntries2",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ScreenModel.datasetGetFolioStatus(requestContext,datasetGetFolioStatus_maxRecords,datasetGetFolioStatus_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetSettings",Screen="UnsuccessfulEntries2",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetSettings(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "YMh+L1Z1H9xV5gLNPZiIAg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionGetSettings_Model inputs = null;
...
try {inputs = RESTConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionGetSettings_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionGetSettings_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamOutSettingsText);
return output;
...
[RESTScreenServicesActionProperties(Name="AuditCreateWrapper",Screen="UnsuccessfulEntries2",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionAuditCreateWrapper(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "R9ncJjtM_dSZmMkM5XAN_g", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionAuditCreateWrapper_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionAuditCreateWrapper_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
[RESTScreenServicesActionProperties(Name="ColumnTogglerPassColumn",Screen="UnsuccessfulEntries2",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionColumnTogglerPassColumn(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "CdBjpqOzG3k0+Q1AYbtdhg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionColumnTogglerPassColumn_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_k_Deviations_UnsuccessfulEntries2_ActionColumnTogglerPassColumn_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
