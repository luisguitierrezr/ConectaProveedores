...
[Route("screenservices/ConectaProveedores/e_Orders/Wb_OrderDetailPaymentInformation_13008")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController(ConectaProveedores_Controller.ProxyInstance, childControllers);
    ...
    static ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller() {
...
/*e_Orders.Wb_OrderDetailPaymentInformation_13008.AddRecord*/"6dONWMH_kUW9Ti9X5sMIKA*Lkf0c1NuXkeqoxz3wlJWZQ", 
...
/*e_Orders.Wb_OrderDetailPaymentInformation_13008.ListOfFiles*/"6dONWMH_kUW9Ti9X5sMIKA*c9WDk0cc8keEkp3F771lVQ", 
/*e_Orders.Wb_OrderDetailPaymentInformation_13008.ClearFields*/"6dONWMH_kUW9Ti9X5sMIKA*7MeYpMjE1UGfMfLshSfLXg", 
/*SaveOrderDetail*/"6dONWMH_kUW9Ti9X5sMIKA*zfeEurDo2EWr_zUi2MIeFw", 
/*e_Orders.Wb_OrderDetailPaymentInformation_13008.Validations*/"6dONWMH_kUW9Ti9X5sMIKA*XIz07b_OaUCLoXVTUUtXQw", 
...
/*System_.ListClear*/"uXCIR2Atc0+es3zYuZSnNw*veU0xTJwTE2X4au_He4_vw"});
    ...
    public ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetSpecialApprovals",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetSpecialApprovals(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "vnJOYyFcujOLSxybVuL+qg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel model = null;
...
try {model = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetSpecialApprovals(requestContext,datasetGetSpecialApprovals_maxRecords,datasetGetSpecialApprovals_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetAccountingDataTypes",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetAccountingDataTypes(requestContext,datasetGetAccountingDataTypes_maxRecords,datasetGetAccountingDataTypes_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetAdvancedPaymentTypes",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetAdvancedPaymentTypes(requestContext,datasetGetAdvancedPaymentTypes_maxRecords,datasetGetAdvancedPaymentTypes_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetSpecialPostDeliveryAuthorizations",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetContractStatuses",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetContractStatuses(requestContext,datasetGetContractStatuses_maxRecords,datasetGetContractStatuses_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetProjectAssetServiceOtro",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetProjectAssetServiceOtro(requestContext,datasetGetProjectAssetServiceOtro_maxRecords,datasetGetProjectAssetServiceOtro_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetSuppliers",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetBusinessValueSubcategoriesByCategoryId",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetBusinessValueSubcategoriesByCategoryId(requestContext,datasetGetBusinessValueSubcategoriesByCategoryId_maxRecords,datasetGetBusinessValueSubcategoriesByCategoryId_startIndex,IterationMultiplicity.Multiple,model.ScreenDataSetGetOrderMainById.List.CurrentRec.ssENOrderDetail.ssBusinessValueCategoryId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetSupplierByRequisition",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetOrderMainById",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetProjectAssetServices",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
AggregateRecord<RL_39dc6f4415ce9196844d0ada601cc72b> ds_output = new AggregateRecord<RL_39dc6f4415ce9196844d0ada601cc72b>();
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetProjectAssetServices(requestContext,datasetGetProjectAssetServices_maxRecords,datasetGetProjectAssetServices_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInvoiceUsages",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetInvoiceUsages(requestContext,datasetGetInvoiceUsages_maxRecords,datasetGetInvoiceUsages_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetOrderRetentionTypes",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetOrderRetentionTypes(requestContext,datasetGetOrderRetentionTypes_maxRecords,datasetGetOrderRetentionTypes_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetBusinessValueCategories",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetBusinessValueCategories(requestContext,datasetGetBusinessValueCategories_maxRecords,datasetGetBusinessValueCategories_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetPaymentTerms",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetPaymentTerms(requestContext,datasetGetPaymentTerms_maxRecords,datasetGetPaymentTerms_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInsuranceTypes",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetInsuranceTypes(requestContext,datasetGetInsuranceTypes_maxRecords,datasetGetInsuranceTypes_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetFrequencies",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetFrequencies(requestContext,datasetGetFrequencies_maxRecords,datasetGetFrequencies_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetPaymentOptions",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetPaymentOptions(requestContext,datasetGetPaymentOptions_maxRecords,datasetGetPaymentOptions_startIndex,IterationMultiplicity.Multiple,model.ScreenDataSetGetOrderMainById.List.CurrentRec.ssENOrderDetail.ssPaymentOptionsId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetPaymentWays",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetOrderMainItemsByOrderMainId",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetCurrencies",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetCurrencies(requestContext,datasetGetCurrencies_maxRecords,datasetGetCurrencies_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetDepositTypes",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetDepositTypes(requestContext,datasetGetDepositTypes_maxRecords,datasetGetDepositTypes_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetPaymentMethods",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetPaymentMethods(requestContext,datasetGetPaymentMethods_maxRecords,datasetGetPaymentMethods_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetRejectComment",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ScreenModel.datasetGetRejectComment(requestContext,datasetGetRejectComment_maxRecords,datasetGetRejectComment_startIndex,IterationMultiplicity.Multiple,model.inParami_OrderId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetOrderFilesList",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderFilesList_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamo_FinanceAuthorization, outParamo_ProofOfForeignResidence);
return output;
...
[RESTScreenServicesActionProperties(Name="GetPaymentTermSpecial",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetPaymentTermSpecial_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamId, outParamIsActive);
return output;
...
[RESTScreenServicesActionProperties(Name="GetAccountingData",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetAccountingData_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamOrderAccounting, outParamo_ExchangeRateEvidence, outParamo_Estim_Equal_Agreed, outParamo_CreditNote, outParamo_Voucher, outParamo_Finiquito, outParamo_Anticipo);
return output;
...
[RESTScreenServicesActionProperties(Name="GetOrderContractData",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_DataActionGetOrderContractData_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamo_ContractFile, outParamo_AttachFilesList, outParamo_ContractDepositList, outParamo_ContractInsuranceList, outParamo_ContractAdvancePayment, outParamo_ContractPendingJustification);
return output;
...
[RESTScreenServicesActionProperties(Name="SaveOrderDetail",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionSaveOrderDetail(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "8bUUYXRDhmNPVkKX04isBA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionSaveOrderDetail_Model inputs = null;
...
try {inputs = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionSaveOrderDetail_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionSaveOrderDetail_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamErrorMsg);
return output;
...
[RESTScreenServicesActionProperties(Name="GetIsUserCxP",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.ServerAction)]
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionGetIsUserCxP_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_Value);
return output;
...
[RESTScreenServicesActionProperties(Name="ApprovRejectOrder",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionApprovRejectOrder(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "XUq3ADSWmTtz946jlce+mA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionApprovRejectOrder_Model inputs = null;
...
try {inputs = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionApprovRejectOrder_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionApprovRejectOrder_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_Output);
return output;
...
[RESTScreenServicesActionProperties(Name="SaveContractFile",Screen="Wb_OrderDetailPaymentInformation_13008",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionSaveContractFile(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "Z8yqXl5OlSHTHLD8JQVLAQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionSaveContractFile_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_e_Orders_Wb_OrderDetailPaymentInformation_13008_ActionSaveContractFile_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
