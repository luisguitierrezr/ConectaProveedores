...
public class RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamIsActiveDEV_NewVersionScreenDownloads;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_97ac86b141c7934fd96d3cf71793066e outParamUserRolesList, string outParamAppRoleListText, string outParamEntraRolesListText, bool outParamCanBulkApprove, bool outParamIsActiveDEV_NewVersionScreenDownloads) {RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs();
...
// Write optimized result.outParamCanBulkApprove
result.outParamCanBulkApprove = (bool?) false;
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Model ToModel(RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs variables) {ConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Model result = new ConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_FoliosSAEApproved_DataActionGetUserApplicationRoles_Outputs();
