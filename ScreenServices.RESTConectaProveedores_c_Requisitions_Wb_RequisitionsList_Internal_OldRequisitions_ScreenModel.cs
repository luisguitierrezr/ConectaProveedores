...
public class RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitionsFull_Outputs varLcGetRequisitionsFull;
[JsonProperty("GetUserApplicationRolesAndMore")]
public RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs varLcGetUserApplicationRolesAndMore;
[JsonProperty("GetRequisitions")]
public RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs varLcGetRequisitions;
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel ToModel() {bool varLcl_ShowFilters = variables.varLcl_ShowFilters == null ? false : variables.varLcl_ShowFilters.Value;
...
ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitionsFull_Model _varLcGetRequisitionsFull = (variables.varLcGetRequisitionsFull != null) ? RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitionsFull_Outputs.ToModel(variables.varLcGetRequisitionsFull) : null;
ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Model _varLcGetUserApplicationRolesAndMore = (variables.varLcGetUserApplicationRolesAndMore != null) ? RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetUserApplicationRolesAndMore_Outputs.ToModel(variables.varLcGetUserApplicationRolesAndMore) : null;
ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Model _varLcGetRequisitions = (variables.varLcGetRequisitions != null) ? RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs.ToModel(variables.varLcGetRequisitions) : null;
ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel screenModel = new ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_ScreenModel(varLcl_ShowFilters, varLcl_TableSort, varLcl_StartIndex, varLcl_ApplicationRoleIdForAggregate, varLcl_IsAllowSelectApplicationRoles, varLcl_ReInvokeToggler, varLcl_ColumnJSONVarGetRequisitions, varLcl_CountAfterFetchGetRequisitions, varLcl_ShowCancelPopup, varLcl_AmountFromText, varLcl_AmountToText, varLcl_RequisitonToCancel, varLcl_ShowScreenTableDownloads, varLcl_RequisitionsListInternalIdList, varLcIsListFullNeedRefresh, _ScreenDataSetGetCompanies, _ScreenDataSetGetApprovalStatuses, _ScreenDataSetGetProjectAssetServices, _ScreenDataSetGetCostCenters, _ScreenDataSetGetRequisitionStatuses, _ScreenDataSetGetEntraRole, _varLcGetRequisitionsFull, _varLcGetUserApplicationRolesAndMore, _varLcGetRequisitions, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
