...
public class RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamIsMissingCreditNote;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Outputs FromOutputs(IBehaviorsConfiguration conf, string outParamErrorMsg, EN_d1d0320db36efbb094ad0082361435a0EntityRecord outParamo_Invoice, EN_f81a3d226103fd013068b8763798067aEntityRecord outParamo_InvoiceExtended, string outParamClaveProdServ, string outParamTipoComprobante, bool outParamIsMissingCreditNote) {RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Outputs result = new RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Outputs();
