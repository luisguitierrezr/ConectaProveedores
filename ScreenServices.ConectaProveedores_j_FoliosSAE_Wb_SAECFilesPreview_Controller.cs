...
[Route("screenservices/ConectaProveedores/j_FoliosSAE/Wb_SAECFilesPreview")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController(ConectaProveedores_Controller.ProxyInstance, childControllers);
    ...
    static ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller() {
...
/*DeleteExtraFileFromInvoice*/"6dONWMH_kUW9Ti9X5sMIKA*W4hn27u7TkCTVcAisQnupg"});
    ...
    public ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetFolioFiles",Screen="Wb_SAECFilesPreview",Type=ScreenServicesActionType.DataAction)]
public async Task<ActionResult<Payload.ServiceResponse>> DataActionGetFolioFiles(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "FPDsd6LSGmY9j530ZaFfeQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ScreenModel model = null;
...
try {model = RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
} catch (Exception ex) {
...
[RESTScreenServicesActionProperties(Name="AddNewExtraFilToFolio",Screen="Wb_SAECFilesPreview",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionAddNewExtraFilToFolio(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "dNHN+Zcx3lyLEzPEtOvLwA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionAddNewExtraFilToFolio_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
[RESTScreenServicesActionProperties(Name="DeleteExtraFileFromInvoice",Screen="Wb_SAECFilesPreview",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionDeleteExtraFileFromInvoice(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "7GkpSulvDyxg5vnWrMbcBQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionDeleteExtraFileFromInvoice_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_Wb_SAECFilesPreview_ActionDeleteExtraFileFromInvoice_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
