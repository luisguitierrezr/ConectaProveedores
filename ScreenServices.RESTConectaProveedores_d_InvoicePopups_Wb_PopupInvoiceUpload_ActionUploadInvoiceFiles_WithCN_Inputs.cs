...
public class RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public RestList<ssConectaProveedores.RestRecords.RESTST_7837994e68174a4794f15e4233b48555Structure> inParamCreditNoteFilesList;
...
public bool? inParamIsConstruction;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Inputs result = inputParameters.ToObject<RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Inputs>(settings);
return result;
}


    public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Model ToModel() {ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Model result = new ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUpload_ActionUploadInvoiceFiles_WithCN_Model();
...
result.inParamCreditNoteFilesList = RL_7b4ceb84b6a1255d3a42c8932279bc3c.FromRestList(inParamCreditNoteFilesList, ssConectaProveedores.RestRecords.RESTST_7837994e68174a4794f15e4233b48555Structure.ToStructure);
...
result.inParamIsConstruction = inParamIsConstruction == null ? false : inParamIsConstruction.Value;
return result;
}
