...
public class RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public int? outParamo_TotalCount;
    ...
    public static RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_496abaeba4975b81a1a9b391230e8099 outParamActiveProposals, int outParamo_TotalCount) {RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs result = new RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs();
...
return result;
    ...
    public static ConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Model ToModel(RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs variables) {ConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Model result = new ConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Model();
...
return result;
    ...
    public static RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs result = new RESTConectaProveedores_a_Main_DashboardTreasury_DataActionGetActiveProposals_Outputs();
