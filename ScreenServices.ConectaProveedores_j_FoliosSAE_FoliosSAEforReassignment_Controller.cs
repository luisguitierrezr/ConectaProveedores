...
[Route("screenservices/ConectaProveedores/j_FoliosSAE/FoliosSAEforReassignment")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController("ssOutSystemsUI.ScreenServices.OutSystemsUI_Controller", "OutSystemsUI", childControllers);
                ...
                Permissions.AddAsyncCheckPermissions(new ScreenName("j_FoliosSAE.FoliosSAEforReassignment"), ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller.CheckPermissionsAsync);
            }
        }
    }
...
throw new Ex_NotAlmacenRoleException( "Almacen role required");
    ...
    static ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller() {
...
/*j_FoliosSAE.FoliosSAEforReassignment.RefreshList*/"6dONWMH_kUW9Ti9X5sMIKA*ZFHIUtQyQkyuIF_Zj54thg", 
...
/*j_FoliosSAE.FoliosSAEforReassignment.ResetFilters*/"6dONWMH_kUW9Ti9X5sMIKA*j87pfu9fgked1CTHv7MLIw", 
...
/*a_Common.OnException*/"6dONWMH_kUW9Ti9X5sMIKA*B4kRGvrnOEmQonA8ir4Pyg.#FlowExceptionHandler"});
    ...
    public ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetReassignments",Screen="FoliosSAEforReassignment",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetReassignments(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "JHS8wjN_cul0v_hTW4XMDA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel model = null;
...
try {model = RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ScreenModel.datasetGetReassignments(requestContext,datasetGetReassignments_maxRecords,datasetGetReassignments_startIndex,IterationMultiplicity.Multiple,model.clientVariables.ssFoliosForReassignment_FolioNumber,model.clientVariables.ssFoliosForReassignment_OrderNumber,model.clientVariables.ssFoliosForReassignment_OriginalUserId,model.clientVariables.ssFoliosForReassignment_TargetUserId,model.varLcTableSort,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="FolioReassignGeneralRevoke",Screen="FoliosSAEforReassignment",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionFolioReassignGeneralRevoke(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "xdBcs+wOxMYjcmEp0zdQ3Q", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionFolioReassignGeneralRevoke_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionFolioReassignGeneralRevoke_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionFolioReassignGeneralRevoke_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamErrorMessage);
return output;
...
[RESTScreenServicesActionProperties(Name="ColumnTogglerPassColumn",Screen="FoliosSAEforReassignment",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionColumnTogglerPassColumn(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "CdBjpqOzG3k0+Q1AYbtdhg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionColumnTogglerPassColumn_Model inputs = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
} else {
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionColumnTogglerPassColumn_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
[RESTScreenServicesActionProperties(Name="GetSettings",Screen="FoliosSAEforReassignment",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetSettings(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "YMh+L1Z1H9xV5gLNPZiIAg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionGetSettings_Model inputs = null;
...
try {inputs = RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionGetSettings_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_j_FoliosSAE_FoliosSAEforReassignment_ActionGetSettings_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamOutSettingsText);
return output;
