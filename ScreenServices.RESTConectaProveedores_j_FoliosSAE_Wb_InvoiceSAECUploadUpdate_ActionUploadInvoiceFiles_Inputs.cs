...
public class RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public int? inParamOffsetUtc;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Inputs result = inputParameters.ToObject<RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Inputs>(settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Model ToModel() {ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Model result = new ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadUpdate_ActionUploadInvoiceFiles_Model();
