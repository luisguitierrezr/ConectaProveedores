...
[Route("screenservices/ConectaProveedores/d_Invoices/Wb_i_InvoiceAccounting")]
[RestServiceControllerConfiguration(DefaultValuesBehavior = DefaultValuesBehavior.Send, IsRESTRequest = false, HTTPSecurity = HTTPSecurity.SSL)]
public class ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller : ScreenServicesApiController {

    public static ScreenControllerProxy ProxyInstance = new ScreenControllerProxy();
    public sealed class ScreenControllerProxy : ScreenServicesApiController.BaseScreenControllerProxy {
        public override CheckPermissionsIndex GetPermissionIndex() { return ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller.Permissions; }
        public override IEnumerable<IScreenControllerProxy> GetChildControllers() { return ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller.GetChildControllers(); }
        public override Type GetControllerType() { return typeof(ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller); }
        public override void EnsureInitialized() { ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller.EnsureInitialized(); }
        public override Dictionary<string, BinaryContentUtils.DbBinaryConfig> GetDbBinaryConfigs() { return ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller.GetDbBinaryConfigs(); }
    }
...
SafeAddChildController(ConectaProveedores_Controller.ProxyInstance, childControllers);
    ...
    static ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller() {
...
/*d_Invoices.Wb_i_InvoiceAccounting.EditField*/"6dONWMH_kUW9Ti9X5sMIKA*teiUjamB1EeaWwfybjpeJg", 
/*System_.ListRemove*/"uXCIR2Atc0+es3zYuZSnNw*EL4Omu7NdEeReePEObsNOg", 
/*d_Invoices.Wb_i_InvoiceAccounting.OnClickEditField*/"6dONWMH_kUW9Ti9X5sMIKA*3rKCmMT8EkC9bj12D12W6A", 
...
/*d_Invoices.Wb_i_InvoiceAccounting.TogglePopupImport*/"6dONWMH_kUW9Ti9X5sMIKA*KTgL7PKzi0a_UljhmTkcIA", 
/*System_.ListClear*/"uXCIR2Atc0+es3zYuZSnNw*veU0xTJwTE2X4au_He4_vw", 
/*d_Invoices.Wb_i_InvoiceAccounting.TogglePopupApproval*/"6dONWMH_kUW9Ti9X5sMIKA*oH5P_2c4EkGYjoFlZIlVcw"});

    }

    public ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Controller(
        IAppInfo appInfo,
...
[RESTScreenServicesActionProperties(Name="GetInvoiceRetentionsByInvoiceId",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
public async Task<ActionResult<Payload.ServiceResponse>> ScreenDataSetGetInvoiceRetentionsByInvoiceId(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "XfJdJHOAa26JwHbaGS3tnQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel model = null;
...
try {model = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.FromJSON(screenModel, clientVariables, this.JsonSerializer).ToModel();
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetInvoiceRetentionsByInvoiceId(requestContext,datasetGetInvoiceRetentionsByInvoiceId_maxRecords,datasetGetInvoiceRetentionsByInvoiceId_startIndex,IterationMultiplicity.Multiple,model.inParami_InvoiceId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInvoiceExtendedTaxsByInvoiceId",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetPaymentTerms",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetPaymentTerms(requestContext,datasetGetPaymentTerms_maxRecords,datasetGetPaymentTerms_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInvoiceApproval",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetInvoiceApproval(requestContext,datasetGetInvoiceApproval_maxRecords,datasetGetInvoiceApproval_startIndex,IterationMultiplicity.Multiple,(await Functions.ActionCheckUserSession(requestContext,cancellationToken)),BuiltInFunction.GetUserId (),(await Functions.ActionGetUserSupplier(requestContext,"",cancellationToken)),model.inParami_InvoiceId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetPaymentMethods",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetPaymentMethods(requestContext,datasetGetPaymentMethods_maxRecords,datasetGetPaymentMethods_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInvoiceExtendedById",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetInvoiceExtendedById(requestContext,datasetGetInvoiceExtendedById_maxRecords,datasetGetInvoiceExtendedById_startIndex,IterationMultiplicity.Multiple,model.inParami_InvoiceId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetCostCenters",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetCostCenters(requestContext,datasetGetCostCenters_maxRecords,datasetGetCostCenters_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetRegions",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetRegions(requestContext,datasetGetRegions_maxRecords,datasetGetRegions_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetTaxIndicators",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetTaxIndicators(requestContext,datasetGetTaxIndicators_maxRecords,datasetGetTaxIndicators_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetInvoiceExtendedMoreChargesByInvoiceId",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
[RESTScreenServicesActionProperties(Name="GetInvoiceAccountingsByInvoiceId",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetInvoiceAccountingsByInvoiceId(requestContext,datasetGetInvoiceAccountingsByInvoiceId_maxRecords,datasetGetInvoiceAccountingsByInvoiceId_startIndex,IterationMultiplicity.Multiple,model.inParami_InvoiceId,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetAccountingAccountsServiceTypes",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.Aggregate)]
...
long count;
(ds_output.List,count) = await ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel.datasetGetAccountingAccountsServiceTypes(requestContext,datasetGetAccountingAccountsServiceTypes_maxRecords,datasetGetAccountingAccountsServiceTypes_startIndex,IterationMultiplicity.Multiple,cancellationToken);
...
[RESTScreenServicesActionProperties(Name="GetData",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_DataActionGetData_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamIsAnticipoWithInv, outParamIsLastLevel);
return output;
...
[RESTScreenServicesActionProperties(Name="GetSettings",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.DataAction)]
public async Task<ActionResult<Payload.ServiceResponse>> DataActionGetSettings(CancellationToken cancellationToken) {
    using Stream input = HttpContext.Request.Body;
    return await EndpointAsync(input, "wzskfRKYj+9ntr0Yj3mRwg", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ScreenModel model = null;
CheckPermissionsIndex.CheckPermissionsAsync check;
if(Permissions.TryGetAsyncCheckPermissions(ScreenName.AnyScreen, out check)) {
await check(requestContext, cancellationToken);
...
bool outParamIsActiveDEV_CostCentersNonActive;
outParamIsActiveDEV_CostCentersNonActive = await model.DataActionGetSettings(requestContext,cancellationToken);

var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_DataActionGetSettings_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamIsActiveDEV_CostCentersNonActive);
return output;
...
[RESTScreenServicesActionProperties(Name="GetInvoiceAccounting",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.DataAction)]
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_DataActionGetInvoiceAccounting_Outputs.FromOutputs(this.BehaviorsConfiguration, outParamo_List, outParamo_InvoiceAccountingId);
return output;
...
[RESTScreenServicesActionProperties(Name="GetPaymentMethodDescriptionById",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetPaymentMethodDescriptionById(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "5elxzoJFNIdUrB+k_rsXhA", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetPaymentMethodDescriptionById_Model inputs = null;
...
try {inputs = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetPaymentMethodDescriptionById_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetPaymentMethodDescriptionById_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamDesc);
return output;
...
[RESTScreenServicesActionProperties(Name="GetCodeByTaxId",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetCodeByTaxId(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "Ty7QM+GgI+PN2Z+tGRad3Q", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetCodeByTaxId_Model inputs = null;
...
try {inputs = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetCodeByTaxId_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetCodeByTaxId_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamCode);
return output;
...
[RESTScreenServicesActionProperties(Name="CheckUserSession",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.ServerAction)]
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionCheckUserSession_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamIsValidSession);
return output;
...
[RESTScreenServicesActionProperties(Name="InvoiceAccountingSave",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionInvoiceAccountingSave(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "+OaYtBHOtgAjHh8Am0yN2A", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionInvoiceAccountingSave_Model inputs = null;
...
try {inputs = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionInvoiceAccountingSave_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionInvoiceAccountingSave_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_Output);
return output;
...
[RESTScreenServicesActionProperties(Name="OnSubmitAccounting",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionOnSubmitAccounting(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "5tCw0KuFXoRxdNCFWu06og", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionOnSubmitAccounting_Model inputs = null;
...
try {inputs = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionOnSubmitAccounting_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionOnSubmitAccounting_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamo_Output, res.outParamIsToFinish);
return output;
...
[RESTScreenServicesActionProperties(Name="GetPaymentTermDescriptionById",Screen="Wb_i_InvoiceAccounting",Type=ScreenServicesActionType.ServerAction)]
public async Task<ActionResult<Payload.ServiceResponse>> ActionGetPaymentTermDescriptionById(CancellationToken cancellationToken) {
    ...
    return await EndpointAsync(input, "cYRna9jhvR6EqfFFRbf+LQ", async (screenName, screenModel, inputParameters, clientVariables, cancellationToken) => {
        ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetPaymentTermDescriptionById_Model inputs = null;
...
try {inputs = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetPaymentTermDescriptionById_Inputs.FromJSON(inputParameters, this.JsonSerializer).ToModel();
} catch (Exception ex) {
throw RestExposeErrorsHelper.BadRequest("Failed to parse JSON request content.", ex);
}
...
var output = RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_ActionGetPaymentTermDescriptionById_Outputs.FromOutputs(this.BehaviorsConfiguration, res.outParamDesc);
return output;
