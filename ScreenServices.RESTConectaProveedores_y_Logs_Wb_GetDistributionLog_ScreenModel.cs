...
public class RESTConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_y_Logs_Wb_GetDistributionLog_DataActionGetData_Outputs varLcGetData;
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel ToModel() {int inParamOriginId = variables.inParamOriginId == null ? 0 : variables.inParamOriginId.Value;
...
string inParami_Refresh = variables.inParami_Refresh == null ? "" : variables.inParami_Refresh;
long inParamIdentifier = variables.inParamIdentifier == null ? 0L : variables.inParamIdentifier.Value;
...
ConectaProveedores_y_Logs_Wb_GetDistributionLog_DataActionGetData_Model _varLcGetData = (variables.varLcGetData != null) ? RESTConectaProveedores_y_Logs_Wb_GetDistributionLog_DataActionGetData_Outputs.ToModel(variables.varLcGetData) : null;
ConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel screenModel = new ConectaProveedores_y_Logs_Wb_GetDistributionLog_ScreenModel(inParamOriginId, inParamPeriodInit, inParamPeriodEnd, inParamMaxRecords, inParamShowErrors, inParami_Refresh, inParamIdentifier, varLcStartIndex, varLcShowPopup, varLcJSON_After, varLcJSON_Before, varLcTableSort, _varLcGetData, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
