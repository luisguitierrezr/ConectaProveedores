...
public class RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public int? inParamOffsetUtc;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Inputs result = inputParameters.ToObject<RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Inputs>(settings);
return result;
}


    public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Model ToModel() {ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Model result = new ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_ActionUploadInvoiceFiles_Model();
