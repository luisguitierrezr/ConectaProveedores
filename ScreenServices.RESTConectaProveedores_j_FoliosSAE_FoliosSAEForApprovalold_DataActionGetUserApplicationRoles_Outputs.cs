...
public class RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamCanBulkApprove;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_97ac86b141c7934fd96d3cf71793066e outParamUserRolesList, string outParamAppRoleListText, string outParamEntraRolesListText, bool outParamCanBulkApprove) {RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Model ToModel(RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs variables) {ConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Model result = new ConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApprovalold_DataActionGetUserApplicationRoles_Outputs();
