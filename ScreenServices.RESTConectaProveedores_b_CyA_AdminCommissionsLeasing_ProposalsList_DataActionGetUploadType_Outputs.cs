...
public class RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs : ScreenServicesApiController.Payload.IDataPayload {

    [JsonProperty("List")]
public RestList<ssConectaProveedores.RestRecords.RESTST_714c559a98f1e1080cbf60de3228e843Structure> outParamList;


    public static RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_a579a1a05eaaba551100ea61f4cb3f6b outParamList) {RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs result = new RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs();
...
return result;
    ...
    public static ConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Model ToModel(RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs variables) {ConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Model result = new ConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Model();
...
return result;
    ...
    public static RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs result = new RESTConectaProveedores_b_CyA_AdminCommissionsLeasing_ProposalsList_DataActionGetUploadType_Outputs();
