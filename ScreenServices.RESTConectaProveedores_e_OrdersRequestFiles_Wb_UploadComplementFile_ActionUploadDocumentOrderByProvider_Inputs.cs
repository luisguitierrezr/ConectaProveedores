...
public class RESTConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public int? inParamOffsetUtc;
    ...
    public static RESTConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Inputs result = inputParameters.ToObject<RESTConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Inputs>(settings);
return result;
}


    public ConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Model ToModel() {ConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Model result = new ConectaProveedores_e_OrdersRequestFiles_Wb_UploadComplementFile_ActionUploadDocumentOrderByProvider_Model();
