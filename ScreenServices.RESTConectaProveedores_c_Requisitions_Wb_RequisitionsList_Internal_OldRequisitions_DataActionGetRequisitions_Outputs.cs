...
public class RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public string outParamSortClause;
    ...
    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_a88cee033f640538574578015052224b outParamList, int outParamTotalCount, string outParamSortClause) {RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs result = new RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs();
...
tmpoutParamListElement.AttrRequisition.AttrId = (long?) outParamList.CurrentRec.ssENRequisition.ssId;
...
tmpoutParamListElement.AttrRequisition.AttrRequisitionStatusId = (int?) outParamList.CurrentRec.ssENRequisition.ssRequisitionStatusId;
...
tmpoutParamListElement.AttrRequisition.AttrRegionId = (long?) outParamList.CurrentRec.ssENRequisition.ssRegionId;
tmpoutParamListElement.AttrRequisition.AttrAccountingRegionId = (long?) outParamList.CurrentRec.ssENRequisition.ssAccountingRegionId;
...
tmpoutParamListElement.AttrRequisition.AttrIsContractPending = (bool?) outParamList.CurrentRec.ssENRequisition.ssIsContractPending;
...
tmpoutParamListElement.AttrRequisition.AttrHasContractFileUploaded = (bool?) outParamList.CurrentRec.ssENRequisition.ssHasContractFileUploaded;
...
tmpoutParamListElement.AttrRequisition.AttrAdvWithoutInvoice = (bool?) outParamList.CurrentRec.ssENRequisition.ssAdvWithoutInvoice;
...
// Write optimized tmpoutParamListElement.AttrRequisitionApprovalLevel.AttrId
tmpoutParamListElement.AttrRequisitionApprovalLevel.AttrId = (long?) 0L;
...
tmpoutParamListElement.AttrRequisitionApprovalLevel.AttrApproveAsAreaUsuaria = (bool?) outParamList.CurrentRec.ssENRequisitionApprovalLevel.ssApproveAsAreaUsuaria;
...
// Write optimized tmpoutParamListElement.AttrRequisitionApproval.AttrRequisitionId
tmpoutParamListElement.AttrRequisitionApproval.AttrRequisitionId = (long?) 0L;
...
tmpoutParamListElement.AttrDontShowAction.AttrValue = (bool?) outParamList.CurrentRec.ssSTDontShowAction.ssValue;
...
return result;
    ...
    public static ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Model ToModel(RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs variables) {ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Model result = new ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Model();
...
return result;
    ...
    public static RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs result = new RESTConectaProveedores_c_Requisitions_Wb_RequisitionsList_Internal_OldRequisitions_DataActionGetRequisitions_Outputs();
