...
public class RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
[JsonProperty("o_IsActiveDEV_NumeroDeFolioVisible")]
public bool? outParamo_IsActiveDEV_NumeroDeFolioVisible;


    public static RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs FromOutputs(IBehaviorsConfiguration conf, bool outParamIsActiveAmountValidation, bool outParamIsForceForeigner, decimal outParamo_ForeignCurrencyMargin, decimal outParamo_NationalCurrencyMargin, bool outParamo_IsActiveDEV_HU13008_Complement, bool outParamo_IsActiveDEV_HU13046, bool outParamo_IsActiveDEV_NumeroDeFolioVisible) {RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs result = new RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs();
...
result.outParamo_IsActiveDEV_NumeroDeFolioVisible = (bool?) outParamo_IsActiveDEV_NumeroDeFolioVisible;
return result;
}


    public static ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Model ToModel(RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs variables) {ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Model result = new ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Model();
...
result.outParamo_IsActiveDEV_NumeroDeFolioVisible = variables == null || variables.outParamo_IsActiveDEV_NumeroDeFolioVisible == null ? false : variables.outParamo_IsActiveDEV_NumeroDeFolioVisible.Value;
return result;
}


    public static RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs result = new RESTConectaProveedores_j_FoliosSAE_EditFolioSAE_DataActionGetSettings_Outputs();
...
result.outParamo_IsActiveDEV_NumeroDeFolioVisible = (bool?) screenModel.outParamo_IsActiveDEV_NumeroDeFolioVisible;
return result;
}
