...
public class RESTConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel ToModel() {string varLcUUId = variables.varLcUUId == null ? "" : variables.varLcUUId;
...
ConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel screenModel = new ConectaProveedores_g_Reports_wb_documentExtrationByUUID_ScreenModel(varLcUUId, varLcTableSort, varLcStartIndex, varLcMaxRecords, varLcStorageId, varLcIsSelectOne, varLcForceRefresh, _ScreenDataSetGetInvoiceFiles, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
