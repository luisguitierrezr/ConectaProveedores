...
public class RESTConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public int? inParamOffsetUtc;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Inputs result = inputParameters.ToObject<RESTConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Inputs>(settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Model ToModel() {ConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Model result = new ConectaProveedores_j_FoliosSAE_PreApprovalFolioDetail_ActionCancelFolio_Model();
