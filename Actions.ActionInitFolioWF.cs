...
public class lcvInitFolioWF : VarsBag {
...
public lcvInitFolioWF(long inParami_FolioId, long inParami_ApprovalProcessId, int inParami_ApprovalProcessTypeId) {
...
public class lcoInitFolioWF : VarsBag {
public ST_046fb53ebbe142526d95e87ef1ae9711Structure outParamo_Output = new ST_046fb53ebbe142526d95e87ef1ae9711Structure();

public lcoInitFolioWF() {
}
}
/// <summary>
/// Action <code>InitFolioWF</code> that represents the Service Studio action <code>InitFolioWF</code>
///  <p> Description: Action to initialize Folio workflow.</p>
/// </summary>
public static async Task<ST_046fb53ebbe142526d95e87ef1ae9711Structure> ActionInitFolioWF(IRequestContext requestContext,long inParami_FolioId,long inParami_ApprovalProcessId,int inParami_ApprovalProcessTypeId,CancellationToken cancellationToken) {
ST_046fb53ebbe142526d95e87ef1ae9711Structure outParamo_Output = default;
lcoInitFolioWF result = new lcoInitFolioWF();
lcvInitFolioWF localVars = new lcvInitFolioWF(inParami_FolioId, inParami_ApprovalProcessId, inParami_ApprovalProcessTypeId);
try {
cancellationToken.ThrowIfCancellationRequested();
using (AppHealthProvider.CreateServerActionMetric("InitFolioWF", "1aed3e68-a060-4d06-a900-9bb25653d934"))
using (RuntimePlatformSettings.OpenTelemetry.ServerActionIsEnabled.GetValue() ? activitySource.CreateActionActivity("InitFolioWF", "1aed3e68-a060-4d06-a900-9bb25653d934", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828") : null){
...
int datasetGetFolioById_startIndex = 0;(localVars.queryResGetFolioById_outParamList,localVars.queryResGetFolioById_outParamCount) = await FuncActionInitFolioWF.datasetGetFolioById(requestContext,datasetGetFolioById_maxRecords,datasetGetFolioById_startIndex,IterationMultiplicity.Never,localVars.inParami_FolioId,cancellationToken);
...
// o_Output.Message = "Form not found!"
result.outParamo_Output.ssMessage = AppUtils.GetStringResource("QSzjv2wR7kOVcuMXp8OyRA#Value.1059582856.1", "Form not found!");
} else {
// Has First Approver defined?
if(((localVars.queryResGetFolioById_outParamList.CurrentRec.ssENFolio.ssFirstApproverUserId!=BuiltInFunction.NullTextIdentifier ()))) {
...
// o_Output.Message = "First approver selected not found!"
result.outParamo_Output.ssMessage = AppUtils.GetStringResource("auOmY349AE6uakwmEcW3DQ#Value.1545252646.1", "First approver selected not found!");
goto RETURN_STATEMENT;

} else {
// GetApprovalProcessDef
(localVars.resGetApprovalProcessDef.outParamo_ApprovalProcess,localVars.resGetApprovalProcessDef.outParamo_Output) = await Actions.ActionGetApprovalProcessDef(requestContext,AppUtils.GetStringResource("9GlpugOHCUCvFHeypeWTLQ#Value.363639310.1", "FolioSAE"),localVars.queryResGetFolioById_outParamList.CurrentRec.ssENOrderMain.ssRegionId,localVars.queryResGetFirstApproverUserData_outParamList.CurrentRec.ssENDepartment.ssName,localVars.queryResGetFirstApproverUserData_outParamList.CurrentRec.ssENTelcelDirection.ssName,localVars.queryResGetFirstApproverUserData_outParamList.CurrentRec.ssENUser_Extended_Internal.ssEntraRoleId,localVars.queryResGetFirstApproverUserData_outParamList.CurrentRec.ssENUser_Extended_Internal.ssDepartmentId,false,false,4,false,0L,cancellationToken);
...
localVars.resInitFolioWF_FromApprovProcId.outParamo_Output = await Actions.ActionInitFolioWF_FromApprovProcId(requestContext,localVars.inParami_FolioId,localVars.inParami_ApprovalProcessId,localVars.inParami_ApprovalProcessTypeId,AppUtils.GetStringResource("llPdUJMHKUO03jqRR9JHng#Value.363639310.1", "FolioSAE"),cancellationToken);
...
// o_Output
// o_Output = InitFolioWF_FromApprovProcId.o_Output
result.outParamo_Output=localVars.resInitFolioWF_FromApprovProcId.outParamo_Output;
goto RETURN_STATEMENT;
...
// FolioLogAdd
localVars.resFolioLogAdd.outParamId = await Actions.ActionFolioLogAdd(requestContext,new EN_ef6e162f6b50d0b1f4fc1a1d25cef900EntityRecord(){ ssId = Convert.ToInt64(BuiltInFunction.NullIdentifier ()), ssFolioId = localVars.inParami_FolioId, ssMessage = ((((AppUtils.GetStringResource("831v5R8VTUeYmuf+ySIG+w#Value.2195684.1", "Form")+" ")+localVars.queryResGetFolioById_outParamList.CurrentRec.ssENFolio.ssFolioNumber)+" ")+AppUtils.GetStringResource("831v5R8VTUeYmuf+ySIG+w#Value.476391.1", "initiated approval process.")), ssCreatedOn = BuiltInFunction.CurrDateTime (), ssIsForSupplier = true },cancellationToken);

// o_Output.IsSuccess = True
result.outParamo_Output.ssIsSuccess = true;
{
    using (AppHealthProvider.CreateGlobalEventTriggerMetric("OnSendFolioFirstApproverEmail", "a0b43eee-1398-42f2-a469-3f8caa845e04"))
    using (activitySource.CreateTriggerEventActivity("OnSendFolioFirstApproverEmail", "a0b43eee-1398-42f2-a469-3f8caa845e04", "25ff866d-6edc-4dc9-8233-8f1985921947", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828")) {
...
public static class FuncActionInitFolioWF {
...
// Query Function "GetFirstApproverUserData" o9CDByGW8ECiReWi6OJgSA of Action "InitFolioWF"
...
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("InitFolioWF.GetFirstApproverUserData", "0783d0a3-9621-40f0-a245-e5a2e8e26048");
using var queryActivity = activitySource.CreateAggregateQueryActivity("InitFolioWF.GetFirstApproverUserData", "0783d0a3-9621-40f0-a245-e5a2e8e26048", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
selectBuilder.Append("/* /UserActions.aD7tGmCgBk2pAJuyVlPZNA/NodesNotShownInESpaceTree.o9CDByGW8ECiReWi6OJgSA, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT NULL o0, \"endepartment\".\"name\" o1, NULL o2, NULL o3, NULL o4, NULL o5, NULL o6, NULL o7, \"enentrarole3\".\"rolename\" o8, NULL o9, NULL o10, NULL o11, NULL o12, NULL o13, \"entelceldirection2\".\"name\" o14, NULL o15, NULL o16, NULL o17, NULL o18, NULL o19, NULL o20, NULL o21, \"enuser17\".\"email\" o22, NULL o23, NULL o24, NULL o25, NULL o26, NULL o27, NULL o28, \"enuser_extended_internal9\".\"departmentid\" o29, NULL o30, NULL o31, NULL o32, NULL o33, NULL o34, \"enuser_extended_internal9\".\"entraroleid\" o35, NULL o36, NULL o37, NULL o38, NULL o39, NULL o40, NULL o41, NULL o42, NULL o43, NULL o44, NULL o45, \"enuserextension8\".\"correspondentexternalemail\" o46, NULL o47");
fromBuilder.Append(" FROM ((((({User_Extended_Internal} \"enuser_extended_internal9\" Inner JOIN {User} \"enuser17\" ON (\"enuser_extended_internal9\".\"id\" = \"enuser17\".\"id\"))  Left JOIN {Department} \"endepartment\" ON (\"enuser_extended_internal9\".\"departmentid\" = \"endepartment\".\"id\"))  Left JOIN {UserExtension} \"enuserextension8\" ON (\"enuser17\".\"id\" = \"enuserextension8\".\"id\"))  Left JOIN {TelcelDirection} \"entelceldirection2\" ON (\"enuser_extended_internal9\".\"telceldirectionid\" = \"entelceldirection2\".\"id\"))  Left JOIN {EntraRole} \"enentrarole3\" ON (\"enuser_extended_internal9\".\"entraroleid\" = \"enentrarole3\".\"id\")) ");
whereBuilder.Append(" WHERE ");
if ((qpusUser_Id.Trim()!="")) {
whereBuilder.Append("((\"enuser17\".\"id\" = @qpusUser_Id) AND (\"enuser17\".\"id\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpusUser_Id", DbType.String, qpusUser_Id);
} else {
whereBuilder.Append("(\"enuser17\".\"id\" IS NULL)");
}
if (maxRecords > 0) {
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query InitFolioWF.GetFirstApproverUserData.List", cancellationToken: cancellationToken);
...
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query InitFolioWF.GetFirstApproverUserData.List", cancellationToken: cancellationToken);
...
// Query Function "GetFolioById" QBpYP8XBdEW91p3NCFpU5A of Action "InitFolioWF"
...
long outParamCount = default;
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("InitFolioWF.GetFolioById", "3f581a40-c1c5-4574-bdd6-9dcd085a54e4");
using var queryActivity = activitySource.CreateAggregateQueryActivity("InitFolioWF.GetFolioById", "3f581a40-c1c5-4574-bdd6-9dcd085a54e4", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
// Query Iterations: Never
if (multiplicity == IterationMultiplicity.Never) {
maxRecords = 1;
}
...
var groupByBuilder = new StringBuilder();
var havingBuilder = new StringBuilder();
selectBuilder.Append("/* /UserActions.aD7tGmCgBk2pAJuyVlPZNA/NodesNotShownInESpaceTree.QBpYP8XBdEW91p3NCFpU5A, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT \"enfolio4\".\"id\" o0, \"enfolio4\".\"isdraft\" o1, \"enfolio4\".\"folionumber\" o2, \"enfolio4\".\"canproveedorcancel\" o3, \"enfolio4\".\"orderid\" o4, \"enfolio4\".\"supplierid\" o5, \"enfolio4\".\"companyid\" o6, \"enfolio4\".\"foliostatusid\" o7, trim_scale(\"enfolio4\".\"totalamount\"::numeric) o8, trim_scale(\"enfolio4\".\"totaliva_amount\"::numeric) o9, trim_scale(\"enfolio4\".\"partialamount\"::numeric) o10, \"enfolio4\".\"currencyid\" o11, \"enfolio4\".\"firstapproveruserid\" o12, \"enfolio4\".\"approvalprocesstypeid\" o13, \"enfolio4\".\"sapentryerror\" o14, \"enfolio4\".\"createdby\" o15, \"enfolio4\".\"createdon\" o16, \"enfolio4\".\"updatedby\" o17, \"enfolio4\".\"updatedon\" o18, \"enfolio4\".\"minuteselected\" o19, NULL o20, NULL o21, NULL o22, NULL o23, NULL o24, NULL o25, NULL o26, NULL o27, NULL o28, NULL o29, NULL o30, NULL o31, NULL o32, NULL o33, NULL o34, NULL o35, NULL o36, NULL o37, NULL o38, NULL o39, NULL o40, NULL o41, \"enordermain8\".\"regionid\" o42, NULL o43, NULL o44, NULL o45, NULL o46, NULL o47, NULL o48, NULL o49, NULL o50, NULL o51, NULL o52, NULL o53, NULL o54, NULL o55, NULL o56, NULL o57, NULL o58, NULL o59, NULL o60, NULL o61");
fromBuilder.Append(" FROM (({Folio} \"enfolio4\" Left JOIN {OrderMain} \"enordermain8\" ON (\"enfolio4\".\"orderid\" = \"enordermain8\".\"id\"))  Left JOIN {Region} \"enregion5\" ON (\"enordermain8\".\"regionid\" = \"enregion5\".\"id\")) ");
whereBuilder.Append(" WHERE ");
if (qpfoFolio_Id != 0) {
whereBuilder.Append("((\"enfolio4\".\"id\" = @qpfoFolio_Id) AND (\"enfolio4\".\"id\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpfoFolio_Id", DbType.Int64, qpfoFolio_Id);
} else {
whereBuilder.Append("(\"enfolio4\".\"id\" IS NULL)");
}
if (maxRecords > 0) {
orderByBuilder.Append(" LIMIT ");
orderByBuilder.Append(maxRecords);
...
opt[1] = new BitArray(new bool[] {true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, false, true, true, true, true, true, true});
opt[2] = new BitArray(new bool[] {true, true, true, true, true, true, true, true, true, true, true, true, true});
outParamList.AllOptimizedAttributes = opt;
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query InitFolioWF.GetFolioById.List", cancellationToken: cancellationToken);
await outParamList.LoadFromDatabase(cancellationToken);
outParamList.MaxRecords = maxRecords;
return (outParamList,outParamCount);
} finally {
...
_tmp.MaxRecords = maxRecords;
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query InitFolioWF.GetFolioById.List", cancellationToken: cancellationToken);
await _tmp.LoadFromDatabase(cancellationToken);
