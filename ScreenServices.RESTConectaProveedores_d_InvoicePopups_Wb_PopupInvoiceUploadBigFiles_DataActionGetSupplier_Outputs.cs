...
public class RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamIsActiveDEV_TK395;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs FromOutputs(IBehaviorsConfiguration conf, string outParamExpedicionFiscal, bool outParamIsNational, string outParamName, string outParamRFC, string outParamSociety, bool outParamIsActiveDEV_TK395) {RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs result = new RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs();
...
return result;
    ...
    public static ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Model ToModel(RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs variables) {ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Model result = new ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Model();
...
return result;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs result = new RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadBigFiles_DataActionGetSupplier_Outputs();
