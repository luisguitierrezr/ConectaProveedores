...
public class RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public RestList<ssConectaProveedores.RestRecords.RESTRC_2b77a78552d1dad3876c3ebd8f5c8ec1> outParamInvoicesList;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_ff28012de5324af3e81e5ace09ecb1f0 outParamInvoicesList) {RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs result = new RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs();
...
return result;
    ...
    public static ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Model ToModel(RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs variables) {ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Model result = new ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Model();
...
return result;
    ...
    public static RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs result = new RESTConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultipleBigFiles_DataActionGetInvoicesByRequisitionOrFolio_Outputs();
