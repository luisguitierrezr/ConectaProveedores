...
public class RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public long? outParamUserSupplier;
[JsonProperty("IsAllRegions")]
public bool? outParamIsAllRegions;


    public static RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs FromOutputs(IBehaviorsConfiguration conf, RL_97ac86b141c7934fd96d3cf71793066e outParamUserRolesList, bool outParamIsAuditor, long outParamUserRegion, long outParamUserSupplier, bool outParamIsAllRegions) {RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs result = new RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs();
...
result.outParamUserSupplier = (long?) outParamUserSupplier;
result.outParamIsAllRegions = (bool?) outParamIsAllRegions;
return result;
}


    public static ConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Model ToModel(RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs variables) {ConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Model result = new ConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Model();
...
result.outParamUserSupplier = variables == null || variables.outParamUserSupplier == null ? 0L : variables.outParamUserSupplier.Value;
...
return result;
    ...
    public static RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs result = new RESTConectaProveedores_g_Reports_LinesReport_DataActionGetUserApplicationRoles_Outputs();
...
result.outParamUserSupplier = (long?) screenModel.outParamUserSupplier;
