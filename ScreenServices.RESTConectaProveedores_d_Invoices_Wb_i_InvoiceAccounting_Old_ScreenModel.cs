...
public class RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetData_Outputs varLcGetData;
[JsonProperty("GetInvoiceAccounting")]
public RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs varLcGetInvoiceAccounting;
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel ToModel() {long inParami_InvoiceId = variables.inParami_InvoiceId == null ? 0L : variables.inParami_InvoiceId.Value;
...
ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetData_Model _varLcGetData = (variables.varLcGetData != null) ? RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetData_Outputs.ToModel(variables.varLcGetData) : null;
ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Model _varLcGetInvoiceAccounting = (variables.varLcGetInvoiceAccounting != null) ? RESTConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_DataActionGetInvoiceAccounting_Outputs.ToModel(variables.varLcGetInvoiceAccounting) : null;
ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel screenModel = new ConectaProveedores_d_Invoices_Wb_i_InvoiceAccounting_Old_ScreenModel(inParami_InvoiceId, inParami_RequisitionId, inParamIsActiveUser, inParamIsCorp, inParamSupplierNumber, varLcl_Iva, varLcl_ShowImportPopup, varLcl_ShowApprovalInvoice, varLcl_ShowCancelInvoice, varLcl_ShowModifyPopup, varLcl_IsApproval, varLcl_IsImport, varLcl_InvoiceAccountingEntries, _ScreenDataSetGetCostCenters, _ScreenDataSetGetInvoiceRetentionsByInvoiceId, _ScreenDataSetGetTaxIndicators, _ScreenDataSetGetInvoiceApproval, _ScreenDataSetGetPaymentMethods, _ScreenDataSetGetPaymentTerms, _ScreenDataSetGetInvoiceExtendedById, _ScreenDataSetGetAccountingAccountsServiceTypes, _ScreenDataSetGetRegions, _ScreenDataSetGetInvoiceAccountingsByInvoiceId, _ScreenDataSetGetInvoiceExtendedMoreChargesByInvoiceId, _ScreenDataSetGetInvoiceExtendedTaxsByInvoiceId, _varLcGetData, _varLcGetInvoiceAccounting, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
