...
public class RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamIsActiveDEV_TK395;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs FromOutputs(IBehaviorsConfiguration conf, string outParamExpedicionFiscal, bool outParamIsNational, string outParamName, string outParamRFC, string outParamSociety, string outParamSupplierNr, bool outParamIsActiveDEV_TK395) {RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs();
...
return result;
    ...
    public static ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Model ToModel(RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs variables) {ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Model result = new ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Model();
...
return result;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs FromModel(IBehaviorsConfiguration conf, ConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Model screenModel) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUpload_DataActionGetSupplier_Outputs();
