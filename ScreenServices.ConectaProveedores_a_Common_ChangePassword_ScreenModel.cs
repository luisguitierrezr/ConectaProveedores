...
public class ConectaProveedores_a_Common_ChangePassword_ScreenModel : VarsBag {

    private static readonly ActivitySource activitySource = new(typeof(ConectaProveedores_a_Common_ChangePassword_ScreenModel).Namespace);
...
using var appHealthMetric = AppHealthProvider.CreateScreenServiceAggregateMetric("a_Common.ChangePassword.GetUserDetail", "99935c79-947f-49d9-a2bc-096c0afc7b20");
using var queryActivity = activitySource.CreateScreenAggregateQueryActivity("ChangePassword","a_Common.ChangePassword.GetUserDetail");
...
selectBuilder.Append("/* /NRWebFlows.B4kRGvrnOEmQonA8ir4Pyg/NodesShownInESpaceTree.KRZ4442ho0CmgIxpfhgXAA/ScreenDataSets.eVyTmX+U2UmivAlsCvx7IA, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT NULL o0, NULL o1, \"enuser161\".\"email\" o2, NULL o3, NULL o4");
fromBuilder.Append(" FROM {User} \"enuser161\"");
whereBuilder.Append(" WHERE ");
if ((qpusId.Trim()!="")) {
whereBuilder.Append("((\"enuser161\".\"id\" = @qpusId) AND (\"enuser161\".\"id\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpusId", DbType.String, qpusId);
} else {
whereBuilder.Append("(\"enuser161\".\"id\" IS NULL)");
}
if (maxRecords > 0) {
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query a_Common.ChangePassword.GetUserDetail.List", cancellationToken: cancellationToken);
...
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query a_Common.ChangePassword.GetUserDetail.List", cancellationToken: cancellationToken);
