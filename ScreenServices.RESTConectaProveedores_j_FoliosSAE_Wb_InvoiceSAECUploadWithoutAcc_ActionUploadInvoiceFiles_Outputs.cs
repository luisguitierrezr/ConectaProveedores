...
public class RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadWithoutAcc_ActionUploadInvoiceFiles_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public bool? outParamIsMissingCreditNote;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadWithoutAcc_ActionUploadInvoiceFiles_Outputs FromOutputs(IBehaviorsConfiguration conf, string outParamErrorMsg, EN_d1d0320db36efbb094ad0082361435a0EntityRecord outParamo_Invoice, EN_f81a3d226103fd013068b8763798067aEntityRecord outParamo_InvoiceExtended, string outParamClaveProdServ, string outParamTipoComprobante, bool outParamIsMissingCreditNote) {RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadWithoutAcc_ActionUploadInvoiceFiles_Outputs result = new RESTConectaProveedores_j_FoliosSAE_Wb_InvoiceSAECUploadWithoutAcc_ActionUploadInvoiceFiles_Outputs();
...
// Write the needed fields of the record outParamo_InvoiceExtended to the result.outParamo_InvoiceExtended
result.outParamo_InvoiceExtended = new ssConectaProveedores.RestRecords.RESTEN_f81a3d226103fd013068b8763798067aEntityRecord();
result.outParamo_InvoiceExtended.AttrId = (long?) outParamo_InvoiceExtended.ssId;
result.outParamo_InvoiceExtended.AttrVersion = outParamo_InvoiceExtended.ssVersion;
result.outParamo_InvoiceExtended.AttrFolio = outParamo_InvoiceExtended.ssFolio;
result.outParamo_InvoiceExtended.AttrSerie = outParamo_InvoiceExtended.ssSerie;
result.outParamo_InvoiceExtended.AttrFechaEmision = outParamo_InvoiceExtended.ssFechaEmision;
result.outParamo_InvoiceExtended.AttrFormaPago = outParamo_InvoiceExtended.ssFormaPago;
result.outParamo_InvoiceExtended.AttrMetodoPago = outParamo_InvoiceExtended.ssMetodoPago;
result.outParamo_InvoiceExtended.AttrLugarExpedicion = outParamo_InvoiceExtended.ssLugarExpedicion;
result.outParamo_InvoiceExtended.AttrSubtotal = (decimal?) outParamo_InvoiceExtended.ssSubtotal;
result.outParamo_InvoiceExtended.AttrDescuento = (decimal?) outParamo_InvoiceExtended.ssDescuento;
result.outParamo_InvoiceExtended.AttrTotalIVA = (decimal?) outParamo_InvoiceExtended.ssTotalIVA;
result.outParamo_InvoiceExtended.AttrRetenciones = (decimal?) outParamo_InvoiceExtended.ssRetenciones;
result.outParamo_InvoiceExtended.AttrTotal = (decimal?) outParamo_InvoiceExtended.ssTotal;
result.outParamo_InvoiceExtended.AttrTipoComprobante = outParamo_InvoiceExtended.ssTipoComprobante;
result.outParamo_InvoiceExtended.AttrMoneda = outParamo_InvoiceExtended.ssMoneda;
result.outParamo_InvoiceExtended.AttrTipoCambio = (decimal?) outParamo_InvoiceExtended.ssTipoCambio;
result.outParamo_InvoiceExtended.AttrUsoCFDI = outParamo_InvoiceExtended.ssUsoCFDI;
result.outParamo_InvoiceExtended.AttrExportacion = outParamo_InvoiceExtended.ssExportacion;
result.outParamo_InvoiceExtended.AttrUUID = outParamo_InvoiceExtended.ssUUID;
