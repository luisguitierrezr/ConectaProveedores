...
public class RESTConectaProveedores_e_Orders_OrdersApproved_ActionScreenTableDownloadOrderScreen_Outputs : ScreenServicesApiController.Payload.IDataPayload {
...
public string outParamo_ErrorMsg;
    ...
    public static RESTConectaProveedores_e_Orders_OrdersApproved_ActionScreenTableDownloadOrderScreen_Outputs FromOutputs(IBehaviorsConfiguration conf, ST_a158c76eb93396680623c04244f48b6cStructure outParamo_File, string outParamo_StringListIds, string outParamo_ErrorMsg) {RESTConectaProveedores_e_Orders_OrdersApproved_ActionScreenTableDownloadOrderScreen_Outputs result = new RESTConectaProveedores_e_Orders_OrdersApproved_ActionScreenTableDownloadOrderScreen_Outputs();
