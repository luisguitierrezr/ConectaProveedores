...
public class ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_ScreenModel : VarsBag {

    private static readonly ActivitySource activitySource = new(typeof(ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_ScreenModel).Namespace);
...
public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_DataActionGetInvoicesByRequisitionOrFolio_Model varLcGetInvoicesByRequisitionOrFolio;
public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_DataActionGetSupplier_Model varLcGetSupplier;
public ConectaProveedores_ClientVariables clientVariables;


    public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_ScreenModel() {
}



    public ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_ScreenModel(int inParamInvoiceStatusId, long inParamRequisitionId, long inParamFolioId, string varLcErrorMsg, RL_2e76d5be11218f97ffd872b5a7213337 varLcFilesList, bool varLcHasChanged, bool varLcIsExecuting, bool varLcIsSaving, ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_DataActionGetInvoicesByRequisitionOrFolio_Model varLcGetInvoicesByRequisitionOrFolio, ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_DataActionGetSupplier_Model varLcGetSupplier, ConectaProveedores_ClientVariables clientVariables) {
...
ConectaProveedores_d_InvoicePopups_Wb_PopupInvoiceUploadMultiple_ScreenModel model = this;

try {
cancellationToken.ThrowIfCancellationRequested();
using (AppHealthProvider.CreateScreenServiceDataActionMetric("GetInvoicesByRequisitionOrFolio", "7807cac5-6b08-4736-82e7-b56b89d1a94a"))
using (activitySource.CreateScreenDataActionActivity("Wb_PopupInvoiceUploadMultiple", "GetInvoicesByRequisitionOrFolio")){
// no req
...
try {
cancellationToken.ThrowIfCancellationRequested();
using (AppHealthProvider.CreateScreenServiceDataActionMetric("GetSupplier", "e9151e12-d393-4747-bed5-3dc26ceac766"))
using (activitySource.CreateScreenDataActionActivity("Wb_PopupInvoiceUploadMultiple", "GetSupplier")){
...
// Query Function "GetInvoicesByFolioId" oimvM0V+0kiZbRSxV5AHnw of Action "GetInvoicesByRequisitionOrFolio"
...
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByFolioId", "33af29a2-7e45-48d2-996d-14b15790079f");
using var queryActivity = activitySource.CreateAggregateQueryActivity("d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByFolioId", "33af29a2-7e45-48d2-996d-14b15790079f", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
selectBuilder.Append("/* /NRWebFlows.mak5F1HCzk2BbukH+WQStA/NodesShownInESpaceTree.POTmpGxLREypzVgYpzAOLg/DataActions.xcoHeAhrNkeC57VridGpSg/NodesNotShownInESpaceTree.oimvM0V+0kiZbRSxV5AHnw, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT NULL o0, \"eninvoice97\".\"name\" o1, NULL o2, NULL o3, NULL o4, NULL o5, NULL o6, NULL o7, NULL o8, NULL o9, NULL o10, NULL o11, NULL o12, NULL o13, NULL o14, NULL o15, NULL o16, NULL o17, NULL o18, NULL o19, NULL o20, NULL o21, NULL o22, NULL o23, NULL o24, NULL o25, NULL o26, NULL o27, NULL o28, NULL o29, NULL o30, NULL o31");
fromBuilder.Append(" FROM ({Invoice} \"eninvoice97\" Inner JOIN {InvoiceFile} \"eninvoicefile31\" ON (\"eninvoice97\".\"id\" = \"eninvoicefile31\".\"invoiceid\")) ");
...
whereBuilder.Append("((\"eninvoice97\".\"folioid\" = @qpfoInvoice_FolioId) AND (\"eninvoice97\".\"folioid\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpfoInvoice_FolioId", DbType.Int64, qpfoInvoice_FolioId);
} else {
whereBuilder.Append("(\"eninvoice97\".\"folioid\" IS NULL)");
}
whereBuilder.Append(" AND (\"eninvoice97\".\"invoicestatusid\" <> ");
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByFolioId.List", cancellationToken: cancellationToken);
...
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByFolioId.List", cancellationToken: cancellationToken);
...
// Query Function "GetInvoicesByRequisitionId" 0iO4w9QQHUqBZdEQeIFFZg of Action "GetInvoicesByRequisitionOrFolio"
...
long outParamCount = default;
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByRequisitionId", "c3b823d2-10d4-4a1d-8165-d11078814566");
using var queryActivity = activitySource.CreateAggregateQueryActivity("d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByRequisitionId", "c3b823d2-10d4-4a1d-8165-d11078814566", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
// Query Iterations: Multiple
if (multiplicity == IterationMultiplicity.Never) {
maxRecords = 1;
}
...
var groupByBuilder = new StringBuilder();
var havingBuilder = new StringBuilder();
selectBuilder.Append("/* /NRWebFlows.mak5F1HCzk2BbukH+WQStA/NodesShownInESpaceTree.POTmpGxLREypzVgYpzAOLg/DataActions.xcoHeAhrNkeC57VridGpSg/NodesNotShownInESpaceTree.0iO4w9QQHUqBZdEQeIFFZg, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT NULL o0, \"eninvoice98\".\"name\" o1, NULL o2, NULL o3, NULL o4, NULL o5, NULL o6, NULL o7, NULL o8, NULL o9, NULL o10, NULL o11, NULL o12, NULL o13, NULL o14, NULL o15, NULL o16, NULL o17, NULL o18, NULL o19, NULL o20, NULL o21, NULL o22, NULL o23, NULL o24, NULL o25, NULL o26, NULL o27, NULL o28, NULL o29, NULL o30, NULL o31");
fromBuilder.Append(" FROM ({Invoice} \"eninvoice98\" Inner JOIN {InvoiceFile} \"eninvoicefile32\" ON (\"eninvoice98\".\"id\" = \"eninvoicefile32\".\"invoiceid\")) ");
whereBuilder.Append(" WHERE ");
if (qpreInvoice_RequisitionId != 0) {
whereBuilder.Append("((\"eninvoice98\".\"requisitionid\" = @qpreInvoice_RequisitionId) AND (\"eninvoice98\".\"requisitionid\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpreInvoice_RequisitionId", DbType.Int64, qpreInvoice_RequisitionId);
} else {
whereBuilder.Append("(\"eninvoice98\".\"requisitionid\" IS NULL)");
}
whereBuilder.Append(" AND (\"eninvoice98\".\"invoicestatusid\" <> ");
whereBuilder.Append((ENInvoiceStatusEntity.GetRecordByKey(ObjectKey.Parse("RteygpK6NkexqZHONe6zkg"))).ssId);
whereBuilder.Append(")");
if (maxRecords > 0) {
orderByBuilder.Append(" LIMIT ");
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByRequisitionId.List", cancellationToken: cancellationToken);
await outParamList.LoadFromDatabase(cancellationToken);
outParamList.MaxRecords = maxRecords;
return (outParamList,outParamCount);
} finally {
...
_tmp.MaxRecords = maxRecords;
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetInvoicesByRequisitionOrFolio.GetInvoicesByRequisitionId.List", cancellationToken: cancellationToken);
await _tmp.LoadFromDatabase(cancellationToken);
outParamList = (RL_ff28012de5324af3e81e5ace09ecb1f0)_tmp;
return (outParamList,outParamCount);
} finally {
...
// Query Function "GetSupplierById" Y5njScQbvEWEzCbxC19eSA of Action "GetSupplier"
...
long outParamCount = default;
using var appHealthMetric = AppHealthProvider.CreateServerQueryAggregateMetric("d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetSupplier.GetSupplierById", "49e39963-1bc4-45bc-84cc-26f10b5f5e48");
using var queryActivity = activitySource.CreateAggregateQueryActivity("d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetSupplier.GetSupplierById", "49e39963-1bc4-45bc-84cc-26f10b5f5e48", "ConectaProveedores", "588dd3e9-ffc1-4591-bd4e-2f57e6c30828");
...
var groupByBuilder = new StringBuilder();
var havingBuilder = new StringBuilder();
selectBuilder.Append("/* /NRWebFlows.mak5F1HCzk2BbukH+WQStA/NodesShownInESpaceTree.POTmpGxLREypzVgYpzAOLg/DataActions.Eh4V6ZPTR0e+1T3CbOrHZg/NodesNotShownInESpaceTree.Y5njScQbvEWEzCbxC19eSA, 588dd3e9-ffc1-4591-bd4e-2f57e6c30828 */");
selectBuilder.Append("SELECT NULL o0, NULL o1, NULL o2, NULL o3, NULL o4, NULL o5, NULL o6, NULL o7, NULL o8, NULL o9, NULL o10, NULL o11, NULL o12, NULL o13, NULL o14, NULL o15, NULL o16, NULL o17, NULL o18, NULL o19, NULL o20, NULL o21, NULL o22, NULL o23, NULL o24, NULL o25, NULL o26, NULL o27, NULL o28, NULL o29, NULL o30, NULL o31, \"ensupplier62\".\"pais\" o32, NULL o33, NULL o34, NULL o35, NULL o36, NULL o37, NULL o38, NULL o39, NULL o40, NULL o41, NULL o42, NULL o43, NULL o44, NULL o45, NULL o46, NULL o47, NULL o48, NULL o49, NULL o50, NULL o51, NULL o52, NULL o53, NULL o54, NULL o55, NULL o56, NULL o57, NULL o58, NULL o59, NULL o60, NULL o61, NULL o62, NULL o63, NULL o64, NULL o65, NULL o66, NULL o67, NULL o68, NULL o69, NULL o70, NULL o71, NULL o72, NULL o73, NULL o74, NULL o75, NULL o76, NULL o77");
fromBuilder.Append(" FROM ((({Supplier} \"ensupplier62\" Left JOIN {SupplierDetail} \"ensupplierdetail1\" ON (\"ensupplier62\".\"id\" = \"ensupplierdetail1\".\"supplierid\"))  Left JOIN {Company} \"encompany24\" ON (\"ensupplierdetail1\".\"sociedadeid\" = \"encompany24\".\"id\"))  Left JOIN {Region} \"enregion79\" ON (\"ensupplier62\".\"regionid\" = \"enregion79\".\"id\")) ");
whereBuilder.Append(" WHERE ");
if (qpsuSupplier_Id != 0) {
whereBuilder.Append("((\"ensupplier62\".\"id\" = @qpsuSupplier_Id) AND (\"ensupplier62\".\"id\" IS NOT NULL))");
sqlCmd.CreateParameterWithoutReplacements("@qpsuSupplier_Id", DbType.Int64, qpsuSupplier_Id);
} else {
whereBuilder.Append("(\"ensupplier62\".\"id\" IS NULL)");
}
if (maxRecords > 0) {
orderByBuilder.Append(" LIMIT ");
orderByBuilder.Append(maxRecords);
...
if (multiplicity == IterationMultiplicity.Never) {
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, outParamList, "Query d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetSupplier.GetSupplierById.List", cancellationToken: cancellationToken);
await outParamList.LoadFromDatabase(cancellationToken);
outParamList.MaxRecords = maxRecords;
return (outParamList,outParamCount);
} finally {
...
_tmp.MaxRecords = maxRecords;
try {
await DatabaseAccess.ForRuntimeDatabase.ExecuteQueryAsync(sqlCmd, _tmp, "Query d_InvoicePopups.Wb_PopupInvoiceUploadMultiple.GetSupplier.GetSupplierById.List", cancellationToken: cancellationToken);
await _tmp.LoadFromDatabase(cancellationToken);
