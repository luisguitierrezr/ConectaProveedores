...
public class RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Inputs : ScreenServicesApiController.Payload.IDataPayload {
...
public string inParami_GetUserId;
    ...
    public static RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Inputs FromJSON(JObject inputParameters, JsonSerializer settings) {RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Inputs result = inputParameters.ToObject<RESTConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Inputs>(settings);
return result;
}


    public ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Model ToModel() {ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Model result = new ConectaProveedores_j_FoliosSAE_FoliosSAEForApproval_ActionApprovRejectFolio_Model();
