...
public class RESTConectaProveedores_a_Common_ChangePassword_ScreenModel : ScreenServicesApiController.Payload.IDataPayload {
...
public RESTConectaProveedores_ClientVariables clientVariables = new RESTConectaProveedores_ClientVariables();
    ...
    public static RESTConectaProveedores_a_Common_ChangePassword_ScreenModel FromJSON(JObject screenModel, JObject clientVars, JsonSerializer settings) {if((screenModel == null)) {
return null;
}

RESTConectaProveedores_a_Common_ChangePassword_ScreenModel result = screenModel.ToObject<RESTConectaProveedores_a_Common_ChangePassword_ScreenModel>(settings);
result.clientVariables = RESTConectaProveedores_ClientVariables.FromJSON(clientVars, settings);
return result;
}


    public ConectaProveedores_a_Common_ChangePassword_ScreenModel ToModel() {string varLcOldPassword = variables.varLcOldPassword == null ? "" : variables.varLcOldPassword;
...
ConectaProveedores_a_Common_ChangePassword_ScreenModel screenModel = new ConectaProveedores_a_Common_ChangePassword_ScreenModel(varLcOldPassword, varLcNewPassword, varLcConfirmPassword, varLcIsPasswordVisible, varLcIsConfirmPasswordVisible, varLcIsButtonEnabled, varLcIsExecuting, varLcIsNewPasswordCompliant, _ScreenDataSetGetUserDetail, (clientVariables != null) ? clientVariables.ToModel() : null);
return screenModel;
}
